...
typedef union {
    struct {
         ...
         *
         * [Bit 0] Enables protected mode when set; enables real-address mode
         * when clear. This flag does not enable paging directly. It only
         * enables segment-level protection. To enable paging, both the PE and
...
#define CR0_PROTECTION_ENABLE(_)   (((_) >> 0) & 0x01)
         ...
         *
         * [Bit 1] Controls the interaction of the WAIT (or FWAIT) instruction
         * with the TS flag (bit 3 of CR0). If the MP flag is set, a WAIT
         * instruction generates a device-not-available exception (\#NM) if the
         * TS flag is also set. If the MP flag is clear, the WAIT instruction
...
#define CR0_MONITOR_COPROCESSOR(_)   (((_) >> 1) & 0x01)
         ...
         * external x87 FPU when set; indicates an x87 FPU is present when
         * clear. This flag also affects the execution of
         * MMX/SSE/SSE2/SSE3/SSSE3/SSE4 instructions. When the EM flag is set,
         * execution of an x87 FPU instruction generates a device-not-available
         * exception (\#NM). This flag must be set when the processor does not
         * have an internal x87 FPU or is not connected to an external math
         * coprocessor. Setting this flag forces all floating-point instructions
         * to be handled by software emulation. Also, when the EM flag is set,
         * execution of an MMX instruction causes an invalid-opcode exception
         * (\#UD) to be generated. Thus, if an IA-32 or Intel 64 processor
         * incorporates MMX technology, the EM flag must be set to 0 to enable
         * execution of MMX instructions. Similarly for SSE/SSE2/SSE3/SSSE3/SSE4
         * extensions, when the EM flag is set, execution of most
         * SSE/SSE2/SSE3/SSSE3/SSE4 instructions causes an invalid opcode
         * exception (\#UD) to be generated. If an IA-32 or Intel 64 processor
         * incorporates the SSE/SSE2/SSE3/SSSE3/SSE4 extensions, the EM flag
...
#define CR0_EMULATE_FPU(_)   (((_) >> 2) & 0x01)
         ...
         * device-not-available exception (\#NM) is raised prior to the
         * execution of any x87 FPU/MMX/SSE/SSE2/SSE3/SSSE3/SSE4 instruction;
         * with the exception of PAUSE, PREFETCHh, SFENCE, LFENCE, MFENCE,
         ...
         * The processor does not automatically save the context of the x87 FPU,
         * XMM, and MXCSR registers on a task switch. Instead, it sets the TS
         * flag, which causes the processor to raise an \#NM exception whenever
         * it encounters an x87 FPU/MMX/SSE/SSE2/SSE3/SSSE3/SSE4 instruction in
         ...
         * can then be used to clear the TS flag (with the CLTS instruction) and
         * save the context of the x87 FPU, XMM, and MXCSR registers. If the
         * task never encounters an x87 FPU/MMX/SSE/SSE2/SSE3/SSSE3/SSE4
         * instruction, the x87 FPU/MMX/SSE/SSE2/SSE3/SSSE3/SSE4 context is
         * never saved.
         */
...
#define CR0_TASK_SWITCHED(_)   (((_) >> 3) & 0x01)
         ...
         * this flag is hardcoded to 1. In the Intel386 and Intel486 processors,
         * this flag indicates support of Intel 387 DX math coprocessor
...
#define CR0_EXTENSION_TYPE(_)   (((_) >> 4) & 0x01)
         ...
         * errors when set; enables the PC-style x87 FPU error reporting
         * mechanism when clear. When the NE flag is clear and the IGNNE\# input
         * is asserted, x87 FPU errors are ignored. When the NE flag is clear
         * and the IGNNE\# input is deasserted, an unmasked x87 FPU error causes
         * the processor to assert the FERR\# pin to generate an external
         * interrupt and to stop instruction execution immediately before
         * executing the next waiting floating-point instruction or WAIT/FWAIT
         * instruction. The FERR\# pin is intended to drive an input to an
         * external interrupt controller (the FERR\# pin emulates the ERROR\#
         * pin of the Intel 287 and Intel 387 DX math coprocessors). The NE
         * flag, IGNNE\# pin, and FERR\# pin are used with external logic to
...
#define CR0_NUMERIC_ERROR(_)   (((_) >> 5) & 0x01)
         ...
         * @brief Write Protect
         *
         * [Bit 16] When set, inhibits supervisor-level procedures from writing
         * into readonly pages; when clear, allows supervisor-level procedures
         * to write into read-only pages (regardless of the U/S bit setting).
         * This flag facilitates implementation of the copy-onwrite method of
         * creating a new process (forking) used by operating systems such as
         * UNIX.
         *
...
#define CR0_WRITE_PROTECT(_)   (((_) >> 16) & 0x01)
         ...
         * alignment checking when clear. Alignment checking is performed only
         * when the AM flag is set, the AC flag in the EFLAGS register is set,
...
#define CR0_ALIGNMENT_MASK(_)   (((_) >> 18) & 0x01)
         ...
         *
         * [Bit 29] When the NW and CD flags are clear, write-back (for Pentium
         * 4, Intel Xeon, P6 family, and Pentium processors) or write-through
...
#define CR0_NOT_WRITE_THROUGH(_)   (((_) >> 29) & 0x01)
         ...
         * @brief Cache Disable
         *
         * [Bit 30] When the CD and NW flags are clear, caching of memory
         * locations for the whole of physical memory in the processor's
         * internal (and external) caches is enabled. When the CD flag is set,
         * caching is restricted. To prevent the processor from accessing and
         * updating its caches, the CD flag must be set and the caches must be
         * invalidated so that no cache hits can occur.
         *
...
#define CR0_CACHE_DISABLE(_)   (((_) >> 30) & 0x01)
         ...
         * @brief Paging Enable
         *
         * [Bit 31] Enables paging when set; disables paging when clear. When
         * paging is disabled, all linear addresses are treated as physical
         * addresses. The PG flag has no effect if the PE flag (bit 0 of
         * register CR0) is not also set; setting the PG flag when the PE flag
         * is clear causes a general-protection exception (\#GP). On Intel 64
         * processors, enabling and disabling IA-32e mode operation also
...
typedef union {
    struct {
         ...
         * structure of the current paging-structure hierarchy. This bit is not
         * used if paging is disabled, with PAE paging, or with 4-level paging
         * if CR4.PCIDE=1.
         *
...
#define CR3_PAGE_LEVEL_WRITE_THROUGH(_)   (((_) >> 3) & 0x01)
         ...
         * structure of the current paging-structure hierarchy. This bit is not
         * used if paging is disabled, with PAE paging, or with 4-level paging2
         * if CR4.PCIDE=1.
         *
         * @see Vol3A[4.9(PAGING AND MEMORY TYPING)]
         */
...
//virtual-8086 mode when set; disables the extensions when
//		 * clear. Use of the virtual mode extensions can improve the performance
//of virtual-8086 applications by eliminating the
//		 * overhead of calling the virtual- 8086 monitor to handle interrupts
//and exceptions that occur while executing an 8086
//		 * program and, instead, redirecting the interrupts and exceptions back
//to the 8086 program's handlers. It also provides
...
//		 *
//		 * @see Vol3B[20.3(INTERRUPT AND EXCEPTION HANDLING IN VIRTUAL-8086
//MODE)]
//		 */
...
// #define CR4_VIRTUAL_MODE_EXTENSIONS(_)                               (((_) >>
// 0) & 0x01)
//
//		/**
//		 * @brief Protected-Mode Virtual Interrupts
//		 *
//		 * [Bit 1] Enables hardware support for a virtual interrupt flag (VIF)
//in protected mode when set; disables the VIF flag in
...
// #define CR4_PROTECTED_MODE_VIRTUAL_INTERRUPTS(_)                     (((_) >>
// 1) & 0x01)
//
//		/**
//		 * @brief Time Stamp Disable
//		 *
//		 * [Bit 2] Restricts the execution of the RDTSC instruction to
//procedures running at privilege level 0 when set; allows
//		 * RDTSC instruction to be executed at any privilege level when clear.
//This bit also applies to the RDTSCP instruction if
...
// #define CR4_TIMESTAMP_DISABLE(_)                                     (((_) >>
// 2) & 0x01)
//
//		/**
...
//compatibility with software written to run on
...
// #define CR4_DEBUGGING_EXTENSIONS(_)                                  (((_) >>
// 3) & 0x01)
//
//		/**
...
// #define CR4_PAGE_SIZE_EXTENSIONS(_)                                  (((_) >>
// 4) & 0x01)
//
//		/**
//		 * @brief Physical Address Extension
//		 *
//		 * [Bit 5] When set, enables paging to produce physical addresses with
...
// #define CR4_PHYSICAL_ADDRESS_EXTENSION(_)                            (((_) >>
// 5) & 0x01)
//
//		/**
...
// #define CR4_MACHINE_CHECK_ENABLE(_)                                  (((_) >>
// 6) & 0x01)
//
//		/**
//		 * @brief Page Global Enable
//		 *
//		 * [Bit 7] (Introduced in the P6 family processors.) Enables the global
//page feature when set; disables the global page
//		 * feature when clear. The global page feature allows frequently used or
//shared pages to be marked as global to all users
//		 * (done with the global flag, bit 8, in a page-directory or page-table
//entry). Global pages are not flushed from the
//		 * translation-lookaside buffer (TLB) on a task switch or a write to
//register CR3. When enabling the global page feature,
//		 * paging must be enabled (by setting the PG flag in control register
//CR0) before the PGE flag is set. Reversing this
//		 * sequence may affect program correctness, and processor performance
//will be impacted.
//		 *
...
// #define CR4_PAGE_GLOBAL_ENABLE(_)                                    (((_) >>
// 7) & 0x01)
//
//		/**
...
//procedures running at any protection level when set;
...
// #define CR4_PERFORMANCE_MONITORING_COUNTER_ENABLE(_)                 (((_) >>
// 8) & 0x01)
//
//		/**
...
//		 * -# indicates to software that the operating system supports the use
//of the FXSAVE and FXRSTOR instructions,
//		 * -# enables the FXSAVE and FXRSTOR instructions to save and restore
//the contents of the XMM and MXCSR registers along
//		 * with the contents of the x87 FPU and MMX registers, and
//		 * -# enables the processor to execute SSE/SSE2/SSE3/SSSE3/SSE4
//instructions, with the exception of the PAUSE, PREFETCHh,
//		 * SFENCE, LFENCE, MFENCE, MOVNTI, CLFLUSH, CRC32, and POPCNT.
//		 * If this flag is clear, the FXSAVE and FXRSTOR instructions will save
//and restore the contents of the x87 FPU and MMX
//		 * registers, but they may not save and restore the contents of the XMM
//and MXCSR registers. Also, the processor will
//		 * generate an invalid opcode exception (\#UD) if it attempts to execute
//any SSE/SSE2/SSE3 instruction, with the exception
//		 * of PAUSE, PREFETCHh, SFENCE, LFENCE, MFENCE, MOVNTI, CLFLUSH, CRC32,
//and POPCNT. The operating system or executive must
...
//FXSAVE/FXRSTOR to save/restore the contents of the X87 FPU, XMM and
//		 *          MXCSR registers. Consequently OSFXSR bit indicates that the
//operating system provides context switch support for
...
// #define CR4_OS_FXSAVE_FXRSTOR_SUPPORT(_)                             (((_) >>
// 9) & 0x01)
//
//		/**
...
//Exceptions - When set, indicates that the operating
//		 * system supports the handling of unmasked SIMD floating-point
//exceptions through an exception handler that is invoked
//		 * when a SIMD floating-point exception (\#XM) is generated. SIMD
//floating-point exceptions are only generated by
//		 * SSE/SSE2/SSE3/SSE4.1 SIMD floating-point instructions.
//		 * The operating system or executive must explicitly set this flag. If
//this flag is not set, the processor will generate an
//		 * invalid opcode exception (\#UD) whenever it detects an unmasked SIMD
...
// #define CR4_OS_XMM_EXCEPTION_SUPPORT(_)                              (((_) >>
// 10) & 0x01)
//
//		/**
//		 * @brief User-Mode Instruction Prevention
//		 *
//		 * [Bit 11] When set, the following instructions cannot be executed if
//CPL > 0: SGDT, SIDT, SLDT, SMSW, and STR. An attempt
...
// #define CR4_USERMODE_INSTRUCTION_PREVENTION(_)                       (((_) >>
// 11) & 0x01)
//
//		/**
//		 * @brief 57-bit Linear Addresses
//		 *
//		 * [Bit 12] When set in IA-32e mode, the processor uses 5-level paging
//to translate 57-bit linear addresses. When clear in
//		 * IA-32e mode, the processor uses 4-level paging to translate 48-bit
//linear addresses. This bit cannot be modified in
//		 * IA-32e mode.
//		 *
//		 * @see Vol3C[4(PAGING)]
//		 */
...
// #define CR4_LINEAR_ADDRESSES_57_BIT(_)                               (((_) >>
// 12) & 0x01)
//
//		/**
//		 * @brief VMX-Enable
...
// #define CR4_FSGSBASE_ENABLE(_)                                       (((_) >>
// 16) & 0x01)
//
//		/**
//		 * @brief PCID-Enable
//		 *
//		 * [Bit 17] Enables process-context identifiers (PCIDs) when set. Can be
//set only in IA-32e mode (if IA32_EFER.LMA = 1).
//		 *
...
//system supports the use of the XGETBV, XSAVE and
//		 * XRSTOR instructions by general software;
//		 * -# enables the XSAVE and XRSTOR instructions to save and restore the
//x87 FPU state (including MMX registers), the SSE
//		 * state (XMM registers and MXCSR), along with other processor extended
...
// #define CR4_OS_XSAVE(_)                                              (((_) >>
// 18) & 0x01)
//
//		/**
//		 * @brief Key-Locker-Enable
//		 *
//		 * [Bit 19] When set, the LOADIWKEY instruction is enabled; in addition,
//if support for the AES Key Locker instructions has
//		 * been activated by system firmware, CPUID.19H:EBX.AESKLE[bit 0] is
//enumerated as 1 and the AES Key Locker instructions
//		 * are enabled. When clear, CPUID.19H:EBX.AESKLE[bit 0] is enumerated as
//0 and execution of any Key Locker instruction
...
// #define CR4_KEY_LOCKER_ENABLE(_)                                     (((_) >>
// 19) & 0x01)
//
//		/**
//		 * @brief SMEP-Enable
//		 *
//		 * [Bit 20] Enables supervisor-mode execution prevention (SMEP) when
//set.
//		 *
//		 * @see Vol3A[4.6(ACCESS RIGHTS)]
//		 */
...
// #define CR4_SMAP_ENABLE(_)                                           (((_) >>
// 21) & 0x01)
//
//		/**
//		 * @brief Protection-Key-Enable
//		 *
//		 * [Bit 22] Enables 4-level paging to associate each linear address with
//a protection key. The PKRU register specifies, for
//		 * each protection key, whether user-mode linear addresses with that
//protection key can be read or written. This bit also
//		 * enables access to the PKRU register using the RDPKRU and WRPKRU
//instructions.
//		 */
...
// #define CR4_PROTECTION_KEY_ENABLE(_)                                 (((_) >>
// 22) & 0x01)
//
//		/**
//		 * @brief Control-flow Enforcement Technology
//		 *
//		 * [Bit 23] Enables control-flow enforcement technology when set. This
//flag can be set only if CR0.WP is set, and it must
...
// #define CR4_CONTROL_FLOW_ENFORCEMENT_ENABLE(_)                       (((_) >>
// 23) & 0x01)
//
//		/**
//		 * @brief Enable protection keys for supervisor-mode pages
//		 *
//		 * [Bit 24] 4-level paging and 5-level paging associate each
//supervisor-mode linear address with a protection key. When
//		 * set, this flag allows use of the IA32_PKRS MSR to specify, for each
//protection key, whether supervisor-mode linear
...
// #define CR4_PROTECTION_KEY_FOR_SUPERVISOR_MODE_ENABLE_FLAG 0x1000000 #define
// CR4_PROTECTION_KEY_FOR_SUPERVISOR_MODE_ENABLE_MASK           0x01 #define
// CR4_PROTECTION_KEY_FOR_SUPERVISOR_MODE_ENABLE(_)             (((_) >> 24) &
// 0x01)
//		UINT64 Reserved2 : 39;
//	};
//
...
typedef union {
    struct {
         ...
         * interrupts are enabled. This field is available in 64- bit mode. A
         * value of 15 means all interrupts will be disabled.
         */
...
#define CR8_TASK_PRIORITY_LEVEL(_)   (((_) >> 0) & 0x0F)
         ...
         * @brief Reserved
         *
         * [Bits 63:4] Reserved and must be written with zeros. Failure to do
         * this causes a general-protection exception.
         */
        UINT64 Reserved : 60;
...
typedef union {
    struct {
         ...
         *
         * [Bits 3:0] Indicates (when set) that its associated breakpoint
         * condition was met when a debug exception was generated. These flags
         * are set if the condition described for each breakpoint by the LENn,
         * and R/Wn flags in debug control register DR7 is true. They may or may
         * not be set if the breakpoint is not enabled by the Ln or the Gn flags
         * in register DR7. Therefore on a \#DB, a debug handler should check
         * only those B0-B3 bits which correspond to an enabled breakpoint.
         */
...
#define DR6_BREAKPOINT_CONDITION(_)   (((_) >> 0) & 0x0F)
         ...
         *
         * [Bit 13] Indicates that the next instruction in the instruction
         * stream accesses one of the debug registers (DR0 through DR7). This
         * flag is enabled when the GD (general detect) flag in debug control
         * register DR7 is set.
         *
         * @see Vol3B[17.2.4(Debug Control Register (DR7))]
         */
...
#define DR6_DEBUG_REGISTER_ACCESS_DETECTED(_)   (((_) >> 13) & 0x01)
         ...
         *
         * [Bit 14] Indicates (when set) that the debug exception was triggered
         * by the singlestep execution mode (enabled with the TF flag in the
         * EFLAGS register). The single-step mode is the highestpriority debug
         * exception. When the BS flag is set, any of the other debug status
...
#define DR6_SINGLE_INSTRUCTION(_)   (((_) >> 14) & 0x01)
         ...
         *
         * [Bit 15] Indicates (when set) that the debug exception was triggered
         * by the singlestep execution mode (enabled with the TF flag in the
         * EFLAGS register). The single-step mode is the highestpriority debug
         * exception. When the BS flag is set, any of the other debug status
         * bits also may be set.
...
#define DR6_TASK_SWITCH(_)   (((_) >> 15) & 0x01)
         ...
         * advanced debugging of RTM transactional regions was enabled. This bit
         * is set for any other debug exception (including all those that occur
         * when advanced debugging of RTM transactional regions is not enabled).
         * This bit is always 1 if the processor does not support RTM.
         *
         * @see Vol3B[17.3.3(Debug Exceptions, Breakpoint Exceptions, and
...
typedef union {
    struct {
        /**
         * @brief L0 through L3 (local breakpoint enable) flags (bits 0, 2, 4,
         * and 6)
         *
         * [Bit 0] Enables (when set) the breakpoint condition for the
         * associated breakpoint for the current task. When a breakpoint
         * condition is detected and its associated Ln flag is set, a debug
         * exception is generated. The processor automatically clears these
         * flags on every task switch to avoid unwanted breakpoint conditions in
         * the new task.
         */
...
#define DR7_LOCAL_BREAKPOINT_0(_)   (((_) >> 0) & 0x01)
        ...
        /**
         * @brief G0 through G3 (global breakpoint enable) flags (bits 1, 3, 5,
         * and 7)
         *
         * [Bit 1] Enables (when set) the breakpoint condition for the
         * associated breakpoint for all tasks. When a breakpoint condition is
         * detected and its associated Gn flag is set, a debug exception is
         * generated. The processor does not clear these flags on a task switch,
...
#define DR7_GLOBAL_BREAKPOINT_3(_)   (((_) >> 7) & 0x01)
         ...
         *
         * [Bit 8] This feature is not supported in the P6 family processors,
         * later IA-32 processors, and Intel 64 processors. When set, these
         * flags cause the processor to detect the exact instruction that caused
         * a data breakpoint condition. For backward and forward compatibility
         * with other Intel processors, we recommend that the LE and GE flags be
...
#define DR7_GLOBAL_EXACT_BREAKPOINT(_)   (((_) >> 9) & 0x01)
         ...
         * regions. This advanced debugging is enabled only if IA32_DEBUGCTL.RTM
         * is also set.
         *
         * @see Vol3B[17.3.3(Debug Exceptions, Breakpoint Exceptions, and
         * Restricted Transactional Memory (RTM))]
...
#define DR7_RESTRICTED_TRANSACTIONAL_MEMORY(_)   (((_) >> 11) & 0x01)
         ...
         * emulator software can set the GD flag to prevent interference from
         * the program currently executing on the processor. The processor
         * clears the GD flag upon entering to the debug exception handler, to
         * allow the handler access to the debug registers.
         */
...
#define DR7_GENERAL_DETECT(_)   (((_) >> 13) & 0x01)
        ...
        /**
         * @brief R/W0 through R/W3 (read/write) fields (bits 16, 17, 20, 21,
         * 24, 25, 28, and 29)
         *
...
#define DR7_READ_WRITE_0(_)   (((_) >> 16) & 0x03)
        ...
        /**
         * @brief LEN0 through LEN3 (Length) fields (bits 18, 19, 22, 23, 26,
         * 27, 30, and 31)
         *
         * [Bits 19:18] Specify the size of the memory location at the address
         * specified in the corresponding breakpoint address register (DR0
         * through DR3). These fields are interpreted as follows:
         * - 00 - 1-byte length.
         * - 01 - 2-byte length.
         * - 10 - Undefined (or 8 byte length, see note below).
         * - 11 - 4-byte length.
         * If the corresponding RWn field in register DR7 is 00 (instruction
         * execution), then the LENn field should also be 00. The effect of
         * using other lengths is undefined.
         *
...
#define CPUID_VERSION_INFORMATION_PROCESSOR_TYPE(_)   (((_) >> 12) & 0x03)
            ...
            /**
             * [Bits 19:16] The Extended Model ID needs to be examined only when
             * the Family ID is 06H or 0FH.
             */
...
#define CPUID_VERSION_INFORMATION_EXTENDED_MODEL_ID(_)   (((_) >> 16) & 0x0F)
            ...
            /**
             * [Bits 27:20] The Extended Family ID needs to be examined only
             * when the Family ID is 0FH.
             */
...
#define CPUID_VERSION_INFORMATION_EXTENDED_FAMILY_ID(_)   (((_) >> 20) & 0xFF)
    ...
    union {
        struct {
            /**
             * [Bits 7:0] This number provides an entry into a brand string
             * table that contains brand strings for IA-32 processors. More
...
#define CPUID_ADDITIONAL_INFORMATION_BRAND_INDEX(_)   (((_) >> 0) & 0xFF)
            ...
            /**
             * @brief Value * 8 = cache line size in bytes; used also by
             * CLFLUSHOPT
             *
             * [Bits 15:8] This number indicates the size of the cache line
             * flushed by the CLFLUSH and CLFLUSHOPT instructions in 8-byte
...
#define CPUID_ADDITIONAL_INFORMATION_CLFLUSH_LINE_SIZE(_)   (((_) >> 8) & 0xFF)
             ...
             * addressing different logical processors in a physical package.
...
#define CPUID_ADDITIONAL_INFORMATION_MAX_ADDRESSABLE_IDS(_)   (((_) >> 16) & 0xFF)
            ...
            /**
             * [Bits 31:24] This number is the 8-bit ID that is assigned to the
             * local APIC on the processor during power up. This field was
...
#define CPUID_ADDITIONAL_INFORMATION_INITIAL_APIC_ID(_)   (((_) >> 24) & 0xFF)
    ...
    union {
        struct {
             ...
             *
             * [Bit 0] A value of 1 indicates the processor supports this
             * technology.
             */
...
#define CPUID_FEATURE_INFORMATION_ECX_STREAMING_SIMD_EXTENSIONS_3(_) \
    (((_) >> 0) & 0x01)
             ...
             *
             * [Bit 1] A value of 1 indicates the processor supports the
...
#define CPUID_FEATURE_INFORMATION_ECX_PCLMULQDQ_INSTRUCTION(_) \
    (((_) >> 1) & 0x01)
             ...
             *
             * [Bit 2] A value of 1 indicates the processor supports DS area
             * using 64-bit layout.
             */
...
#define CPUID_FEATURE_INFORMATION_ECX_DS_AREA_64BIT_LAYOUT(_) \
    (((_) >> 2) & 0x01)
             ...
             *
             * [Bit 3] A value of 1 indicates the processor supports this
             * feature.
             */
...
#define CPUID_FEATURE_INFORMATION_ECX_MONITOR_MWAIT_INSTRUCTION(_) \
    (((_) >> 3) & 0x01)
             ...
             *
             * [Bit 4] A value of 1 indicates the processor supports the
             * extensions to the Debug Store feature to allow for branch message
...
#define CPUID_FEATURE_INFORMATION_ECX_ENHANCED_INTEL_SPEEDSTEP_TECHNOLOGY(_) \
    (((_) >> 7) & 0x01)
             ...
             *
             * [Bit 8] A value of 1 indicates whether the processor supports
             * this technology.
             */
...
#define CPUID_FEATURE_INFORMATION_ECX_SUPPLEMENTAL_STREAMING_SIMD_EXTENSIONS_3( \
    ...
    (((_) >> 9) & 0x01)
             ...
             * @brief L1 Context ID
             *
             * [Bit 10] A value of 1 indicates the L1 data cache mode can be set
             * to either adaptive mode or shared mode. A value of 0 indicates
             * this feature is not supported. See definition of the
...
#define CPUID_FEATURE_INFORMATION_ECX_CMPXCHG16B_INSTRUCTION(_) \
    (((_) >> 13) & 0x01)
             ...
             *
             * [Bit 14] A value of 1 indicates that the processor supports
             * changing IA32_MISC_ENABLE[bit 23].
             */
...
#define CPUID_FEATURE_INFORMATION_ECX_XTPR_UPDATE_CONTROL(_) \
    (((_) >> 14) & 0x01)
             ...
             *
             * [Bit 15] A value of 1 indicates the processor supports the
             * performance and debug feature indication MSR
...
#define CPUID_FEATURE_INFORMATION_ECX_PERFMON_AND_DEBUG_CAPABILITY(_) \
    (((_) >> 15) & 0x01)
             ...
             *
             * [Bit 17] A value of 1 indicates that the processor supports PCIDs
             * and that software may set CR4.PCIDE to 1.
             */
...
#define CPUID_FEATURE_INFORMATION_ECX_PROCESS_CONTEXT_IDENTIFIERS(_) \
    (((_) >> 17) & 0x01)
             ...
             *
             * [Bit 18] A value of 1 indicates the processor supports the
             * ability to prefetch data from a memory mapped device (Direct
             * Cache Access).
             */
...
#define CPUID_FEATURE_INFORMATION_ECX_DIRECT_CACHE_ACCESS(_) \
    (((_) >> 18) & 0x01)
             ...
             *
             * [Bit 19] A value of 1 indicates that the processor supports
             * SSE4.1.
             */
...
#define CPUID_FEATURE_INFORMATION_ECX_SSE41_SUPPORT(_)   (((_) >> 19) & 0x01)
             ...
             *
             * [Bit 20] A value of 1 indicates that the processor supports
             * SSE4.2.
             */
...
#define CPUID_FEATURE_INFORMATION_ECX_SSE42_SUPPORT(_)   (((_) >> 20) & 0x01)
             ...
             *
             * [Bit 21] A value of 1 indicates that the processor supports
             * x2APIC feature.
             */
...
#define CPUID_FEATURE_INFORMATION_ECX_MOVBE_INSTRUCTION(_)   (((_) >> 22) & 0x01)
             ...
             *
             * [Bit 23] A value of 1 indicates that the processor supports the
             * POPCNT instruction.
             */
...
#define CPUID_FEATURE_INFORMATION_ECX_POPCNT_INSTRUCTION(_)   (((_) >> 23) & 0x01)
             ...
             * @brief TSC Deadline
             *
             * [Bit 24] A value of 1 indicates that the processor's local APIC
             * timer supports one-shot operation using a TSC deadline value.
             */
...
#define CPUID_FEATURE_INFORMATION_ECX_TSC_DEADLINE(_)   (((_) >> 24) & 0x01)
             ...
             *
             * [Bit 25] A value of 1 indicates that the processor supports the
...
#define CPUID_FEATURE_INFORMATION_ECX_XSAVE_XRSTOR_INSTRUCTION(_) \
    (((_) >> 26) & 0x01)
             ...
             *
             * [Bit 27] A value of 1 indicates that the OS has set
             * CR4.OSXSAVE[bit 18] to enable XSETBV/XGETBV instructions to
             * access XCR0 and to support processor extended state management
             * using XSAVE/XRSTOR.
             */
            UINT32 OsxSave : 1;
...
#define CPUID_FEATURE_INFORMATION_EDX_FLOATING_POINT_UNIT_ON_CHIP(_) \
    (((_) >> 0) & 0x01)
             ...
             * controlling the feature, CR4.PVI for protected mode virtual
             * interrupts, software interrupt indirection, expansion of the TSS
             * with the software indirection bitmap, and EFLAGS.VIF and
             * EFLAGS.VIP flags.
             */
...
#define CPUID_FEATURE_INFORMATION_EDX_VIRTUAL_8086_MODE_ENHANCEMENTS(_) \
    (((_) >> 1) & 0x01)
             ...
             * @brief Debugging Extensions
             *
             * [Bit 2] Support for I/O breakpoints, including CR4.DE for
             * controlling the feature, and optional trapping of accesses to DR4
             * and DR5.
             */
...
#define CPUID_FEATURE_INFORMATION_EDX_DEBUGGING_EXTENSIONS(_) \
    (((_) >> 2) & 0x01)
             ...
             *
             * [Bit 3] Large pages of size 4 MByte are supported, including
             * CR4.PSE for controlling the feature, the defined dirty bit in PDE
             * (Page Directory Entries), optional reserved bit trapping in CR3,
             * PDEs, and PTEs.
             */
...
#define CPUID_FEATURE_INFORMATION_EDX_TIMESTAMP_COUNTER(_)   (((_) >> 4) & 0x01)
             ...
             *
             * [Bit 5] The RDMSR and WRMSR instructions are supported. Some of
             * the MSRs are implementation dependent.
             */
...
#define CPUID_FEATURE_INFORMATION_EDX_RDMSR_WRMSR_INSTRUCTIONS(_) \
    (((_) >> 5) & 0x01)
             ...
             * @brief Physical Address Extension
             *
             * [Bit 6] Physical addresses greater than 32 bits are supported:
             * extended page table entry formats, an extra level in the page
             * translation tables is defined, 2-MByte pages are supported
...
#define CPUID_FEATURE_INFORMATION_EDX_PHYSICAL_ADDRESS_EXTENSION(_) \
    (((_) >> 6) & 0x01)
             ...
             *
             * [Bit 7] Exception 18 is defined for Machine Checks, including
             * CR4.MCE for controlling the feature. This feature does not define
             * the model-specific implementations of machine-check error
             * logging, reporting, and processor shutdowns. Machine Check
             * exception handlers may have to depend on processor version to do
             * model specific processing of the exception, or test for the
...
#define CPUID_FEATURE_INFORMATION_EDX_CMPXCHG8B(_)   (((_) >> 8) & 0x01)
             ...
             * Controller (APIC), responding to memory mapped commands in the
...
#define CPUID_FEATURE_INFORMATION_EDX_APIC_ON_CHIP(_)   (((_) >> 9) & 0x01)
             ...
             *
             * [Bit 11] The SYSENTER and SYSEXIT and associated MSRs are
             * supported.
             */
...
#define CPUID_FEATURE_INFORMATION_EDX_SYSENTER_SYSEXIT_INSTRUCTIONS(_) \
    (((_) >> 11) & 0x01)
             ...
             *
             * [Bit 12] MTRRs are supported. The MTRRcap MSR contains feature
             * bits that describe what memory types are supported, how many
             * variable MTRRs are supported, and whether fixed MTRRs are
             * supported.
             */
...
#define CPUID_FEATURE_INFORMATION_EDX_MEMORY_TYPE_RANGE_REGISTERS(_) \
    (((_) >> 12) & 0x01)
             ...
             *
             * [Bit 13] The global bit is supported in paging-structure entries
             * that map a page, indicating TLB entries that are common to
             * different processes and need not be flushed. The CR4.PGE bit
...
#define CPUID_FEATURE_INFORMATION_EDX_PAGE_GLOBAL_BIT(_)   (((_) >> 13) & 0x01)
             ...
             * reporting machine errors is supported. The MCG_CAP MSR contains
             * feature bits describing how many banks of error reporting MSRs
             * are supported.
             */
...
#define CPUID_FEATURE_INFORMATION_EDX_MACHINE_CHECK_ARCHITECTURE(_) \
    (((_) >> 14) & 0x01)
             ...
             * addition, if x87 FPU is present as indicated by the CPUID.FPU
...
#define CPUID_FEATURE_INFORMATION_EDX_CONDITIONAL_MOVE_INSTRUCTIONS(_) \
    (((_) >> 15) & 0x01)
             ...
             *
             * [Bit 16] Page Attribute Table is supported. This feature augments
             * the Memory Type Range Registers (MTRRs), allowing an operating
             * system to specify attributes of memory accessed through a linear
...
#define CPUID_FEATURE_INFORMATION_EDX_PAGE_ATTRIBUTE_TABLE(_) \
    (((_) >> 16) & 0x01)
             ...
             *
             * [Bit 17] 4-MByte pages addressing physical memory beyond 4 GBytes
             * are supported with 32-bit paging. This feature indicates that
             * upper bits of the physical address of a 4-MByte page are encoded
             * in bits 20:13 of the page-directory entry. Such physical
             * addresses are limited by MAXPHYADDR and may be up to 40 bits in
             * size.
             */
...
#define CPUID_FEATURE_INFORMATION_EDX_PAGE_SIZE_EXTENSION_36BIT(_) \
    (((_) >> 17) & 0x01)
             ...
             *
             * [Bit 18] The processor supports the 96-bit processor
...
#define CPUID_FEATURE_INFORMATION_EDX_CLFLUSH(_)   (((_) >> 19) & 0x01)
             ...
             * @brief Debug Store
             *
             * [Bit 21] The processor supports the ability to write debug
             * information into a memory resident buffer. This feature is used
             * by the branch trace store (BTS) and processor event-based
...
#define CPUID_FEATURE_INFORMATION_EDX_DEBUG_STORE(_)   (((_) >> 21) & 0x01)
             ...
             *
             * [Bit 22] The processor implements internal MSRs that allow
             * processor temperature to be monitored and processor performance
...
#define CPUID_FEATURE_INFORMATION_EDX_MMX_SUPPORT(_)   (((_) >> 23) & 0x01)
             ...
             *
             * [Bit 24] The FXSAVE and FXRSTOR instructions are supported for
             * fast save and restore of the floating point context. Presence of
             * this bit also indicates that CR4.OSFXSR is available for an
             * operating system to indicate that it supports the FXSAVE and
...
#define CPUID_FEATURE_INFORMATION_EDX_SSE2_SUPPORT(_)   (((_) >> 26) & 0x01)
             ...
             * @brief Self Snoop
             *
             * [Bit 27] The processor supports the management of conflicting
...
#define CPUID_FEATURE_INFORMATION_EDX_SELF_SNOOP(_)   (((_) >> 27) & 0x01)
             ...
             *
             * [Bit 28] A value of 0 for HTT indicates there is only a single
             * logical processor in the package and software should assume only
             * a single APIC ID is reserved. A value of 1 for HTT indicates the
             * value in CPUID.1.EBX[23:16] (the Maximum number of addressable
             * IDs for logical processors in this package) is valid for the
             * package.
             */
...
#define CPUID_FEATURE_INFORMATION_EDX_HYPER_THREADING_TECHNOLOGY(_) \
    (((_) >> 28) & 0x01)
             ...
             *
             * [Bit 29] The processor implements the thermal monitor automatic
...
#define CPUID_FEATURE_INFORMATION_EDX_THERMAL_MONITOR(_)   (((_) >> 29) & 0x01)
             ...
             *
             * [Bit 31] The processor supports the use of the FERR\#/PBE\# pin
             * when the processor is in the stop-clock state (STPCLK\# is
             * asserted) to signal the processor that an interrupt is pending
             * and that the processor should return to normal operation to
...
#define CPUID_EAX_FULLY_ASSOCIATIVE_CACHE(_)   (((_) >> 9) & 0x01)
             ...
             * + EAX[25:14]) is the number of unique initial APIC IDs reserved
             * for addressing different logical processors sharing this cache.
             */
...
#define CPUID_EAX_MAX_ADDRESSABLE_IDS_FOR_LOGICAL_PROCESSORS_SHARING_THIS_CACHE( \
    ...
    (((_) >> 14) & 0xFFF)
             ...
             * @note Add one to the return value to get the result.
             *       The nearest power-of-2 integer that is not smaller than (1
             * + EAX[31:26]) is the number of unique Core_IDs reserved for
             * addressing different processor cores in a physical package. Core
             * ID is a subset of bits of the initial APIC ID. The returned value
             * is constant for valid initial values in ECX. Valid ECX values
             * start from 0.
             */
...
#define CPUID_ECX_NUMBER_OF_SETS(_)   (((_) >> 0) & 0xFFFFFFFF)
    ...
    union {
        struct {
             ...
             *
             * [Bit 0] - 0 = WBINVD/INVD from threads sharing this cache acts
...
typedef struct {
    union {
        struct {
            /**
             * [Bits 15:0] Smallest monitor-line size in bytes (default is
...
#define CPUID_EAX_SMALLEST_MONITOR_LINE_SIZE(_)   (((_) >> 0) & 0xFFFF)
    ...
    union {
        struct {
            /**
             * [Bits 15:0] Largest monitor-line size in bytes (default is
             * processor's monitor granularity).
             */
...
#define CPUID_EBX_LARGEST_MONITOR_LINE_SIZE(_)   (((_) >> 0) & 0xFFFF)
    ...
    union {
        struct {
            /**
             * [Bit 0] Enumeration of Monitor-Mwait extensions (beyond EAX and
...
#define CPUID_ECX_ENUMERATION_OF_MONITOR_MWAIT_EXTENSIONS(_)   (((_) >> 0) & 0x01)
            ...
            /**
             * [Bit 1] Supports treating interrupts as break-event for MWAIT,
...
#define CPUID_EAX_TEMPERATURE_SENSOR_SUPPORTED(_)   (((_) >> 0) & 0x01)
            ...
            /**
             * [Bit 1] Intel Turbo Boost Technology available (see description
             * of IA32_MISC_ENABLE[38]).
             */
...
#define CPUID_EAX_INTEL_TURBO_BOOST_TECHNOLOGY_AVAILABLE(_)   (((_) >> 1) & 0x01)
            ...
            /**
             * [Bit 2] ARAT. APIC-Timer-always-running feature is supported if
             * set.
             */
...
#define CPUID_EAX_APIC_TIMER_ALWAYS_RUNNING(_)   (((_) >> 2) & 0x01)
            ...
            /**
             * [Bit 4] PLN. Power limit notification controls are supported if
             * set.
             */
...
#define CPUID_EAX_POWER_LIMIT_NOTIFICATION(_)   (((_) >> 4) & 0x01)
            ...
            /**
             * [Bit 5] ECMD. Clock modulation duty cycle extension is supported
             * if set.
             */
...
#define CPUID_EAX_HWP_BASE_REGISTERS(_)   (((_) >> 7) & 0x01)
            ...
            /**
             * [Bit 8] HWP_Notification. IA32_HWP_INTERRUPT MSR is supported if
             * set.
             */
...
#define CPUID_EAX_HWP_NOTIFICATION(_)   (((_) >> 8) & 0x01)
            ...
            /**
             * [Bit 9] HWP_Activity_Window. IA32_HWP_REQUEST[bits 41:32] is
             * supported if set.
             */
...
#define CPUID_EAX_FAST_ACCESS_MODE_FOR_HWP_REQUEST_MSR(_)   (((_) >> 18) & 0x01)
            ...
            /**
             * [Bit 20] Ignoring Idle Logical Processor HWP request is supported
             * if set.
             */
...
#define CPUID_EAX_IGNORING_IDLE_LOGICAL_PROCESSOR_HWP_REQUEST(_) \
    (((_) >> 20) & 0x01)
            ...
            /**
             * [Bit 23] Intel Thread Director supported if set.
             * IA32_HW_FEEDBACK_CHAR and IA32_HW_FEEDBACK_THREAD_CONFIG MSRs are
             * supported if set.
             */
...
#define CPUID_EAX_INTEL_THREAD_DIRECTOR(_)   (((_) >> 23) & 0x01)
    ...
    union {
        struct {
            /**
             * [Bits 3:0] Number of Interrupt Thresholds in Digital Thermal
             * Sensor.
             */
...
#define CPUID_EBX_NUMBER_OF_INTERRUPT_THRESHOLDS_IN_THERMAL_SENSOR(_) \
    ...
    union {
        struct {
             ...
             * IA32_MPERF and IA32_APERF). The capability to provide a measure
             * of delivered processor performance (since last reset of the
             * counters), as a percentage of the expected processor performance
             * when running at the TSC frequency.
             */
...
#define CPUID_ECX_HARDWARE_COORDINATION_FEEDBACK_CAPABILITY(_) \
    (((_) >> 0) & 0x01)
             ...
             * processor. Information for that many classes is written into the
             * Intel Thread Director Table by the hardware.
             */
...
#define CPUID_ECX_NUMBER_OF_INTEL_THREAD_DIRECTOR_CLASSES(_)   (((_) >> 3) & 0x01)
            ...
            /**
             * [Bits 15:8] The processor supports performance-energy bias
...
#define CPUID_EBX_ENHANCED_REP_MOVSB_STOSB(_)   (((_) >> 9) & 0x01)
            ...
            /**
             * [Bit 10] If 1, supports INVPCID instruction for system software
...
#define CPUID_EBX_RTM(_)   (((_) >> 11) & 0x01)
            ...
            /**
             * [Bit 12] Supports Intel(R) Resource Director Technology (Intel(R)
             * RDT) Monitoring capability if 1.
             */
            UINT32 RdtM : 1;
...
#define CPUID_EBX_MPX(_)   (((_) >> 14) & 0x01)
            ...
            /**
             * [Bit 15] Supports Intel(R) Resource Director Technology (Intel(R)
             * RDT) Allocation capability if 1.
             */
            UINT32 Rdt : 1;
...
#define CPUID_EBX_ADX(_)   (((_) >> 19) & 0x01)
            ...
            /**
             * [Bit 20] Supports Supervisor-Mode Access Prevention (and the
             * CLAC/STAC instructions) if 1.
             */
            UINT32 Smap : 1;
...
#define CPUID_EBX_AVX512CD(_)   (((_) >> 28) & 0x01)
            ...
            /**
             * [Bit 29] Supports Intel(R) Secure Hash Algorithm Extensions
             * (Intel(R) SHA Extensions) if 1.
             */
            UINT32 Sha : 1;
...
#define CPUID_ECX_PKU(_)   (((_) >> 3) & 0x01)
            ...
            /**
             * [Bit 4] If 1, OS has set CR4.PKE to enable protection keys (and
             * the RDPKRU/WRPKRU instructions).
             */
            UINT32 Ospke : 1;
...
#define CPUID_ECX_AVX512_VBMI2(_)   (((_) >> 6) & 0x01)
            ...
            /**
             * [Bit 7] Supports CET shadow stack features if 1. Processors that
             * set this bit define bits 1:0 of the IA32_U_CET and IA32_S_CET
             * MSRs. Enumerates support for the following MSRs:
...
#define CPUID_ECX_AVX512_BITALG(_)   (((_) >> 12) & 0x01)
            ...
            /**
             * [Bit 13] If 1, the following MSRs are supported:
             * IA32_TME_CAPABILITY, IA32_TME_ACTIVATE, IA32_TME_EXCLUDE_MASK,
             * and IA32_TME_EXCLUDE_BASE.
             */
            UINT32 TmeEn : 1;
...
#define CPUID_ECX_AVX512_VPOPCNTDQ(_)   (((_) >> 14) & 0x01)
            ...
            /**
             * [Bit 16] Supports 57-bit linear addresses and five-level paging
             * if 1.
             */
            UINT32 La57 : 1;
...
#define CPUID_EDX_PCONFIG(_)   (((_) >> 18) & 0x01)
             ...
             * Processors that set this bit define bits 5:2 and bits 63:10 of
             * the IA32_U_CET and IA32_S_CET MSRs.
             */
            UINT32 CetIbt : 1;
...
#define CPUID_EDX_CET_IBT(_)   (((_) >> 20) & 0x01)
             ...
             * (IBPB). Processors that set this bit support the IA32_SPEC_CTRL
             * MSR and the IA32_PRED_CMD MSR. They allow software to set
...
#define CPUID_EDX_STIBP(_)   (((_) >> 27) & 0x01)
             ...
             * this bit support the IA32_FLUSH_CMD MSR. They allow software to
             * set IA32_FLUSH_CMD[0] (L1D_FLUSH).
             */
            UINT32 L1DFlush : 1;
...
#define CPUID_EDX_IA32_CORE_CAPABILITIES(_)   (((_) >> 30) & 0x01)
             ...
             * (SSBD). Processors that set this bit support the IA32_SPEC_CTRL
             * MSR. They allow software to set IA32_SPEC_CTRL[2] (SSBD).
             */
            UINT32 Ssbd : 1;
...
typedef struct {
    union {
        struct {
            /**
             * [Bits 31:0] Value of bits [31:0] of IA32_PLATFORM_DCA_CAP MSR
             * (address 1F8H).
             */
...
#define CPUID_EAX_VERSION_ID_OF_ARCHITECTURAL_PERFORMANCE_MONITORING(_) \
    (((_) >> 0) & 0xFF)
            ...
            /**
             * [Bits 15:8] Number of general-purpose performance monitoring
...
#define CPUID_ECX_RESERVED(_)   (((_) >> 0) & 0xFFFFFFFF)
    ...
    union {
        struct {
            /**
             * [Bits 4:0] Number of fixed-function performance counters (if
             * Version ID > 1).
             */
...
typedef struct {
    union {
        struct {
            /**
             * [Bits 4:0] Number of bits to shift right on x2APIC ID to get a
             * unique topology ID of the next level type. All logical processors
             * with the same next level ID share current level.
             *
             * @note Software should use this field (EAX[4:0]) to enumerate
...
#define CPUID_EAX_X2APIC_ID_TO_UNIQUE_TOPOLOGY_ID_SHIFT(_)   (((_) >> 0) & 0x1F)
    ...
    union {
        struct {
             ...
             *
             * @note Software must not use EBX[15:0] to enumerate processor
             * topology of the system. This value in this field (EBX[15:0]) is
             * only intended for display/diagnostic purposes. The actual number
             * of logical processors available to BIOS/OS/Applications may be
             * different from the value of EBX[15:0], depending on software and
 ...
 * information for each processor extended state save area: <pre> For i = 2 to
 * 62 // sub-leaf 1 is reserved IF (CPUID.(EAX=0DH, ECX=0):VECTOR[i] = 1) //
 * VECTOR is the 64-bit value of EDX:EAX Execute CPUID.(EAX=0DH, ECX = i) to
 * examine size and offset for sub-leaf i; FI; </pre>
 * @{
 */
...
typedef struct {
    /**
     * @brief Reports the supported bits of the lower 32 bits of XCR0. XCR0[n]
     * can be set to 1 only if EAX[n] is 1
     */
    union {
        struct {
            /**
...
#define CPUID_EAX_USED_FOR_IA32_XSS_2(_)   (((_) >> 13) & 0x01)
    ...
    union {
        struct {
            /**
             * [Bits 31:0] Maximum size (bytes, from the beginning of the
             * XSAVE/XRSTOR save area) required by enabled features in XCR0. May
             * be different than ECX if some features at the end of the XSAVE
             * save area are not enabled.
             */
...
#define CPUID_ECX_MAX_SIZE_OF_XSAVE_XRSTOR_SAVE_AREA(_) \
    ...
    union {
        struct {
            /**
             * [Bits 31:0] Reports the supported bits of the upper 32 bits of
             * XCR0. XCR0[n+32] can be set to 1 only if EDX[n] is 1.
             */
...
#define CPUID_EAX_SUPPORTS_XSAVE_XRSTOR_AND_IA32_XSS(_)   (((_) >> 3) & 0x01)
    ...
    union {
        struct {
            /**
             * [Bits 31:0] The size in bytes of the XSAVE area containing all
...
#define CPUID_ECX_HWP_STATE(_)   (((_) >> 16) & 0x01)
    ...
    union {
        struct {
            /**
             * [Bits 31:0] Reports the supported bits of the upper 32 bits of
             * the IA32_XSS MSR. IA32_XSS[n+32] can be set to 1 only if EDX[n]
             * is 1
             */
 ...
 * invalid sub-leaf index, EAX/EBX/ECX/EDX return 0. Sub-leaf n (0
 * <= n <= 31) is invalid if sub-leaf 0 returns 0 in EAX[n] and sub-leaf 1
...
typedef struct {
    union {
        struct {
            /**
             * [Bits 31:0] The size in bytes (from the offset specified in EBX)
             * of the save area for an extended state feature associated with a
...
#define CPUID_EAX_IA32_PLATFORM_DCA_CAP(_)   (((_) >> 0) & 0xFFFFFFFF)
    ...
    union {
        struct {
             ...
             * area. This field reports 0 if the sub-leaf index, n, does not map
             * to a valid bit in the XCR0 register.
             */
            UINT32 Reserved : 32;
#define CPUID_EBX_RESERVED_BIT  0
#define CPUID_EBX_RESERVED_FLAG 0xFFFFFFFF
...
#define CPUID_EBX_RESERVED(_)   (((_) >> 0) & 0xFFFFFFFF)
    ...
    union {
        struct {
            /**
             * [Bit 0] Is set if the bit n (corresponding to the sub-leaf index)
             * is supported in the IA32_XSS MSR; it is clear if bit n is instead
             * supported in XCR0.
             */
            UINT32 Ecx2 : 1;
...
#define CPUID_ECX_ECX_2(_)   (((_) >> 0) & 0x01)
            ...
            /**
             * [Bit 1] Is set if, when the compacted format of an XSAVE area is
             * used, this extended state component located on the next 64-byte
             * boundary following the preceding state component (otherwise, it
...
#define CPUID_ECX_ECX_1(_)   (((_) >> 1) & 0x01)
    ...
    union {
        struct {
            /**
             * [Bits 31:0] This field reports 0 if the sub-leaf index, n, is
...
#define CPUID_EAX_RESERVED(_)   (((_) >> 0) & 0xFFFFFFFF)
    ...
    union {
        struct {
            /**
             * [Bits 31:0] Maximum range (zero-based) of RMID within this
...
typedef struct {
    union {
        struct {
            /**
             * [Bits 4:0] Length of the capacity bit mask for the corresponding
             * ResID using minus-one notation.
             */
...
#define CPUID_EAX_LENGTH_OF_CAPACITY_BIT_MASK(_)   (((_) >> 0) & 0x1F)
    ...
    union {
        struct {
            /**
             * [Bits 31:0] Bit-granular map of isolation/contention of
             * allocation units.
             */
            UINT32 Ebx0 : 32;
...
typedef struct {
    union {
        struct {
            /**
             * [Bits 11:0] Reports the maximum MBA throttling value supported
             * for the corresponding ResID using minus-one notation.
             */
...
#define CPUID_EBX_RESERVED(_)   (((_) >> 0) & 0xFFFFFFFF)
    ...
    union {
        struct {
            ...
            /**
             * [Bit 2] Reports whether the response of the delay values is
             * linear.
             */
...
typedef struct {
    union {
        struct {
            /**
             * [Bit 0] If 1, Indicates Intel SGX supports the collection of SGX1
             * leaf functions.
             */
            UINT32 Sgx1 : 1;
...
#define CPUID_EAX_SGX1(_)   (((_) >> 0) & 0x01)
            ...
            /**
             * [Bit 1] If 1, Indicates Intel SGX supports the collection of SGX2
             * leaf functions.
             */
            UINT32 Sgx2 : 1;
...
#define CPUID_EAX_SGX2(_)   (((_) >> 1) & 0x01)
            ...
            /**
             * [Bit 5] If 1, indicates Intel SGX supports ENCLV instruction
...
#define CPUID_EAX_SGX_ENCLV_ADVANCED(_)   (((_) >> 5) & 0x01)
            ...
            /**
             * [Bit 6] If 1, indicates Intel SGX supports ENCLS instruction
...
#define CPUID_ECX_RESERVED(_)   (((_) >> 0) & 0xFFFFFFFF)
    ...
    union {
        struct {
            /**
             * [Bits 7:0] The maximum supported enclave size in non-64-bit mode
             * is 2^(EDX[7:0]).
             */
...
#define CPUID_ECX_VALID_SECS_ATTRIBUTES_2(_)   (((_) >> 0) & 0xFFFFFFFF)
    ...
    union {
        struct {
            /**
             * [Bits 31:0] Reports the valid bits of SECS.ATTRIBUTES[127:96]
...
typedef struct {
    union {
        struct {
            /**
             * [Bits 3:0] Sub-leaf Type 1. This sub-leaf enumerates an EPC
             * section. EBX:EAX and EDX:ECX provide information on the Enclave
...
#define CPUID_EAX_SUB_LEAF_TYPE(_)   (((_) >> 0) & 0x0F)
            ...
            /**
             * [Bits 31:12] Bits 31:12 of the physical address of the base of
             * the EPC section.
             */
...
#define CPUID_EAX_EPC_BASE_PHYSICAL_ADDRESS_1(_)   (((_) >> 12) & 0xFFFFF)
    ...
    union {
        struct {
            /**
             * [Bits 19:0] Bits 51:32 of the physical address of the base of the
             * EPC section.
             */
...
#define CPUID_ECX_EPC_SECTION_PROPERTY(_)   (((_) >> 0) & 0x0F)
            ...
            /**
             * [Bits 31:12] Bits 31:12 of the size of the corresponding EPC
...
#define CPUID_ECX_EPC_SIZE_1(_)   (((_) >> 12) & 0xFFFFF)
    ...
    union {
        struct {
            /**
             * [Bits 19:0] Bits 51:32 of the size of the corresponding EPC
             * section within the Processor Reserved Memory.
             */
            UINT32 EpcSize2 : 20;
...
#define CPUID_EAX_MAX_SUB_LEAF(_)   (((_) >> 0) & 0xFFFFFFFF)
    ...
    union {
        struct {
            /**
             * [Bit 0] If 1, indicates that IA32_RTIT_CTL.CR3Filter can be set
             * to 1, and that IA32_RTIT_CR3_MATCH MSR can be accessed.
             */
            UINT32 Flag0 : 1;
...
#define CPUID_EBX_FLAG0(_)   (((_) >> 0) & 0x01)
            ...
            /**
             * [Bit 1] If 1, indicates support of Configurable PSB and
             * Cycle-Accurate Mode.
             */
            UINT32 Flag1 : 1;
...
#define CPUID_EBX_FLAG1(_)   (((_) >> 1) & 0x01)
            ...
            /**
             * [Bit 2] If 1, indicates support of IP Filtering, TraceStop
             * filtering, and preservation of Intel PT MSRs across warm reset.
             */
            UINT32 Flag2 : 1;
...
#define CPUID_EBX_FLAG2(_)   (((_) >> 2) & 0x01)
            ...
            /**
             * [Bit 3] If 1, indicates support of MTC timing packet and
...
#define CPUID_EBX_FLAG3(_)   (((_) >> 3) & 0x01)
             ...
             * IA32_RTIT_CTL[12] (PTWEn) and IA32_RTIT_CTL[5] (FUPonPTW), and
...
#define CPUID_EBX_FLAG4(_)   (((_) >> 4) & 0x01)
            ...
            /**
             * [Bit 5] If 1, indicates support of Power Event Trace. Writes can
             * set IA32_RTIT_CTL[4] (PwrEvtEn), enabling Power Event Trace
             * packet generation.
             */
            UINT32 Flag5 : 1;
...
#define CPUID_EBX_FLAG5(_)   (((_) >> 5) & 0x01)
            ...
            /**
             * [Bit 6] If 1, indicates support for PSB and PH preservation.
             * Writes can set IA32_RTIT CTL[56] (InjectPsb-PmiOnEnable),
             * enabling the processor to setIA32_12TIT STATUS[7] (PendTopaPMI)
             * and/or IA32_RTIT_STATUS[6] (PendPSB) in order to preserve ToPA
             * PMIs and/or PSBs otherwise lost due to Intel PT disable. Writes
             * can also set PendToPAPMI and PendPSB.
             */
            UINT32 Flag6 : 1;
...
#define CPUID_EBX_FLAG6(_)   (((_) >> 6) & 0x01)
            ...
            /**
             * [Bit 7] If 1, writes can set IA32_RTIT_CTL[31] (EventEn),
             * enabling Event Trace packet generation.
             */
            UINT32 Flag7 : 1;
...
#define CPUID_EBX_FLAG7(_)   (((_) >> 7) & 0x01)
            ...
            /**
             * [Bit 8] If 1, writes can set IA32_RTIT_CTL[55] (DisTNT),
             * disabling TNT packet generation.
             */
            UINT32 Flag8 : 1;
...
#define CPUID_EBX_FLAG8(_)   (((_) >> 8) & 0x01)
    ...
    union {
        struct {
            /**
             * [Bit 0] If 1, Tracing can be enabled with IA32_RTIT_CTL.ToPA = 1,
             * hence utilizing the ToPA output scheme; IA32_RTIT_OUTPUT_BASE and
...
#define CPUID_ECX_FLAG0(_)   (((_) >> 0) & 0x01)
            ...
            /**
             * [Bit 1] If 1, ToPA tables can hold any number of output entries,
             * up to the maximum allowed by the MaskOrTableOffset field of
...
#define CPUID_ECX_FLAG2(_)   (((_) >> 2) & 0x01)
            ...
            /**
             * [Bit 3] If 1, indicates support of output to Trace Transport
             * subsystem.
             */
            UINT32 Flag3 : 1;
...
#define CPUID_ECX_FLAG3(_)   (((_) >> 3) & 0x01)
            ...
            /**
             * [Bit 31] If 1, generated packets which contain IP payloads have
             * LIP values, which include the CS base component.
             */
            UINT32 Flag31 : 1;
...
#define CPUID_EBX_BITMAP_OF_SUPPORTED_CYCLE_THRESHOLD_VALUE_ENCODINGS(_) \
    (((_) >> 0) & 0xFFFF)
            ...
            /**
             * [Bits 31:16] Bitmap of supported Configurable PSB frequency
             * encodings.
             */
...
#define CPUID_EAX_DENOMINATOR(_)   (((_) >> 0) & 0xFFFFFFFF)
    ...
    union {
        struct {
            /**
             * [Bits 31:0] An unsigned integer which is the numerator of the
             * TSC/"core crystal clock" ratio.
             */
            UINT32 Numerator : 32;
...
#define CPUID_EBX_NUMERATOR(_)   (((_) >> 0) & 0xFFFFFFFF)
    ...
    union {
        struct {
            /**
             * [Bits 31:0] An unsigned integer which is the nominal frequency of
...
typedef struct {
    union {
        struct {
            /**
             * [Bits 31:0] Reports the maximum input value of supported sub-leaf
             * in leaf 17H.
             */
...
#define CPUID_EBX_SOC_VENDOR_ID(_)   (((_) >> 0) & 0xFFFF)
            ...
            /**
             * [Bit 16] If 1, the SOC Vendor ID field is assigned via an
             * industry standard enumeration scheme. Otherwise, the SOC Vendor
...
#define CPUID_EBX_IS_VENDOR_SCHEME(_)   (((_) >> 16) & 0x01)
    ...
    union {
        struct {
            /**
             * [Bits 31:0] A unique number an SOC vendor assigns to its SOC
             * projects.
             */
            UINT32 ProjectId : 32;
...
#define CPUID_ECX_PROJECT_ID(_)   (((_) >> 0) & 0xFFFFFFFF)
    ...
    union {
        struct {
            /**
             * [Bits 31:0] A unique number within an SOC project that an SOC
             * vendor assigns.
             */
...
#define CPUID_EBX_PAGE_ENTRIES_1GB_SUPPORTED(_)   (((_) >> 3) & 0x01)
            ...
            /**
             * [Bits 10:8] Partitioning (0: Soft partitioning between the
...
#define CPUID_ECX_NUMBER_OF_SETS(_)   (((_) >> 0) & 0xFFFFFFFF)
    ...
    union {
        struct {
             ...
             *
             * @note Some unified TLBs will allow a single TLB entry to satisfy
             * data read/write and instruction fetches. Others will require
             * separate entries (e.g., one loaded on data read/write and another
             * loaded on an instruction fetch) . Please see the Intel(R) 64 and
             * IA-32 Architectures Optimization Reference Manual for details of
...
typedef union {
    struct {
         ...
         *
         * [Bits 52:50] Contains information concerning the intended platform
         * for the processor.
         *
         *
         * 52 | 51 | 50 | _
...
typedef union {
    struct {
         ...
         *
         * [Bit 0] When set, locks this MSR from being written; writes to this
         * bit will result in GP(0).
         *
         * @note Once the Lock bit is set, the contents of this register cannot
         * be modified. Therefore the lock bit must be set after configuring
         * support for Intel Virtualization Technology and prior to transferring
         * control to an option ROM or the OS. Hence, once the Lock bit is set,
         * the entire IA32_FEATURE_CONTROL contents are preserved across RESET
         * when PWRGOOD is not deasserted.
         * @remarks If any one enumeration condition for defined bit field
...
#define IA32_FEATURE_CONTROL_LOCK_BIT(_)   (((_) >> 0) & 0x01)
         ...
         * with SMX to support Intel(R) Trusted Execution Technology. BIOS must
         * set this bit only when the CPUID function 1 returns VMX feature flag
         * and SMX feature flag set (ECX bits 5 and 6 respectively).
         *
...
#define IA32_FEATURE_CONTROL_ENABLE_VMX_INSIDE_SMX(_)   (((_) >> 1) & 0x01)
         ...
         *
         * [Bit 2] This bit enables VMX for a system executive that does not
         * require SMX. BIOS must set this bit only when the CPUID function 1
         * returns the VMX feature flag set (ECX bit 5).
         *
...
#define IA32_FEATURE_CONTROL_ENABLE_VMX_OUTSIDE_SMX(_)   (((_) >> 2) & 0x01)
         ...
         *
         * [Bits 14:8] When set, each bit in the field represents an enable
         * control for a corresponding SENTER function. This field is supported
...
#define IA32_FEATURE_CONTROL_SENTER_LOCAL_FUNCTION_ENABLES(_) \
    (((_) >> 8) & 0x7F)
         ...
         *
         * [Bit 15] This bit must be set to enable SENTER leaf functions. This
         * bit is supported only if CPUID.1:ECX.[bit 6] is set.
         *
         * @remarks If CPUID.01H:ECX[6] = 1
         */
...
#define IA32_FEATURE_CONTROL_SENTER_GLOBAL_ENABLE(_)   (((_) >> 15) & 0x01)
         ...
         *
         * [Bit 17] This bit must be set to enable runtime reconfiguration of
         * SGX Launch Control via the IA32_SGXLEPUBKEYHASHn MSR.
         *
...
#define IA32_FEATURE_CONTROL_SGX_GLOBAL_ENABLE(_)   (((_) >> 18) & 0x01)
         ...
         *
         * [Bit 20] When set, system software can program the MSRs associated
...
typedef struct {
    /**
     * Local offset value of the IA32_TSC for a logical processor. Reset value
     * is zero. A write to IA32_TSC will modify the local offset in
...
typedef union {
    struct {
        /**
         * [Bit 0] IBRS: Indirect Branch Restricted Speculation (IBRS).
...
#define IA32_SPEC_CTRL_IBRS(_)   (((_) >> 0) & 0x01)
        ...
        /**
         * [Bit 1] STIBP: Single Thread Indirect Branch Predictors (STIBP).
         * Prevents indirect branch predictions on all logical processors on the
         * core from being controlled by any sibling logical processor in the
         * same core.
         *
...
#define IA32_SPEC_CTRL_STIBP(_)   (((_) >> 1) & 0x01)
        ...
        /**
         * [Bit 2] SSBD: Speculative Store Bypass Disable (SSBD). Delays
         * speculative execution of a load until the addresses for all older
         * stores are known.
         *
...
#define IA32_BIOS_UPDATE_SIGNATURE_RESERVED(_)   (((_) >> 0) & 0xFFFFFFFF)
         ...
         *
         * [Bits 63:32] This field contains the signature of the currently
         * loaded microcode update when read following the execution of the
         * CPUID instruction, function 1. It is required that this register
         * field be pre-loaded with zero prior to executing the CPUID,
         * function 1. If the field remains equal to zero, then there is no
...
typedef union {
    struct {
         ...
         * dual-monitor treatment cannot be activated if the bit is 0. This bit
         * is cleared when the logical processor is reset.
         *
...
#define IA32_SMM_MONITOR_CTL_VALID(_)   (((_) >> 0) & 0x01)
         ...
         *
         * [Bit 2] Determines whether executions of VMXOFF unblock SMIs under
         * the default treatment of SMIs and SMM. Executions of VMXOFF unblock
         * SMIs unless bit 2 is 1 (the value of bit 0 is irrelevant).
         *
...
#define IA32_STM_FEATURES_IA32E 0x00000001
     ...
     * activated. SMM code should establish these fields so that activating of
     * the STM invokes the STM's initialization code.
     *
...
typedef struct {
     ...
     * the logical processor is in C0. Cleared upon overflow / wrap-around of
     * IA32_MPERF.
     */
    UINT64 C0Acnt;
} IA32_APERF_REGISTER;
...
#define IA32_MTRR_CAPABILITIES_VARIABLE_RANGE_COUNT(_)   (((_) >> 0) & 0xFF)
         ...
         * IA32_MTRR_FIX4K_0F8000) are supported when set; no fixed range
...
#define IA32_MTRR_CAPABILITIES_FIXED_RANGE_SUPPORTED(_)   (((_) >> 8) & 0x01)
         ...
         *
         * [Bit 10] The write-combining (WC) memory type is supported when set;
         * the WC type is not supported when clear.
         */
...
#define IA32_MTRR_CAPABILITIES_WC_SUPPORTED(_)   (((_) >> 10) & 0x01)
         ...
         * supported when bit 11 is set; the SMRR interface is not supported
         * when clear.
         */
...
#define IA32_ARCH_CAPABILITIES_IBRS_ALL(_)   (((_) >> 1) & 0x01)
        ...
        /**
         * [Bit 2] RSBA: The processor supports RSB Alternate. Alternative
         * branch predictors may be used by RET instructions when the RSB is
         * empty. SW using retpoline may be affected by this behavior.
         */
        UINT64 Rsba : 1;
...
#define IA32_ARCH_CAPABILITIES_RSBA(_)   (((_) >> 2) & 0x01)
        ...
        /**
         * [Bit 3] SKIP_L1DFL_VMENTRY: A value of 1 indicates the hypervisor
         * need not flush the L1D on VM entry.
         */
...
#define IA32_ARCH_CAPABILITIES_MDS_NO(_)   (((_) >> 5) & 0x01)
         ...
         * machine check error due to modifying the size of a code page without
         * TLB invalidation.
         */
...
#define IA32_TSX_CTRL_RTM_DISABLE(_)   (((_) >> 0) & 0x01)
        ...
        /**
         * [Bit 1] TSX_CPUID_CLEAR: When set to 1, CPUID.07H.EBX.RTM [bit 11]
         * and CPUID.07H.EBX.HLE [bit 4] report 0. When set to 0 and the SKU
         * supports TSX, these bits will return 1.
         */
...
#define IA32_MCG_CAP_MCG_CTL_P(_)   (((_) >> 8) & 0x01)
        ...
        /**
         * [Bit 9] Extended machine check state registers are present if this
         * bit is set.
         */
        UINT64 McgExtP : 1;
...
#define IA32_MCG_CAP_MCP_CMCI_P(_)   (((_) >> 10) & 0x01)
        ...
        /**
         * [Bit 11] Threshold-based error status register are present if this
         * bit is set.
         */
        UINT64 McgTesP : 1;
...
#define IA32_MCG_CAP_MCG_TES_P(_)   (((_) >> 11) & 0x01)
        ...
        /**
         * [Bits 23:16] Number of extended machine check state registers
         * present.
         */
        UINT64 McgExtCnt : 8;
...
#define IA32_MCG_CAP_MCG_EXT_CNT(_)   (((_) >> 16) & 0xFF)
        ...
        /**
         * [Bit 24] The processor supports software error recovery if this bit
         * is set.
         */
        UINT64 McgSerP : 1;
...
#define IA32_MCG_CAP_MCG_SER_P(_)   (((_) >> 24) & 0x01)
         ...
         * Entry" that augments the data included in machine check bank
         * registers.
         *
         * @remarks 06_3EH
         */
...
#define IA32_PERFEVTSEL_EVENT_SELECT(_)   (((_) >> 0) & 0xFF)
        ...
        /**
         * [Bits 15:8] Qualifies the microarchitectural condition to detect on
         * the selected event logic.
         */
        UINT64 UMask : 8;
...
#define IA32_PERFEVTSEL_INTR(_)   (((_) >> 20) & 0x01)
         ...
         * conditions occurring across all logical processors sharing a
...
#define IA32_PERFEVTSEL_INV(_)   (((_) >> 23) & 0x01)
         ...
         * counter increments each cycle if the event count is greater than or
         * equal to the CMASK.
         */
        UINT64 Cmask : 8;
...
#define IA32_CLOCK_MODULATION_ON_DEMAND_CLOCK_MODULATION_DUTY_CYCLE(_) \
    (((_) >> 1) & 0x07)
         ...
         *
         * [Bit 4] On-Demand Clock Modulation Enable: Set 1 to enable
         * modulation.
         *
         * @remarks If CPUID.01H:EDX[22] = 1
         */
...
typedef union {
    struct {
         ...
         *
         * [Bit 0] When set, the fast-strings feature (for REP MOVS and REP
         * STORS) is enabled (default). When clear, fast-strings are disabled.
         *
         * @remarks 0F_0H
         */
...
#define IA32_MISC_ENABLE_FAST_STRINGS_ENABLE(_)   (((_) >> 0) & 0x01)
         ...
         *
         * [Bit 3] - 1 = Setting this bit enables the thermal control circuit
         * (TCC) portion of the Intel Thermal Monitor feature. This allows the
         * processor to automatically reduce power consumption in response to
         * TCC activation.
         * - 0 = Disabled.
         *
         ...
         * still be activated. The default value of this field varies with
         * product.
         * @remarks 0F_0H
         */
...
#define IA32_MISC_ENABLE_ENHANCED_INTEL_SPEEDSTEP_TECHNOLOGY_ENABLE(_) \
    (((_) >> 16) & 0x01)
         ...
         *
         * [Bit 18] When this bit is set to 0, the MONITOR feature flag is not
         * set (CPUID.01H:ECX[bit3] = 0). This indicates that MONITOR/MWAIT are
         * not supported. Software attempts to execute MONITOR/MWAIT will cause
         * \#UD when this bit is 0. When this bit is set to 1 (default),
         * MONITOR/MWAIT are supported (CPUID.01H:ECX[bit 3] = 1). If the SSE3
         * feature flag ECX[0] is not set (CPUID.01H:ECX[bit 0] = 0), the OS
         * must not attempt to alter this bit. BIOS must leave it in the default
...
#define IA32_MISC_ENABLE_ENABLE_MONITOR_FSM(_)   (((_) >> 18) & 0x01)
         ...
         *
         * [Bit 22] When this bit is set to 1, CPUID.00H returns a maximum value
         * in EAX[7:0] of 2. BIOS should contain a setup question that allows
         * users to specify when the installed OS does not support CPUID
         * functions greater than 2. Before setting this bit, BIOS must execute
         * the CPUID.0H and examine the maximum value returned in EAX[7:0]. If
         * the maximum value is greater than 2, this bit is supported.
         * Otherwise, this bit is not supported. Setting this bit when the
         * maximum value is not greater than 2 may generate a \#GP exception.
...
#define IA32_MISC_ENABLE_LIMIT_CPUID_MAXVAL(_)   (((_) >> 22) & 0x01)
         ...
         * optional messages that allow the processor to inform the chipset of
         * its priority.
         *
...
#define IA32_MISC_ENABLE_XTPR_MESSAGE_DISABLE(_)   (((_) >> 23) & 0x01)
         ...
         * Disable Bit feature (if available) allows the OS to enable PAE paging
         * and take advantage of data only pages. BIOS must not alter the
...
typedef union {
    struct {
        /**
         * [Bit 0] Setting this bit to 1 enables the processor to record a
...
#define IA32_DEBUGCTL_LBR(_)   (((_) >> 0) & 0x01)
        ...
        /**
         * [Bit 1] Setting this bit to 1 enables the processor to treat
...
#define IA32_DEBUGCTL_BTF(_)   (((_) >> 1) & 0x01)
        ...
        /**
         * [Bit 6] Setting this bit to 1 enables branch trace messages to be
         * sent.
         *
         * @remarks 06_0EH
         */
...
#define IA32_DEBUGCTL_BTS(_)   (((_) >> 7) & 0x01)
        ...
        /**
         * [Bit 8] When clear, BTMs are logged in a BTS buffer in circular
...
#define IA32_DEBUGCTL_FREEZE_LBRS_ON_PMI(_)   (((_) >> 11) & 0x01)
        ...
        /**
         * [Bit 12] When set, each ENABLE bit of the global counter control MSR
         * are frozen (address 38FH) on a PMI request.
         *
         * @remarks If CPUID.01H: ECX[15] = 1 && CPUID.0AH: EAX[7:0] > 1
         */
...
#define IA32_DEBUGCTL_FREEZE_PERFMON_ON_PMI(_)   (((_) >> 12) & 0x01)
        ...
        /**
         * [Bit 13] When set, enables the logical processor to receive and
...
#define IA32_DCA_0_CAP_DCA_QUEUE_SIZE(_)   (((_) >> 7) & 0x0F)
        ...
        /**
         * [Bits 16:13] Writes will update the register but have no HW
         * side-effect.
         */
        UINT64 DcaDelay : 4;
...
#define IA32_MTRR_PHYSBASE_TYPE(_)   (((_) >> 0) & 0xFF)
        ...
        /**
         * [Bits 47:12] Specifies the base address of the address range. This
         * 24-bit value, in the case where MAXPHYADDR is 36 bits, is extended by
         * 12 bits at the low end to form the base address (this automatically
...
typedef union {
    struct {
        ...
        /**
         * [Bit 11] Enables the register pair when set; disables register pair
         * when clear.
         */
        UINT64 Valid : 1;
...
#define IA32_MTRR_PHYSMASK_VALID(_)   (((_) >> 11) & 0x01)
        ...
        /**
         * [Bits 47:12] Specifies a mask (24 bits if the maximum physical
         * address size is 36 bits, 28 bits if the maximum physical address size
         * is 40 bits). The mask determines the range of the region being
         ...
         * value.
         * - The width of the PhysMask field depends on the maximum physical
         * address size supported by the processor. CPUID.80000008H reports the
         * maximum physical address size supported by the processor. If
         * CPUID.80000008H is not available, software may assume that the
...
#define IA32_PERF_GLOBAL_STATUS_OVF_FIXEDCTR2(_)   (((_) >> 34) & 0x01)
         ...
         * buffer that was completely filled.
         *
...
typedef union {
    struct {
        /**
         * [Bits 31:0] EN_PMC(n). Enable bitmask. Only the first n-1 bits are
...
#define IA32_PERF_GLOBAL_CTRL_EN_PMCN(_)   (((_) >> 0) & 0xFFFFFFFF)
        ...
        /**
         * [Bits 63:32] EN_FIXED_CTR(n). Enable bitmask. Only the first n-1 bits
...
typedef union {
    struct {
        /**
         * [Bits 31:0] Set 1 to clear Ovf_PMC(n) bit. Clear bitmask. Only the
...
#define IA32_PERF_GLOBAL_STATUS_RESET_CLEAR_OVF_PMCN(_) \
    (((_) >> 0) & 0xFFFFFFFF)
        ...
        /**
         * [Bits 34:32] Set 1 to clear Ovf_FIXED_CTR(n) bit. Clear bitmask. Only
         * the first n-1 bits are valid. Bits 31:n are reserved.
         *
         * @remarks If CPUID.0AH: EDX[4:0] > n
         */
...
typedef union {
    struct {
        /**
         * [Bits 31:0] Set 1 to cause Ovf_PMC(n) = 1. Set bitmask. Only the
         * first n-1 bits are valid. Bits 31:n are reserved.
         *
         * @remarks If CPUID.0AH: EAX[15:8] > n
         */
...
#define IA32_PERF_GLOBAL_STATUS_SET_OVF_PMCN(_)   (((_) >> 0) & 0xFFFFFFFF)
        ...
        /**
         * [Bits 34:32] Set 1 to cause Ovf_FIXED_CTR(n) = 1. Set bitmask. Only
         * the first n-1 bits are valid. Bits 31:n are reserved.
         *
         * @remarks If CPUID.0AH: EDX[4:0] > n
         */
...
typedef union {
    struct {
        /**
         * [Bits 31:0] IA32_PERFEVTSEL(n) in use. Status bitmask. Only the first
...
#define IA32_PERF_GLOBAL_INUSE_IA32_PERFEVTSELN_IN_USE(_) \
    (((_) >> 0) & 0xFFFFFFFF)
        ...
        /**
         * [Bits 34:32] IA32_FIXED_CTR(n) in use. Status bitmask. Only the first
         * n-1 bits are valid. Bits 31:n are reserved.
         */
...
typedef union {
    struct {
         ...
         * Processors that use the same VMCS revision identifier use the same
         * size for VMCS regions.
         */
...
#define IA32_VMX_BASIC_MUST_BE_ZERO(_)   (((_) >> 31) & 0x01)
         ...
         * 0 and at most 4096 (bit 44 is set if and only if bits 43:32 are
         * clear).
         */
...
#define IA32_VMX_BASIC_VMCS_SIZE_IN_BYTES(_)   (((_) >> 32) & 0x1FFF)
         ...
         * VMX transitions). If the bit is 0, these addresses are limited to the
         * processor's physical-address width.2 If the bit is 1, these addresses
...
#define IA32_VMX_BASIC_DUAL_MONITOR_SUPPORT(_)   (((_) >> 49) & 0x01)
         ...
         * 53:50 in this MSR. As of this writing, all processors that support
         * VMX operation indicate the write-back type.
         */
        UINT64 MemoryType : 4;
...
#define IA32_VMX_BASIC_MEMORY_TYPE(_)   (((_) >> 50) & 0x0F)
        ...
        /**
         * @brief Whether the processor provides additional information for
         * exits due to INS/OUTS
         *
         * [Bit 54] When set to 1, the processor reports information in the
         * VM-exit instruction-information field on VM exits due to execution of
         * the INS and OUTS instructions. This reporting is done only if this
         * bit is read as 1.
         *
         * @see Vol3C[27.2.4(Information for VM Exits Due to Instruction
         * Execution)]
         */
...
#define IA32_VMX_BASIC_INS_OUTS_REPORTING(_)   (((_) >> 54) & 0x01)
        ...
        /**
         * @brief Whether default 1 bits in control MSRs (pin/proc/exit/entry)
         * may be cleared to 0 and that 'true' control MSRs are supported
         *
...
typedef union {
    struct {
        /**
         * @brief External interrupts cause VM-exits if set; otherwise
...
#define IA32_VMX_PINBASED_CTLS_EXTERNAL_INTERRUPT_EXITING(_)   (((_) >> 0) & 0x01)
         ...
         * exits. Otherwise, they are delivered normally using descriptor 2 of
         * the IDT. This control also determines interactions between IRET and
         * blocking by NMI.
         *
...
#define IA32_VMX_PINBASED_CTLS_NMI_EXITING(_)   (((_) >> 3) & 0x01)
         ...
         * @brief Virtual NMIs
         *
         * [Bit 5] If this control is 1, NMIs are never blocked and the
         * "blocking by NMI" bit (bit 3) in the interruptibility-state field
         * indicates "virtual-NMI blocking". This control also interacts with
         * the "NMI-window exiting" VM-execution control.
         *
...
#define IA32_VMX_PINBASED_CTLS_VIRTUAL_NMI(_)   (((_) >> 5) & 0x01)
         ...
         *
         * [Bit 6] If this control is 1, the VMX-preemption timer counts down in
         * VMX non-root operation. A VM exit occurs when the timer counts down
         * to zero.
         *
...
#define IA32_VMX_PINBASED_CTLS_ACTIVATE_VMX_PREEMPTION_TIMER(_) \
    (((_) >> 6) & 0x01)
        ...
        /**
         * @brief Process interrupts with the posted-interrupt notification
         * vector
         *
         * [Bit 7] If this control is 1, the processor treats interrupts with
         * the posted-interrupt notification vector specially, updating the
         * virtual-APIC page with posted-interrupt requests.
         *
...
typedef union {
    struct {
         ...
         *
         * [Bit 2] If this control is 1, a VM exit occurs at the beginning of
         * any instruction if RFLAGS.IF = 1 and there are no other blocking of
         * interrupts.
         *
...
#define IA32_VMX_PROCBASED_CTLS_INTERRUPT_WINDOW_EXITING(_)   (((_) >> 2) & 0x01)
         ...
         *
         * [Bit 3] This control determines whether executions of RDTSC,
...
#define IA32_VMX_PROCBASED_CTLS_USE_TSC_OFFSETTING(_)   (((_) >> 3) & 0x01)
         ...
         *
         * [Bit 7] This control determines whether executions of HLT cause VM
         * exits.
         */
        UINT64 HltExiting : 1;
...
#define IA32_VMX_PROCBASED_CTLS_RDPMC_EXITING(_)   (((_) >> 11) & 0x01)
         ...
         *
         * [Bit 12] This control determines whether executions of RDTSC and
...
#define IA32_VMX_PROCBASED_CTLS_RDTSC_EXITING(_)   (((_) >> 12) & 0x01)
        ...
        /**
         * @brief VM-exit when executing the MOV to CR3 instruction (forced to 1
         ...
         * processors to support the virtual-machine extensions supported only
         * the 1-setting of this control.
         *
...
#define IA32_VMX_PROCBASED_CTLS_CR3_LOAD_EXITING(_)   (((_) >> 15) & 0x01)
        ...
        /**
         * @brief VM-exit when executing the MOV from CR3 instruction (forced to
         * 1 on the 'first' VT-x capable CPUs; this actually includes the newest
         * Nehalem CPUs)
         *
         * [Bit 16] This control determines whether executions of MOV from CR3
         * cause VM exits. The first processors to support the virtual-machine
...
#define IA32_VMX_PROCBASED_CTLS_CR3_STORE_EXITING(_)   (((_) >> 16) & 0x01)
         ...
         * processor operates as if all the tertiary processor-based
...
#define IA32_VMX_PROCBASED_CTLS_ACTIVATE_TERTIARY_CONTROLS(_) \
    (((_) >> 17) & 0x01)
         ...
         *
         * [Bit 19] This control determines whether executions of MOV to CR8
         * cause VM exits.
         */
...
#define IA32_VMX_PROCBASED_CTLS_CR8_LOAD_EXITING(_)   (((_) >> 19) & 0x01)
         ...
         *
         * [Bit 20] This control determines whether executions of MOV from CR8
         * cause VM exits.
         */
...
#define IA32_VMX_PROCBASED_CTLS_CR8_STORE_EXITING(_)   (((_) >> 20) & 0x01)
         ...
         *
         * [Bit 21] Setting this control to 1 enables TPR virtualization and
         * other APIC-virtualization features.
         *
...
#define IA32_VMX_PROCBASED_CTLS_USE_TPR_SHADOW(_)   (((_) >> 21) & 0x01)
         ...
         *
         * [Bit 22] If this control is 1, a VM exit occurs at the beginning of
         * any instruction if there is no virtual-NMI blocking.
         *
         * @see Vol3C[24.4.2(Guest Non-Register State)]
         */
...
#define IA32_VMX_PROCBASED_CTLS_NMI_WINDOW_EXITING(_)   (((_) >> 22) & 0x01)
         ...
         *
         * [Bit 23] This control determines whether executions of MOV DR cause
         * VM exits.
         */
...
#define IA32_VMX_PROCBASED_CTLS_MOV_DR_EXITING(_)   (((_) >> 23) & 0x01)
         ...
         *
         * [Bit 24] This control determines whether executions of I/O
...
#define IA32_VMX_PROCBASED_CTLS_UNCONDITIONAL_IO_EXITING(_)   (((_) >> 24) & 0x01)
         ...
         *
         * [Bit 25] This control determines whether I/O bitmaps are used to
         * restrict executions of I/O instructions For this control, "0" means
         * "do not use I/O bitmaps" and "1" means "use I/O bitmaps." If the I/O
...
#define IA32_VMX_PROCBASED_CTLS_USE_IO_BITMAPS(_)   (((_) >> 25) & 0x01)
         ...
         *
         * [Bit 27] If this control is 1, the monitor trap flag debugging
         * feature is enabled.
         *
...
#define IA32_VMX_PROCBASED_CTLS_MONITOR_TRAP_FLAG(_)   (((_) >> 27) & 0x01)
         ...
         *
         * [Bit 28] This control determines whether MSR bitmaps are used to
         * control execution of the RDMSR and WRMSR instructions. For this
         * control, "0" means "do not use MSR bitmaps" and "1" means "use MSR
         * bitmaps." If the MSR bitmaps are not used, all executions of the
...
#define IA32_VMX_PROCBASED_CTLS_USE_MSR_BITMAPS(_)   (((_) >> 28) & 0x01)
         ...
         *
         * [Bit 29] This control determines whether executions of MONITOR cause
         * VM exits.
         */
...
#define IA32_VMX_PROCBASED_CTLS_PAUSE_EXITING(_)   (((_) >> 30) & 0x01)
         ...
         * controls are used
         *
         * [Bit 31] This control determines whether the secondary
         * processor-based VM-execution controls are used. If this control is 0,
         * the logical processor operates as if all the secondary
...
typedef union {
    struct {
        ...
        /**
         * @brief Save guest debug controls (dr7 & IA32_DEBUGCTL_MSR) (forced to
         * 1 on the 'first' VT-x capable CPUs; this actually includes the newest
         * Nehalem CPUs)
         *
         * [Bit 2] This control determines whether DR7 and the IA32_DEBUGCTL MSR
         * are saved on VM exit. The first processors to support the
         * virtual-machine extensions supported only the 1-setting of this
         * control.
         */
...
#define IA32_VMX_EXIT_CTLS_SAVE_DEBUG_CONTROLS(_)   (((_) >> 2) & 0x01)
         ...
         *
         * [Bit 9] On processors that support Intel 64 architecture, this
         * control determines whether a logical processor is in 64-bit mode
         * after the next VM exit. Its value is loaded into CS.L, IA32_EFER.LME,
         * and IA32_EFER.LMA on every VM exit.1 This control must be 0 on
...
#define IA32_VMX_EXIT_CTLS_HOST_ADDRESS_SPACE_SIZE(_)   (((_) >> 9) & 0x01)
         ...
         *
         * [Bit 12] This control determines whether the IA32_PERF_GLOBAL_CTRL
         * MSR is loaded on VM exit.
         */
...
#define IA32_VMX_EXIT_CTLS_LOAD_IA32_PERF_GLOBAL_CTRL(_)   (((_) >> 12) & 0x01)
         ...
         * processor acknowledges the interrupt controller, acquiring the
         * interrupt's vector. The vector is stored in the VM-exit
...
#define IA32_VMX_EXIT_CTLS_ACKNOWLEDGE_INTERRUPT_ON_EXIT(_)   (((_) >> 15) & 0x01)
         ...
         *
         * [Bit 18] This control determines whether the IA32_PAT MSR is saved on
         * VM exit.
         */
...
#define IA32_VMX_EXIT_CTLS_SAVE_IA32_PAT(_)   (((_) >> 18) & 0x01)
         ...
         *
         * [Bit 19] This control determines whether the IA32_PAT MSR is loaded
         * on VM exit.
         */
...
#define IA32_VMX_EXIT_CTLS_LOAD_IA32_PAT(_)   (((_) >> 19) & 0x01)
         ...
         *
         * [Bit 20] This control determines whether the IA32_EFER MSR is saved
         * on VM exit.
         */
...
#define IA32_VMX_EXIT_CTLS_SAVE_IA32_EFER(_)   (((_) >> 20) & 0x01)
         ...
         *
         * [Bit 21] This control determines whether the IA32_EFER MSR is loaded
         * on VM exit.
         */
...
#define IA32_VMX_EXIT_CTLS_LOAD_IA32_EFER(_)   (((_) >> 21) & 0x01)
        ...
        /**
         * @brief Whether the value of the VMX preemption timer is saved on
         * every VM-exit
         *
         * [Bit 22] This control determines whether the value of the
...
#define IA32_VMX_EXIT_CTLS_SAVE_VMX_PREEMPTION_TIMER_VALUE(_) \
    (((_) >> 22) & 0x01)
        ...
        /**
         * [Bit 23] This control determines whether the IA32_BNDCFGS MSR is
         * cleared on VM exit.
         */
...
#define IA32_VMX_EXIT_CTLS_CLEAR_IA32_BNDCFGS(_)   (((_) >> 23) & 0x01)
        ...
        /**
         * [Bit 24] If this control is 1, Intel Processor Trace does not produce
         * a paging information packet (PIP) on a VM exit or a VMCS packet on an
         * SMM VM exit.
         *
...
#define IA32_VMX_EXIT_CTLS_CONCEAL_VMX_FROM_PT(_)   (((_) >> 24) & 0x01)
        ...
        /**
         * [Bit 25] This control determines whether the IA32_RTIT_CTL MSR is
         * cleared on VM exit.
         *
         * @see Vol3C[35(INTEL(R) PROCESSOR TRACE)]
         */
...
#define IA32_VMX_EXIT_CTLS_CLEAR_IA32_RTIT_CTL(_)   (((_) >> 25) & 0x01)
        ...
        /**
         * [Bit 26] This control determines whether the IA32_LBR_CTL MSR is
         * cleared on VM exit.
         */
...
#define IA32_VMX_EXIT_CTLS_LOAD_IA32_CET_STATE(_)   (((_) >> 28) & 0x01)
        ...
        /**
         * [Bit 29] This control determines whether the IA32_PKRS MSR is loaded
         * on VM exit.
         */
...
#define IA32_VMX_EXIT_CTLS_LOAD_IA32_PKRS(_)   (((_) >> 29) & 0x01)
        ...
        /**
         * [Bit 31] This control determines whether the secondary VM-exit
         * controls are used. If this control is 0, the logical processor
         * operates as if all the secondary VM-exit controls were also 0.
         */
        UINT64 ActivateSecondaryControls : 1;
...
typedef union {
    struct {
        ...
        /**
         * @brief Load guest debug controls (dr7 & IA32_DEBUGCTL_MSR) (forced to
         * 1 on the 'first' VT-x capable CPUs; this actually includes the newest
         * Nehalem CPUs)
         *
         * [Bit 2] This control determines whether DR7 and the IA32_DEBUGCTL MSR
...
#define IA32_VMX_ENTRY_CTLS_LOAD_DEBUG_CONTROLS(_)   (((_) >> 2) & 0x01)
        ...
        /**
         * @brief 64 bits guest mode. Must be 0 for CPUs that don't support
         * AMD64
         *
         * [Bit 9] On processors that support Intel 64 architecture, this
         * control determines whether the logical processor is in IA-32e mode
         * after VM entry. Its value is loaded into IA32_EFER.LMA as part of VM
         * entry. This control must be 0 on processors that do not support Intel
         * 64 architecture.
         */
...
#define IA32_VMX_ENTRY_CTLS_IA32E_MODE_GUEST(_)   (((_) >> 9) & 0x01)
         ...
         * system-management mode (SMM) after VM entry. This control must be 0
...
#define IA32_VMX_ENTRY_CTLS_ENTRY_TO_SMM(_)   (((_) >> 10) & 0x01)
        ...
        /**
         * @brief Disable dual treatment of SMI and SMM; must be zero for
         * VM-entry outside of SMM
         *
         * [Bit 11] If set to 1, the default treatment of SMIs and SMM is in
         * effect after the VM entry. This control must be 0 for any VM entry
         * from outside SMM
         *
...
#define IA32_VMX_ENTRY_CTLS_DEACTIVATE_DUAL_MONITOR_TREATMENT(_) \
    (((_) >> 11) & 0x01)
        ...
        /**
         * @brief Whether the guest IA32_PERF_GLOBAL_CTRL MSR is loaded on
         * VM-entry
         *
         * [Bit 13] This control determines whether the IA32_PERF_GLOBAL_CTRL
         * MSR is loaded on VM entry.
         */
        UINT64 LoadIa32PerfGlobalCtrl : 1;
...
#define IA32_VMX_ENTRY_CTLS_LOAD_IA32_PERF_GLOBAL_CTRL(_)   (((_) >> 13) & 0x01)
         ...
         *
         * [Bit 14] This control determines whether the IA32_PAT MSR is loaded
         * on VM entry.
         */
        UINT64 LoadIa32Pat : 1;
...
#define IA32_VMX_ENTRY_CTLS_LOAD_IA32_PAT(_)   (((_) >> 14) & 0x01)
         ...
         *
         * [Bit 15] This control determines whether the IA32_EFER MSR is loaded
         * on VM entry.
         */
        UINT64 LoadIa32Efer : 1;
...
#define IA32_VMX_ENTRY_CTLS_LOAD_IA32_EFER(_)   (((_) >> 15) & 0x01)
        ...
        /**
         * [Bit 16] This control determines whether the IA32_BNDCFGS MSR is
         * loaded on VM entry.
         */
...
#define IA32_VMX_ENTRY_CTLS_LOAD_IA32_BNDCFGS(_)   (((_) >> 16) & 0x01)
        ...
        /**
         * [Bit 17] If this control is 1, Intel Processor Trace does not produce
         * a paging information packet (PIP) on a VM entry or a VMCS packet on a
         * VM entry that returns from SMM.
         *
         * @see Vol3C[35(INTEL(R) PROCESSOR TRACE)]
         */
        UINT64 ConcealVmxFromPt : 1;
...
#define IA32_VMX_ENTRY_CTLS_CONCEAL_VMX_FROM_PT(_)   (((_) >> 17) & 0x01)
        ...
        /**
         * [Bit 18] This control determines whether the IA32_RTIT_CTL MSR is
         * loaded on VM entry.
         */
...
#define IA32_VMX_ENTRY_CTLS_LOAD_CET_STATE(_)   (((_) >> 20) & 0x01)
        ...
        /**
         * [Bit 21] This control determines whether the IA32_LBR_CTL MSR is
         * loaded on VM entry.
         */
...
#define IA32_VMX_ENTRY_CTLS_LOAD_IA32_LBR_CTL(_)   (((_) >> 21) & 0x01)
        ...
        /**
         * [Bit 22] This control determines whether the IA32_PKRS MSR is loaded
         * on VM entry.
         */
        UINT64 LoadIa32Pkrs : 1;
...
typedef union {
    struct {
         ...
         *
         * [Bits 4:0] Report a value X that specifies the relationship between
         * the rate of the VMX-preemption timer and that of the timestamp
         * counter (TSC). Specifically, the VMX-preemption timer (if it is
         * active) counts down by 1 every time bit X in the TSC changes due to a
         * TSC increment.
         */
...
#define IA32_VMX_MISC_PREEMPTION_TIMER_TSC_RELATIONSHIP(_)   (((_) >> 0) & 0x1F)
        ...
        /**
         * @brief Whether VM-exit stores EFER.LMA into the "IA32e mode guest"
         * field
         *
         * [Bit 5] When set to 1, VM exits store the value of IA32_EFER.LMA into
         * the "IA-32e mode guest" VM-entry control. This bit is read as 1 on
         * any logical processor that supports the 1-setting of the
...
#define IA32_VMX_MISC_STORE_EFER_LMA_ON_VMEXIT(_)   (((_) >> 5) & 0x01)
         ...
         * implementation causes a VM entry to fail if it attempts to establish
         * that activity state. All implementations support VM entry to activity
         * state 0 (active).
         */
...
#define IA32_VMX_MISC_ACTIVITY_STATES(_)   (((_) >> 6) & 0x07)
         ...
         *
         * [Bit 14] When set to 1, Intel(R) Processor Trace (Intel PT) can be
         * used in VMX operation. If the processor supports Intel PT but does
         * not allow it to be used in VMX operation, execution of VMXON clears
         * IA32_RTIT_CTL.TraceEn; any attempt to write IA32_RTIT_CTL while in
         * VMX operation (including VMX root operation) causes a
...
#define IA32_VMX_MISC_RDMSR_CAN_READ_IA32_SMBASE_MSR_IN_SMM(_) \
    (((_) >> 15) & 0x01)
         ...
         *
         * [Bits 24:16] Indicate the number of CR3-target values supported by
         * the processor. This number is a value between 0 and 256, inclusive
...
#define IA32_VMX_MISC_CR3_TARGET_COUNT(_)   (((_) >> 16) & 0x1FF)
         ...
         *
         * [Bits 27:25] Used to compute the recommended maximum number of MSRs
         * that should appear in the VM-exit MSR-store list, the VM-exit
         * MSR-load list, or the VM-entry MSR-load list. Specifically, if the
         * value bits 27:25 of IA32_VMX_MISC is N, then 512 * (N + 1) is the
         * recommended maximum number of MSRs to be included in each list. If
         * the limit is exceeded, undefined processor behavior may result
...
#define IA32_VMX_MISC_SMM_MONITOR_CTL_B2(_)   (((_) >> 28) & 0x01)
        ...
        /**
         * @brief Whether VMWRITE can be used to write VM-exit information
         * fields
         *
         * [Bit 29] When set to 1, software can use VMWRITE to write to any
         * supported field in the VMCS; otherwise, VMWRITE cannot be used to
         * modify VM-exit information fields.
         */
...
#define IA32_VMX_MISC_VMWRITE_VMEXIT_INFO(_)   (((_) >> 29) & 0x01)
         ...
         * interrupt, software exception, or privileged software exception with
         * an instruction length of 0.
         */
...
#define IA32_VMX_PROCBASED_CTLS2_ENABLE_EPT(_)   (((_) >> 1) & 0x01)
         ...
         *
         * [Bit 2] This control determines whether executions of LGDT, LIDT,
...
#define IA32_VMX_PROCBASED_CTLS2_VIRTUALIZE_X2APIC_MODE(_)   (((_) >> 4) & 0x01)
         ...
         *
         * [Bit 5] If this control is 1, cached translations of linear addresses
         * are associated with a virtualprocessor identifier (VPID).
         *
...
#define IA32_VMX_PROCBASED_CTLS2_WBINVD_EXITING(_)   (((_) >> 6) & 0x01)
         ...
         *
         * [Bit 7] This control determines whether guest software may run in
...
#define IA32_VMX_PROCBASED_CTLS2_UNRESTRICTED_GUEST(_)   (((_) >> 7) & 0x01)
         ...
         *
         * [Bit 8] If this control is 1, the logical processor virtualizes
         * certain APIC accesses.
         *
         * @see Vol3C[29.4(VIRTUALIZING MEMORY-MAPPED APIC ACCESSES)]
         * @see Vol3C[29.5(VIRTUALIZING MSR-BASED APIC ACCESSES)]
         */
...
#define IA32_VMX_PROCBASED_CTLS2_VIRTUAL_INTERRUPT_DELIVERY(_) \
    (((_) >> 9) & 0x01)
         ...
         *
         * [Bit 10] This control determines whether a series of executions of
         * PAUSE can cause a VM exit.
         *
...
#define IA32_VMX_PROCBASED_CTLS2_PAUSE_LOOP_EXITING(_)   (((_) >> 10) & 0x01)
         ...
         *
         * [Bit 11] This control determines whether executions of RDRAND cause
         * VM exits.
         */
...
#define IA32_VMX_PROCBASED_CTLS2_RDRAND_EXITING(_)   (((_) >> 11) & 0x01)
         ...
         *
         * [Bit 12] If this control is 0, any execution of INVPCID causes a
         * \#UD.
         */
...
#define IA32_VMX_PROCBASED_CTLS2_ENABLE_INVPCID(_)   (((_) >> 12) & 0x01)
         ...
         *
         * [Bit 13] Setting this control to 1 enables use of the VMFUNC
...
#define IA32_VMX_PROCBASED_CTLS2_ENABLE_VM_FUNCTIONS(_)   (((_) >> 13) & 0x01)
         ...
         *
         * [Bit 14] If this control is 1, executions of VMREAD and VMWRITE in
         * VMX non-root operation may access a shadow VMCS (instead of causing
         * VM exits).
         *
...
#define IA32_VMX_PROCBASED_CTLS2_ENABLE_ENCLS_EXITING(_)   (((_) >> 15) & 0x01)
         ...
         *
         * [Bit 16] This control determines whether executions of RDSEED cause
         * VM exits.
         */
...
#define IA32_VMX_PROCBASED_CTLS2_RDSEED_EXITING(_)   (((_) >> 16) & 0x01)
         ...
         *
         * [Bit 17] If this control is 1, an access to a guest-physical address
...
#define IA32_VMX_PROCBASED_CTLS2_EPT_VIOLATION(_)   (((_) >> 18) & 0x01)
         ...
         *
         * [Bit 19] If this control is 1, Intel Processor Trace suppresses from
         * PIPs an indication that the processor was in VMX non-root operation
         * and omits a VMCS packet from any PSB+ produced in VMX nonroot
         * operation.
         *
         * @see Vol3C[35(INTEL(R) PROCESSOR TRACE)]
         */
...
#define IA32_VMX_PROCBASED_CTLS2_CONCEAL_VMX_FROM_PT(_)   (((_) >> 19) & 0x01)
         ...
         *
         * [Bit 20] If this control is 0, any execution of XSAVES or XRSTORS
         * causes a \#UD.
         */
...
#define IA32_VMX_PROCBASED_CTLS2_MODE_BASED_EXECUTE_CONTROL_FOR_EPT(_) \
    (((_) >> 22) & 0x01)
        ...
        /**
         * [Bit 23] If this control is 1, EPT write permissions may be specified
         * at the granularity of 128 bytes.
         *
...
#define IA32_VMX_PROCBASED_CTLS2_PT_USES_GUEST_PHYSICAL_ADDRESSES(_) \
    (((_) >> 24) & 0x01)
         ...
         *
         * [Bit 25] This control determines whether executions of RDTSC,
         * executions of RDTSCP, and executions of RDMSR that read from the
...
typedef union {
    struct {
        /**
         * [Bit 0] When set to 1, the processor supports execute-only
         * translations by EPT. This support allows software to configure EPT
         * paging-structure entries in which bits 1:0 are clear (indicating that
         * data accesses are not allowed) and bit 2 is set (indicating that
...
#define IA32_VMX_EPT_VPID_CAP_PAGE_WALK_LENGTH_4(_)   (((_) >> 6) & 0x01)
        ...
        /**
         * [Bit 8] When set to 1, the logical processor allows software to
         * configure the EPT paging-structure memory type to be uncacheable
         * (UC).
         *
...
#define IA32_VMX_EPT_VPID_CAP_MEMORY_TYPE_WRITE_BACK(_)   (((_) >> 14) & 0x01)
         ...
         * configure a EPT PDE to map a 2-Mbyte page (by setting bit 7 in the
         * EPT PDE).
         */
...
#define IA32_VMX_EPT_VPID_CAP_PDE_2MB_PAGES(_)   (((_) >> 16) & 0x01)
         ...
         * configure a EPT PDPTE to map a 1-Gbyte page (by setting bit 7 in the
         * EPT PDPTE).
         */
...
#define IA32_VMX_EPT_VPID_CAP_INVEPT(_)   (((_) >> 20) & 0x01)
        ...
        /**
         * [Bit 21] When set to 1, accessed and dirty flags for EPT are
         * supported.
         *
...
#define IA32_VMX_EPT_VPID_CAP_EPT_ACCESSED_AND_DIRTY_FLAGS(_) \
    (((_) >> 21) & 0x01)
         ...
         * information for EPT violations. This reporting is done only if this
         * bit is read as 1.
         *
...
#define IA32_VMX_EPT_VPID_CAP_INVVPID(_)   (((_) >> 32) & 0x01)
        ...
        /**
         * [Bit 40] When set to 1, the individual-address INVVPID type is
         * supported.
         */
...
#define IA32_VMX_EPT_VPID_CAP_INVVPID_ALL_CONTEXTS(_)   (((_) >> 42) & 0x01)
        ...
        /**
         * [Bit 43] When set to 1, the single-context-retaining-globals INVVPID
         * type is supported.
         */
...
#define IA32_VMX_EPT_VPID_CAP_INVVPID_SINGLE_CONTEXT_RETAIN_GLOBALS(_) \
    (((_) >> 43) & 0x01)
        ...
        /**
         * [Bits 53:48] Enumerate the maximum HLAT prefix size. It is expected
         * that any processor that supports the 1-setting of the "enable HLAT"
...
typedef union {
    struct {
        /**
         * [Bits 31:0] Indicate the allowed 0-settings of these controls. VM
         * entry allows control X to be 0 if bit X in the MSR is cleared to 0;
...
#define IA32_VMX_TRUE_CTLS_ALLOWED_0_SETTINGS(_)   (((_) >> 0) & 0xFFFFFFFF)
        ...
        /**
         * [Bits 63:32] Indicate the allowed 1-settings of these controls. VM
         * entry allows control X to be 1 if bit 32+X in the MSR is set to 1; if
         * bit 32+X in the MSR is cleared to 0, VM entry fails if control X
         * is 1.
         */
...
typedef union {
    struct {
        /**
         * [Bit 0] The EPTP-switching VM function changes the EPT pointer to a
         * value chosen from the EPTP list.
         *
...
typedef union {
    struct {
         ...
         *
         * [Bit 0] This control determines whether executions of LOADIWKEY cause
         * VM exits.
         */
...
#define IA32_VMX_PROCBASED_CTLS3_ENABLE_HLAT(_)   (((_) >> 1) & 0x01)
        ...
        /**
         * @brief If this control is 1, EPT permissions can be specified to
         * allow writes only for paging-related control updates
         *
         * [Bit 2] If this control is 1, EPT permissions can be specified to
         * allow writes only for paging-related control updates.
         *
         * @see Vol3C[28.3.3.2(EPT Violations)]
         */
...
#define IA32_VMX_PROCBASED_CTLS3_EPT_PAGING_WRITE(_)   (((_) >> 2) & 0x01)
        ...
        /**
         * [Bit 3] If this control is 1, EPT permissions can be specified to
         * prevent accesses using linear addresses verification whose
         * translation has certain properties.
         *
         * @see Vol3C[28.3.3.2(EPT Violations)]
         */
...
typedef union {
    struct {
        /**
         * [Bit 0] - If 1, indicates that a non-faulting Intel SGX instruction
         * has been executed, consequently, launching a properly signed ACM but
         * with Intel SGX SVN value less than the BIOS specified Intel SGX SVN
         * threshold would lead to an TXT shutdown.
         * - If 0, indicates that the processor will allow a properly signed ACM
         * to launch irrespective of the Intel SGX SVN value of the ACM.
         *
         * @see Vol3D[41.11.3(Interactions with Authenticated Code Modules
         * (ACMs))]
         */
        UINT64 Lock : 1;
...
#define IA32_SGX_SVN_STATUS_LOCK(_)   (((_) >> 0) & 0x01)
        ...
        /**
         * @brief Reflects the expected threshold of Intel SGX SVN for the SINIT
         * ACM
         *
         * [Bits 23:16] - If CPUID.01H:ECX.SMX = 1, this field reflects the
         * expected threshold of Intel SGX SVN for the SINIT ACM.
...
typedef union {
    struct {
         ...
         *
         * [Bits 47:7] The base physical address. How this address is used
         * depends on the value of IA32_RTIT_CTL.ToPA:
         * - 0: This is the base physical address of a single, contiguous
         * physical output region. This could be mapped to DRAM or to MMIO,
         * depending on the value. The base address should be aligned with the
         * size of the region, such that none of the 1s in the mask value
         * overlap with 1s in the base address. If the base is not aligned, an
         * operational error will result.
         * - 1: The base physical address of the current ToPA table. The address
         * must be 4K aligned. Writing an address in which bits 11:7 are
         * non-zero will not cause a
...
#define IA32_RTIT_OUTPUT_MASK_PTRS_LOWER_MASK(_)   (((_) >> 0) & 0x7F)
         ...
         * contiguous physical output region. The size of this field indicates
         * that regions can be of size 128B up to 4GB. This value (combined with
         * the lower 7 bits, which are reserved to 1) will be ANDed with the
         * OutputOffset field to determine the next write address. All 1s in
         * this field should be consecutive and starting at bit 7, otherwise the
         * region will not be contiguous, and an operational error will be
         * signaled when TraceEn is set.
         * - 1: This field holds bits 27:3 of the offset pointer into the
         * current ToPA table. This value can be added to the
         * IA32_RTIT_OUTPUT_BASE value to produce a pointer to the current ToPA
         * table entry, which itself is a pointer to the current output region.
         * In this scenario, the lower 7 reserved bits are ignored. This field
         * supports tables up to 256 MBytes in size.
         *
         * @see Vol3C[35.3.9(Operational Errors)]
         */
...
#define IA32_RTIT_OUTPUT_MASK_PTRS_MASK_OR_TABLE_OFFSET(_) \
    (((_) >> 7) & 0x1FFFFFF)
         ...
         * IA32_RTIT_CTL.ToPA:
         * - 0: This is bits 31:0 of the offset pointer into the single,
         * contiguous physical output region. This value will be added to the
         * IA32_RTIT_OUTPUT_BASE value to form the physical address at which the
         * next byte of packet output data will be written. This value must be
         * less than or equal to the MaskOrTableOffset field, otherwise an
         * operational error will be signaled when TraceEn is set.
         * - 1: This field holds bits 31:0 of the offset pointer into the
         * current ToPA output region. This value will be added to the output
         * region base field, found in the current ToPA table entry, to form the
         * physical address at which the next byte of trace output data will be
         * written. This value must be less than the ToPA entry size, otherwise
         * an operational error will be signaled when TraceEn is set.
         *
         * @see Vol3C[35.3.9(Operational Errors)]
         */
...
typedef union {
    struct {
         ...
         * When this bit transitions from 1 to 0, all buffered packets are
         * flushed out of internal buffers. A further store, fence, or
         * architecturally serializing instruction may be required to ensure
         * that packet data can be observed at the trace endpoint. Note that the
         * processor will clear this bit on \#SMI (Section) and warm reset.
         * Other MSR bits of IA32_RTIT_CTL (and other trace configuration MSRs)
         * are not impacted by these events.
         *
...
#define IA32_RTIT_CTL_FUP_ON_PTW(_)   (((_) >> 5) & 0x01)
         ...
         * @brief FabricEn
         *
         * [Bit 6] - 0: Trace output is directed to the memory subsystem,
         * mechanism depends on IA32_RTIT_CTL.ToPA.
...
#define IA32_RTIT_CTL_CR3_FILTER(_)   (((_) >> 7) & 0x01)
         ...
         * = 1, and IA32_RTIT_CTL.FabricEn=0 WRMSR to IA32_RTIT_CTL that sets
         * TraceEn but clears this bit and FabricEn would cause \#GP: If
         * CPUID.(EAX=14H, ECX=0):ECX.SNGLRGNOUT[bit 2] = 0 WRMSR to
         * IA32_RTIT_CTL that sets this bit causes \#GP: If CPUID.(EAX=14H,
...
#define IA32_RTIT_CTL_BRANCH_ENABLED(_)   (((_) >> 13) & 0x01)
         ...
         * crystal clock, or Always Running Timer (ART). MTC will be sent each
         * time the selected ART bit toggles. The following Encodings are
         * defined: 0: ART(0), 1: ART(1), 2: ART(2), 3: ART(3), 4: ART(4), 5:
         * ART(5), 6: ART(6), 7: ART(7), 8: ART(8), 9: ART(9), 10: ART(10), 11:
         * ART(11), 12: ART(12), 13: ART(13), 14: ART(14), 15: ART(15)
         *
         * @remarks If (CPUID.(EAX=07H, ECX=0):EBX[3] = 1) Reserved if
         * CPUID.(EAX=14H, ECX=0):EBX.MTC[bit 3] = 0
...
#define IA32_RTIT_CTL_MTC_FREQUENCY(_)   (((_) >> 14) & 0x0F)
         ...
         * 2(CycThresh-1). The following Encodings are defined: 0: 0, 1: 1, 2:
         * 2, 3: 4, 4: 8, 5: 16, 6: 32, 7: 64, 8: 128, 9: 256, 10: 512, 11:
         * 1024, 12: 2048, 13: 4096, 14: 8192, 15: 16384
         *
...
#define IA32_RTIT_CTL_CYC_THRESHOLD(_)   (((_) >> 19) & 0x0F)
         ...
         * @brief PSBFreq
         *
         * [Bits 27:24] Indicates the frequency of PSB packets. PSB packet
         * frequency is based on the number of Intel PT packet bytes output, so
         * this field allows the user to determine the increment of
         * IA32_IA32_RTIT_STATUS.PacketByteCnt that should cause a PSB to be
         * generated. Note that PSB insertion is not precise, but the average
         * output bytes per PSB should approximate the SW selected period. The
         * following Encodings are defined: 0: 2K, 1: 4K, 2: 8K, 3: 16K, 4: 32K,
         * 5: 64K, 6: 128K, 7: 256K, 8: 512K, 9: 1M, 10: 2M, 11: 4M, 12: 8M, 13:
         * 16M, 14: 32M, 15: 64M
         *
         * @remarks If (CPUID.(EAX=07H, ECX=0):EBX[1] = 1) Reserved if
         * CPUID.(EAX=14H, ECX=0):EBX.CPSB_CAM[bit 1] = 0
...
#define IA32_RTIT_CTL_PSB_FREQUENCY(_)   (((_) >> 24) & 0x0F)
         ...
         * @brief ADDR0_CFG
         *
         * [Bits 35:32] Configures the base/limit register pair
         * IA32_RTIT_ADDR0_A/B based on the following encodings:
         * - 0: ADDR0 range unused.
         * - 1: The [IA32_RTIT_ADDR0_A..IA32_RTIT_ADDR0_B] range defines a
         * FilterEn range. FilterEn will only be set when the IP is within this
         * range, though other FilterEn ranges can additionally be used.
         * - 2: The [IA32_RTIT_ADDR0_A..IA32_RTIT_ADDR0_B] range defines a
         * TraceStop range. TraceStop will be asserted if code branches into
         * this range.
         * - 3..15: Reserved (\#GP).
         *
...
#define IA32_RTIT_CTL_ADDR0_CFG(_)   (((_) >> 32) & 0x0F)
         ...
         * @brief ADDR1_CFG
         *
         * [Bits 39:36] Configures the base/limit register pair
         * IA32_RTIT_ADDR1_A/B based on the following encodings:
         * - 0: ADDR1 range unused.
         * - 1: The [IA32_RTIT_ADDR1_A..IA32_RTIT_ADDR1_B] range defines a
         * FilterEn range. FilterEn will only be set when the IP is within this
         * range, though other FilterEn ranges can additionally be used.
         * - 2: The [IA32_RTIT_ADDR1_A..IA32_RTIT_ADDR1_B] range defines a
         * TraceStop range. TraceStop will be asserted if code branches into
         * this range.
         * - 3..15: Reserved (\#GP).
         *
...
#define IA32_RTIT_CTL_ADDR1_CFG(_)   (((_) >> 36) & 0x0F)
         ...
         * @brief ADDR2_CFG
         *
         * [Bits 43:40] Configures the base/limit register pair
         * IA32_RTIT_ADDR2_A/B based on the following encodings:
         * - 0: ADDR2 range unused.
         * - 1: The [IA32_RTIT_ADDR2_A..IA32_RTIT_ADDR2_B] range defines a
         * FilterEn range. FilterEn will only be set when the IP is within this
         * range, though other FilterEn ranges can additionally be used.
         * - 2: The [IA32_RTIT_ADDR2_A..IA32_RTIT_ADDR2_B] range defines a
         * TraceStop range. TraceStop will be asserted if code branches into
         * this range.
         * - 3..15: Reserved (\#GP).
         *
...
#define IA32_RTIT_CTL_ADDR2_CFG(_)   (((_) >> 40) & 0x0F)
         ...
         * @brief ADDR3_CFG
         *
         * [Bits 47:44] Configures the base/limit register pair
         * IA32_RTIT_ADDR3_A/B based on the following encodings:
         * - 0: ADDR3 range unused.
         * - 1: The [IA32_RTIT_ADDR3_A..IA32_RTIT_ADDR3_B] range defines a
         * FilterEn range. FilterEn will only be set when the IP is within this
         * range, though other FilterEn ranges can additionally be used.
         * - 2: The [IA32_RTIT_ADDR3_A..IA32_RTIT_ADDR3_B] range defines a
         * TraceStop range. TraceStop will be asserted if code branches into
         * this range.
         * - 3..15: Reserved (\#GP).
         *
...
typedef union {
    struct {
         ...
         *
         * [Bit 0] This bit is written by the processor, and indicates that
         * tracing is allowed for the current IP. Writes are ignored.
         *
         * @remarks If (CPUID.(EAX=07H, ECX=0):EBX[2] = 1)
...
#define IA32_RTIT_STATUS_FILTER_ENABLED(_)   (((_) >> 0) & 0x01)
         ...
         *
         * [Bit 1] The processor sets this bit to indicate that tracing is
         * allowed for the current context. Writes are ignored.
         *
...
#define IA32_RTIT_STATUS_CONTEXT_ENABLED(_)   (((_) >> 1) & 0x01)
         ...
         *
         * [Bit 2] The processor sets this bit to indicate that tracing is
         * enabled. Writes are ignored.
         *
...
#define IA32_RTIT_STATUS_TRIGGER_ENABLED(_)   (((_) >> 2) & 0x01)
         ...
         * @brief Error
         *
         * [Bit 4] The processor sets this bit to indicate that an operational
         * error has been encountered. When this bit is set, TriggerEn is
         * cleared to 0 and packet generation is disabled. When TraceEn is
         * cleared, software can write this bit. Once it is set, only software
         * can clear it. It is not recommended that software ever set this bit,
         * except in cases where it is restoring a prior saved state.
         *
         * @see Vol3C[35.2.6.2(Table of Physical Addresses (ToPA) | ToPA
         * Errors)]
         */
        UINT64 Error : 1;
...
#define IA32_RTIT_STATUS_STOPPED(_)   (((_) >> 5) & 0x01)
         ...
         * @brief Pend PSB
         *
         * [Bit 6] If IA32_RTIT_CTL.InjectPsbPmiOnEnable[56] = 1, the processor
         * sets this bit when the threshold for a PSB+ to be inserted has been
         * reached. The processor will clear this bit when the PSB+ has been
         * inserted into the trace. If PendPSB = 1 and InjectPsbPmiOnEnable = 1
         * when IA32_RTIT_CTL.TraceEn[0] transitions from 0 to 1, a PSB+ will be
...
#define IA32_RTIT_STATUS_PEND_PSB(_)   (((_) >> 6) & 0x01)
         ...
         * @brief Pend ToPA PMI
         *
         * [Bit 7] If IA32_RTIT_CTL.InjectPsbPmiOnEnable[56] = 1, the processor
         * sets this bit when the threshold for a ToPA PMI to be inserted has
         * been reached. Software should clear this bit once the ToPA PMI has
         * been handled. If PendTopaPMI = 1 and InjectPsbPmiOnEnable = 1 when
         * IA32_RTIT_CTL.TraceEn[0] transitions from 0 to 1, a PMI will be
         * pended.
         *
         * @remarks If CPUID.(EAX=14H, ECX=0):EBX.INJECTPSBPMI[6] = 1
...
#define IA32_RTIT_STATUS_PEND_TOPA_PMI(_)   (((_) >> 7) & 0x01)
         ...
         * @brief PacketByteCnt
         *
         * [Bits 48:32] This field is written by the processor, and holds a
         * count of packet bytes that have been sent out. The processor also
         * uses this field to determine when the next PSB packet should be
         * inserted. Note that the processor may clear or modify this field at
         * any time while IA32_RTIT_CTL.TraceEn=1. It will have a stable value
         * when IA32_RTIT_CTL.TraceEn=0.
         *
...
#define IA32_U_CET_LEG_IW_EN(_)   (((_) >> 3) & 0x01)
        ...
        /**
         * [Bit 4] When set to 1, enables use of no-track prefix for indirect
         * branch tracking.
         *
         * @see Vol1[18(CONTROL-FLOW ENFORCEMENT TECHNOLOGY (CET))]
         */
...
#define IA32_U_CET_SUPPRESS_DIS(_)   (((_) >> 5) & 0x01)
        ...
        /**
         * [Bit 10] When set to 1, indirect branch tracking is suppressed. This
         * bit can be written to 1 only if TRACKER is written as IDLE.
         *
         * @see Vol1[18(CONTROL-FLOW ENFORCEMENT TECHNOLOGY (CET))]
         */
        UINT64 Suppress : 1;
...
#define IA32_U_CET_TRACKER(_)   (((_) >> 11) & 0x01)
        ...
        /**
         * [Bits 63:12] Linear address bits 63:12 of a legacy code page bitmap
         * used for legacy compatibility when indirect branch tracking is
         * enabled. If the processor does not support Intel 64 architecture,
         * these fields have only 32 bits; bits 63:32 of the MSRs are reserved.
         * On processors that support Intel 64 architecture this value cannot
         * represent a non-canonical address. In protected mode, only 31:0 are
         * loaded. The linear address written must be aligned to 8 bytes and
...
#define IA32_DEBUG_INTERFACE_ENABLE(_)   (((_) >> 0) & 0x01)
         ...
         * @brief Lock <b>(R/W)</b>
         *
         * [Bit 30] If 1, locks any further change to the MSR. The lock bit is
         * set automatically on the first SMI assertion even if not explicitly
...
#define IA32_DEBUG_INTERFACE_LOCK(_)   (((_) >> 30) & 0x01)
         ...
         *
         * [Bit 31] This "sticky bit" is set by hardware to indicate the status
         * of bit 0. Default is 0.
         *
         * @remarks If CPUID.01H:ECX.[11] = 1
         */
...
typedef union {
    struct {
         ...
         * @brief Enable <b>(R/W)</b>
         *
         * [Bit 0] Set 1 to enable L3 CAT masks and COS to operate in Code and
         * Data Prioritization (CDP) mode.
         */
        UINT64 Enable : 1;
...
typedef union {
    struct {
         ...
         * @brief Enable <b>(R/W)</b>
         *
         * [Bit 0] Set 1 to enable L2 CAT masks and COS to operate in Code and
         * Data Prioritization (CDP) mode.
         */
        UINT64 Enable : 1;
...
typedef union {
    struct {
         ...
         * @brief Event ID
         *
         * [Bits 7:0] ID of a supported monitoring event to report via
         * IA32_QM_CTR.
         */
        UINT64 EventId : 8;
...
#define IA32_QM_EVTSEL_EVENT_ID(_)   (((_) >> 0) & 0xFF)
         ...
         * IA32_QM_CTR.
         *
         * @remarks Bits [N+31:32] N = Ceil (Log2 (CPUID.(EAX=
         * 0FH,ECX=0H).EBX[31:0] + 1))
         */
...
#define IA32_QM_CTR_UNAVAILABLE(_)   (((_) >> 62) & 0x01)
         ...
         * @brief Error
         *
         * [Bit 63] If 1, indicates an unsupported RMID or event type was
...
typedef union {
    struct {
         ...
         *
         * [Bits 31:0] ID for monitoring hardware to track internal operation,
         * e.g., memory access.
         *
         * @remarks Bits [N-1:0] N = Ceil (Log2 (CPUID.(EAX= 0FH,
         * ECX=0H).EBX[31:0] +1)) 31:N Reserved
         */
        UINT64 ResourceMonitoringId : 32;
...
#define IA32_PQR_ASSOC_RESOURCE_MONITORING_ID(_)   (((_) >> 0) & 0xFFFFFFFF)
         ...
         * @brief COS <b>(R/W)</b>
         *
         * [Bits 63:32] The class of service (COS) to enforce (on writes);
         * returns the current COS when read.
         *
...
#define IA32_BNDCFGS_ENABLE(_)   (((_) >> 0) & 0x01)
        ...
        /**
         * [Bit 1] Preserve the bounds registers for near branch instructions in
         * the absence of the BND prefix.
         */
...
typedef union {
    struct {
         ...
         *
         * [Bit 0] Force HDC idling or wake up HDC-idled logical processors in
         * the package.
         *
         * @remarks If CPUID.06H:EAX.[13] = 1
...
typedef union {
    struct {
         ...
         *
         * [Bit 0] Allow/Block this logical processor for package level HDC
         * control.
         *
         * @remarks If CPUID.06H:EAX.[13] = 1
...
#define PDE_4MB_32_PRESENT(_)   (((_) >> 0) & 0x01)
        ...
        /**
         * [Bit 1] Read/write; if 0, writes may not be allowed to the 4-MByte
...
#define PDE_4MB_32_WRITE(_)   (((_) >> 1) & 0x01)
        ...
        /**
         * [Bit 2] User/supervisor; if 0, user-mode accesses are not allowed to
         * the 4-MByte page referenced by this entry.
         *
         * @see Vol3A[4.6(Access Rights)]
         */
        UINT32 Supervisor : 1;
...
#define PDE_4MB_32_SUPERVISOR(_)   (((_) >> 2) & 0x01)
        ...
        /**
         * [Bit 3] Page-level write-through; indirectly determines the memory
         * type used to access the 4-MByte page referenced by this entry.
         *
...
#define PDE_4MB_32_PAGE_LEVEL_WRITE_THROUGH(_)   (((_) >> 3) & 0x01)
        ...
        /**
         * [Bit 4] Page-level cache disable; indirectly determines the memory
         * type used to access the 4-MByte page referenced by this entry.
         *
         * @see Vol3A[4.9.2(Paging and Memory Typing When the PAT is Supported
         * (Pentium III and More Recent Processor Families))]
...
#define PDE_4MB_32_ACCESSED(_)   (((_) >> 5) & 0x01)
        ...
        /**
         * [Bit 6] Dirty; indicates whether software has written to the 4-MByte
         * page referenced by this entry.
         *
         * @see Vol3A[4.8(Accessed and Dirty Flags)]
         */
...
#define PDE_4MB_32_IGNORED_1(_)   (((_) >> 9) & 0x07)
        ...
        /**
         * [Bit 12] Indirectly determines the memory type used to access the
...
#define PDE_32_IGNORED_1(_)   (((_) >> 6) & 0x01)
        ...
        /**
         * [Bit 7] If CR4.PSE = 1, must be 0 (otherwise, this entry maps a
...
#define PDE_32_IGNORED_2(_)   (((_) >> 8) & 0x0F)
        ...
        /**
         * [Bits 31:12] Physical address of 4-KByte aligned page table
         * referenced by this entry.
         */
...
#define PTE_32_PRESENT(_)   (((_) >> 0) & 0x01)
        ...
        /**
         * [Bit 1] Read/write; if 0, writes may not be allowed to the 4-KByte
         * page referenced by this entry.
         *
         * @see Vol3A[4.6(Access Rights)]
         */
...
#define PTE_32_ACCESSED(_)   (((_) >> 5) & 0x01)
        ...
        /**
         * [Bit 6] Dirty; indicates whether software has written to the 4-KByte
         * page referenced by this entry.
         *
         * @see Vol3A[4.8(Accessed and Dirty Flags)]
         */
...
#define PTE_32_DIRTY(_)   (((_) >> 6) & 0x01)
        ...
        /**
         * [Bit 7] Indirectly determines the memory type used to access the
...
typedef union {
    struct {
        /**
         * [Bit 0] Present; must be 1 to reference a page-directory-pointer
         * table.
         */
        UINT64 Present : 1;
...
#define PML4E_64_SUPERVISOR(_)   (((_) >> 2) & 0x01)
        ...
        /**
         * [Bit 3] Page-level write-through; indirectly determines the memory
         * type used to access the page-directory-pointer table referenced by
         * this entry.
         *
         * @see Vol3A[4.9.2(Paging and Memory Typing When the PAT is Supported
         * (Pentium III and More Recent Processor Families))]
...
#define PML4E_64_IGNORED_1(_)   (((_) >> 8) & 0x07)
        ...
        /**
         * [Bit 11] For ordinary paging, ignored; for HLAT paging, restart (if
         * 1, linear-address translation is restarted with ordinary paging)
         *
...
#define PML4E_64_RESTART(_)   (((_) >> 11) & 0x01)
        ...
        /**
         * [Bits 47:12] Physical address of 4-KByte aligned
...
#define PML4E_64_IGNORED_2(_)   (((_) >> 52) & 0x7FF)
        ...
        /**
         * [Bit 63] If IA32_EFER.NXE = 1, execute-disable (if 1, instruction
         * fetches are not allowed from the 512-GByte region controlled by this
...
#define PDPTE_1GB_64_PRESENT(_)   (((_) >> 0) & 0x01)
        ...
        /**
         * [Bit 1] Read/write; if 0, writes may not be allowed to the 1-GByte
         * page referenced by this entry.
         *
         * @see Vol3A[4.6(Access Rights)]
         */
...
#define PDPTE_1GB_64_SUPERVISOR(_)   (((_) >> 2) & 0x01)
        ...
        /**
         * [Bit 3] Page-level write-through; indirectly determines the memory
         * type used to access the 1-GByte page referenced by this entry.
         *
         * @see Vol3A[4.9.2(Paging and Memory Typing When the PAT is Supported
         * (Pentium III and More Recent Processor Families))]
         */
...
#define PDPTE_1GB_64_ACCESSED(_)   (((_) >> 5) & 0x01)
        ...
        /**
         * [Bit 6] Dirty; indicates whether software has written to the 1-GByte
         * page referenced by this entry.
         *
         * @see Vol3A[4.8(Accessed and Dirty Flags)]
         */
...
#define PDPTE_1GB_64_RESTART(_)   (((_) >> 11) & 0x01)
         ...
         *
         * @note The PAT is supported on all processors that support 4-level
         * paging.
         * @see Vol3A[4.9.2(Paging and Memory Typing When the PAT is Supported
         * (Pentium III and More Recent Processor Families))]
         */
...
#define PDPTE_1GB_64_IGNORED_2(_)   (((_) >> 52) & 0x7F)
        ...
        /**
         * [Bits 62:59] Protection key; if CR4.PKE = 1, determines the
         * protection key of the page; ignored otherwise.
         *
...
#define PDPTE_1GB_64_PROTECTION_KEY(_)   (((_) >> 59) & 0x0F)
        ...
        /**
         * [Bit 63] If IA32_EFER.NXE = 1, execute-disable (if 1, instruction
         * fetches are not allowed from the 1-GByte page controlled by this
         * entry); otherwise, reserved (must be 0).
         *
         * @see Vol3A[4.6(Access Rights)]
         */
...
#define PDPTE_64_SUPERVISOR(_)   (((_) >> 2) & 0x01)
        ...
        /**
         * [Bit 3] Page-level write-through; indirectly determines the memory
         * type used to access the page directory referenced by this entry.
         *
         * @see Vol3A[4.9.2(Paging and Memory Typing When the PAT is Supported
         * (Pentium III and More Recent Processor Families))]
         */
...
#define PDPTE_64_ACCESSED(_)   (((_) >> 5) & 0x01)
        ...
        /**
         * [Bit 7] Page size; must be 0 (otherwise, this entry maps a 1-GByte
         * page).
         */
        UINT64 LargePage : 1;
...
#define PDPTE_64_IGNORED_2(_)   (((_) >> 52) & 0x7FF)
        ...
        /**
         * [Bit 63] If IA32_EFER.NXE = 1, execute-disable (if 1, instruction
         * fetches are not allowed from the 1-GByte region controlled by this
         * entry); otherwise, reserved (must be 0).
         *
         * @see Vol3A[4.6(Access Rights)]
         */
...
#define PDE_2MB_64_PRESENT(_)   (((_) >> 0) & 0x01)
        ...
        /**
         * [Bit 1] Read/write; if 0, writes may not be allowed to the 2-MByte
         * page referenced by this entry.
         *
         * @see Vol3A[4.6(Access Rights)]
         */
...
#define PDE_2MB_64_WRITE(_)   (((_) >> 1) & 0x01)
        ...
        /**
         * [Bit 2] User/supervisor; if 0, user-mode accesses are not allowed to
         * the 2-MByte page referenced by this entry.
         *
         * @see Vol3A[4.6(Access Rights)]
         */
        UINT64 Supervisor : 1;
...
#define PDE_2MB_64_SUPERVISOR(_)   (((_) >> 2) & 0x01)
        ...
        /**
         * [Bit 3] Page-level write-through; indirectly determines the memory
         * type used to access the 2-MByte page referenced by this entry.
         *
         * @see Vol3A[4.9.2(Paging and Memory Typing When the PAT is Supported
         * (Pentium III and More Recent Processor Families))]
         */
...
#define PDE_2MB_64_ACCESSED(_)   (((_) >> 5) & 0x01)
        ...
        /**
         * [Bit 6] Dirty; indicates whether software has written to the 2-MByte
         * page referenced by this entry.
         *
         * @see Vol3A[4.8(Accessed and Dirty Flags)]
         */
...
#define PDE_2MB_64_PROTECTION_KEY(_)   (((_) >> 59) & 0x0F)
        ...
        /**
         * [Bit 63] If IA32_EFER.NXE = 1, execute-disable (if 1, instruction
         * fetches are not allowed from the 2-MByte page controlled by this
         * entry); otherwise, reserved (must be 0).
         *
         * @see Vol3A[4.6(Access Rights)]
         */
...
#define PDE_64_ACCESSED(_)   (((_) >> 5) & 0x01)
        ...
        /**
         * [Bit 7] Page size; must be 0 (otherwise, this entry maps a 2-MByte
         * page).
         */
        UINT64 LargePage : 1;
...
#define PDE_64_RESTART(_)   (((_) >> 11) & 0x01)
        ...
        /**
         * [Bits 47:12] Physical address of 4-KByte aligned page table
         * referenced by this entry.
         */
        UINT64 PageFrameNumber : 36;
...
#define PDE_64_IGNORED_2(_)   (((_) >> 52) & 0x7FF)
        ...
        /**
         * [Bit 63] If IA32_EFER.NXE = 1, execute-disable (if 1, instruction
         * fetches are not allowed from the 2-MByte region controlled by this
         * entry); otherwise, reserved (must be 0).
         *
         * @see Vol3A[4.6(Access Rights)]
         */
...
typedef enum {
    /**
     * If the INVPCID type is 0, the logical processor invalidates
     * mappings-except global translations-associated with the PCID specified in
     * the INVPCID descriptor and that would be used to translate the linear
     * address specified in the INVPCID descriptor.2 (The instruction may also
     * invalidate global translations, as well as mappings associated with other
     * PCIDs and for other linear addresses.)
     */
    ...
    /**
     * If the INVPCID type is 3, the logical processor invalidates
...
typedef union {
    struct {
         ...
         * @brief Type field
         *
         * [Bits 11:8] Indicates the segment or gate type and specifies the
         * kinds of access that can be made to the segment and the direction of
         * growth. The interpretation of this field depends on whether the
         * descriptor type flag specifies an application (code or data)
         * descriptor or a system descriptor. The encoding of the type field is
         * different for code, data, and system descriptors.
         *
...
#define SEGMENT_ACCESS_RIGHTS_DESCRIPTOR_TYPE(_)   (((_) >> 12) & 0x01)
         ...
         * privilege level can range from 0 to 3, with 0 being the most
         * privileged level. The DPL is used to control access to the segment.
         * See Section 5.5, "Privilege Levels", for a description of the
         * relationship of the DPL to the CPL of the executing code segment and
...
#define SEGMENT_ACCESS_RIGHTS_SYSTEM(_)   (((_) >> 20) & 0x01)
         ...
         *
         * [Bit 21] In IA-32e mode, bit 21 of the second doubleword of the
         * segment descriptor indicates whether a code segment contains native
         * 64-bit code. A value of 1 indicates instructions in this code segment
         * are executed in 64-bit mode. A value of 0 indicates the instructions
         * in this code segment are executed in compatibility mode. If L-bit is
         * set, then D-bit must be cleared. When not in IA-32e mode or for
...
#define SEGMENT_ACCESS_RIGHTS_LONG_MODE(_)   (((_) >> 21) & 0x01)
         ...
         * upper bound) flag
         *
         * [Bit 22] Performs different functions depending on whether the
         * segment descriptor is an executable code segment, an expand-down data
         ...
         * pops, and calls). If the flag is set, a 32-bit stack pointer is used,
         * which is stored in the 32-bit ESP register; if the flag is clear, a
         * 16-bit stack pointer is used, which is stored in the 16- bit SP
         * register. If the stack segment is set up to be an expand-down data
         * segment (described in the next paragraph), the B flag also specifies
         * the upper bound of the stack segment.
...
#define SEGMENT_ACCESS_RIGHTS_DEFAULT_BIG(_)   (((_) >> 22) & 0x01)
         ...
         * when checking the offset against the segment limit. For example, when
         * the granularity flag is set, a limit of 0 results in valid offsets
         * from 0 to 4095.
         */
...
typedef struct {
     ...
     * KBytes to 4 GBytes, in 4-KByte increments. The processor uses the segment
     * limit in two different ways, depending on whether the segment is an
     * expand-up or an expand-down segment. For expand-up segments, the offset
     * in a logical address can range from 0 to the segment limit. Offsets
     * greater than the segment limit generate general-protection exceptions
     * (\#GP, for all segments other than SS) or stack-fault exceptions (\#SS
     ...
     * FFFFFFFFH or FFFFH, depending on the setting of the B flag. Offsets less
     * than or equal to the segment limit generate general-protection exceptions
     * or stack-fault exceptions. Decreasing the value in the segment limit
     * field for an expanddown segment allocates new memory at the bottom of the
     * segment's address space, rather than at the top. IA-32 architecture
     * stacks always grow downwards, making this mechanism convenient for
     * expandable stacks.
     *
     * @see Vol3A[3.4.5.1(Code- and Data-Segment Descriptor Types)]
     */
     ...
     * to form a single 32-bit value. Segment base addresses should be aligned
    ...
    union {
        struct {
            /**
             * [Bits 7:0] Base address field (23:16); see description of
             * $BASE_LOW for more details.
             */
...
#define SEGMENT__BASE_ADDRESS_MIDDLE(_)   (((_) >> 0) & 0xFF)
             ...
             *
             * [Bits 11:8] Indicates the segment or gate type and specifies the
             * kinds of access that can be made to the segment and the direction
             * of growth. The interpretation of this field depends on whether
             * the descriptor type flag specifies an application (code or data)
...
#define SEGMENT__TYPE(_)   (((_) >> 8) & 0x0F)
             ...
             *
             * [Bit 12] Specifies whether the segment descriptor is for a system
             * segment (S flag is clear) or a code or data segment (S flag is
             * set).
             */
            UINT32 DescriptorType : 1;
...
#define SEGMENT__DESCRIPTOR_TYPE(_)   (((_) >> 12) & 0x01)
             ...
             * [Bits 14:13] Specifies the privilege level of the segment. The
             * privilege level can range from 0 to 3, with 0 being the most
             * privileged level. The DPL is used to control access to the
             * segment. See Section 5.5, "Privilege Levels", for a description
             * of the relationship of the DPL to the CPL of the executing code
...
#define SEGMENT__DESCRIPTOR_PRIVILEGE_LEVEL(_)   (((_) >> 13) & 0x03)
             ...
             * @brief P (segment-present) flag
             *
             * [Bit 15] Indicates whether the segment is present in memory (set)
             * or not present (clear). If this flag is clear, the processor
             * generates a segment-not-present exception (\#NP) when a segment
             * selector that points to the segment descriptor is loaded into a
             * segment register. Memory management software can use this flag to
             * control which segments are actually loaded into physical memory
             * at a given time. It offers a control in addition to paging for
...
#define SEGMENT__PRESENT(_)   (((_) >> 15) & 0x01)
            ...
            /**
             * [Bits 19:16] Segment limit field (19:16); see description of
             * $LIMIT_LOW for more details.
             */
...
#define SEGMENT__SEGMENT_LIMIT_HIGH(_)   (((_) >> 16) & 0x0F)
             ...
             * @brief Available bit
             *
             * [Bit 20] Bit 20 of the second doubleword of the segment
             * descriptor is available for use by system software.
             */
            UINT32 System : 1;
...
#define SEGMENT__SYSTEM(_)   (((_) >> 20) & 0x01)
             ...
             *
             * [Bit 21] In IA-32e mode, bit 21 of the second doubleword of the
             * segment descriptor indicates whether a code segment contains
             * native 64-bit code. A value of 1 indicates instructions in this
             * code segment are executed in 64-bit mode. A value of 0 indicates
             * the instructions in this code segment are executed in
             * compatibility mode. If L-bit is set, then D-bit must be cleared.
             * When not in IA-32e mode or for non-code segments, bit 21 is
...
#define SEGMENT__LONG_MODE(_)   (((_) >> 21) & 0x01)
             ...
             *
             * [Bit 22] Performs different functions depending on whether the
             * segment descriptor is an executable code segment, an expand-down
             * data segment, or a stack segment. (This flag should always be set
             * to 1 for 32-bit code and data segments and to 0 for 16-bit code
             * and data segments.)
             * - Executable code segment. The flag is called the D flag and it
             * indicates the default length for effective addresses and operands
             ...
             * clear, a 16-bit stack pointer is used, which is stored in the 16-
             * bit SP register. If the stack segment is set up to be an
             * expand-down data segment (described in the next paragraph), the B
...
#define SEGMENT__DEFAULT_BIG(_)   (((_) >> 22) & 0x01)
             ...
             * @brief G (granularity) flag
             *
             * [Bit 23] Determines the scaling of the segment limit field. When
             * the granularity flag is clear, the segment limit is interpreted
             * in byte units; when flag is set, the segment limit is interpreted
             * in 4-KByte units. (This flag does not affect the granularity of
             * the base address; it is always byte granular.) When the
             * granularity flag is set, the twelve least significant bits of an
             * offset are not tested when checking the offset against the
             * segment limit. For example, when the granularity flag is set, a
             * limit of 0 results in valid offsets from 0 to 4095.
             */
            UINT32 Granularity : 1;
...
#define SEGMENT__GRANULARITY(_)   (((_) >> 23) & 0x01)
            ...
            /**
             * [Bits 31:24] Base address field (31:24); see description of
             * $BASE_LOW for more details.
             */
...
#define SEGMENT__BASE_ADDRESS_HIGH(_)   (((_) >> 24) & 0xFF)
    ...
    /**
     * Base address field (32:63); see description of $BASE_LOW for more
     * details.
     */
...
typedef union {
    struct {
        /**
         * [Bits 1:0] Specifies the privilege level of the selector. The
         * privilege level can range from 0 to 3, with 0 being the most
         * privileged level.
         *
...
#define SEGMENT_SELECTOR_TABLE(_)   (((_) >> 2) & 0x01)
         ...
         * segment descriptor) and adds the result to the base address of the
         * GDT or LDT (from the GDTR or LDTR register, respectively).
         */
        UINT16 Index : 13;
...
typedef struct {
    /**
     * The 32-bit value that would have been saved into the VMCS as an exit
     * reason had a VM exit occurred instead of the virtualization exception.
     * For EPT violations, this value is 48 (00000030H).
     */
    UINT32 Reason;
     ...
     * guest-linear address had a VM exit occurred instead of the virtualization
     * exception.
     */
    ...
    /**
     * The 64-bit value that would have been saved into the VMCS as a
     * guest-physical address had a VM exit occurred instead of the
...
typedef union {
    struct {
         ...
         * @brief B0 - B3
         *
         * [Bits 3:0] When set, each of these bits indicates that the
         * corresponding breakpoint condition was met. Any of these bits may be
         * set even if its corresponding enabling bit in DR7 is not set.
         */
        UINT64 BreakpointCondition : 4;
...
#define VMX_EXIT_QUALIFICATION_DEBUG_EXCEPTION_DEBUG_REGISTER_ACCESS_DETECTED( \
    ...
    (((_) >> 13) & 0x01)
         ...
         * exception is either the execution of a single instruction (if
         * RFLAGS.TF = 1 and IA32_DEBUGCTL.BTF = 0) or a taken branch (if
...
typedef union {
    struct {
         ...
         * always 0 on processors that do not support Intel 64 architecture as
         * they do not support CR8.
         */
...
#define VMX_EXIT_QUALIFICATION_GENREG_R15 0x0000000F
        ...
        /**
         * [Bits 31:16] For LMSW, the LMSW source data. For CLTS and MOV CR,
         * cleared to 0.
         */
...
#define VMX_EXIT_QUALIFICATION_ENCODING_IMMEDIATE 0x00000001
        ...
        /**
         * [Bits 31:16] Port number (as specified in DX or in an immediate
         * operand).
         */
...
typedef union {
    struct {
        /**
         * [Bits 11:0] - If the APIC-access VM exit is due to a linear access,
         * the offset of access within the APIC page.
         * - Undefined if the APIC-access VM exit is due a guest-physical
         * access.
         */
...
#define VMX_EXIT_QUALIFICATION_EPT_VIOLATION_WRITE_ACCESS(_)   (((_) >> 1) & 0x01)
        ...
        /**
         * [Bit 2] Set if the access causing the EPT violation was an
         * instruction fetch.
         */
...
#define VMX_EXIT_QUALIFICATION_EPT_VIOLATION_EXECUTE_ACCESS(_) \
    (((_) >> 2) & 0x01)
        ...
        /**
         * [Bit 3] The logical-AND of bit 0 in the EPT paging-structure entries
         * used to translate the guest-physical address of the access causing
         * the EPT violation (indicates whether the guest-physical address was
         * readable).
         */
...
#define VMX_EXIT_QUALIFICATION_EPT_VIOLATION_EPT_READABLE(_)   (((_) >> 3) & 0x01)
        ...
        /**
         * [Bit 4] The logical-AND of bit 1 in the EPT paging-structure entries
         * used to translate the guest-physical address of the access causing
         * the EPT violation (indicates whether the guest-physical address was
         * writeable).
         */
...
#define VMX_EXIT_QUALIFICATION_EPT_VIOLATION_EPT_WRITEABLE(_) \
    (((_) >> 4) & 0x01)
        ...
        /**
         * [Bit 5] The logical-AND of bit 2 in the EPT paging-structure entries
         * used to translate the guest-physical address of the access causing
         * the EPT violation. If the "mode-based execute control for EPT"
         * VM-execution control is 0, this indicates whether the guest-physical
         * address was executable. If that control is 1, this indicates whether
         * the guest-physical address was executable for supervisor-mode linear
         * addresses.
         */
...
#define VMX_EXIT_QUALIFICATION_EPT_VIOLATION_EPT_EXECUTABLE(_) \
    (((_) >> 5) & 0x01)
         ...
         * 0, the value of this bit is undefined. If that control is 1, this bit
         * is the logical-AND of bit 10 in the EPT paging-structures entries
         * used to translate the guest-physical address of the access causing
         * the EPT violation. In this case, it indicates whether the
         * guest-physical address was executable for user-mode linear addresses.
         */
...
#define VMX_EXIT_QUALIFICATION_EPT_VIOLATION_VALID_GUEST_LINEAR_ADDRESS(_) \
    (((_) >> 7) & 0x01)
         ...
         * accessed or dirty bit. Reserved if bit 7 is 0 (cleared to 0).
         */
...
#define VMX_EXIT_QUALIFICATION_EPT_VIOLATION_CAUSED_BY_TRANSLATION(_) \
    (((_) >> 8) & 0x01)
        ...
        /**
         * [Bit 9] This bit is 0 if the linear address is a supervisor-mode
         * linear address and 1 if it is a user-mode linear address. Otherwise,
         * this bit is undefined.
         *
         * @remarks If bit 7 is 1, bit 8 is 1, and the processor supports
         * advanced VM-exit information for EPT violations. (If CR0.PG = 0, the
         * translation of every linear address is a user-mode linear address and
         * thus this bit will be 1.)
         */
...
#define VMX_EXIT_QUALIFICATION_EPT_VIOLATION_USER_MODE_LINEAR_ADDRESS(_) \
    (((_) >> 9) & 0x01)
         ...
         * read-only page and 1 if it translates to a read/write page.
         * Otherwise, this bit is undefined
         *
         * @remarks If bit 7 is 1, bit 8 is 1, and the processor supports
         * advanced VM-exit information for EPT violations. (If CR0.PG = 0,
         * every linear address is read/write and thus this bit will be 1.)
         */
...
#define VMX_EXIT_QUALIFICATION_EPT_VIOLATION_READABLE_WRITABLE_PAGE(_) \
    (((_) >> 10) & 0x01)
         ...
         * @remarks If bit 7 is 1, bit 8 is 1, and the processor supports
         * advanced VM-exit information for EPT violations. (If CR0.PG = 0,
         * CR4.PAE = 0, or IA32_EFER.NXE = 0, every linear address is executable
         * and thus this bit will be 0.)
         */
...
#define VMX_EXIT_QUALIFICATION_EPT_VIOLATION_NMI_UNBLOCKING(_) \
    (((_) >> 12) & 0x01)
        ...
        /**
         * [Bit 13] Set if the access causing the EPT violation was a
         * shadow-stack access.
         */
...
#define VMX_EXIT_QUALIFICATION_EPT_VIOLATION_SHADOW_STACK_ACCESS(_) \
    (((_) >> 13) & 0x01)
        ...
        /**
         * [Bit 14] If supervisor shadow-stack control is enabled (by setting
         * bit 7 of EPTP), this bit is the same as bit 60 in the EPT
         * paging-structure entry that maps the page of the guest-physical
         * address of the access causing the EPT violation. Otherwise (or if
         * translation of the guest-physical address terminates before reaching
         * an EPT paging-structure entry that maps a page), this bit is
         * undefined.
         */
        UINT64 SupervisorShadowStack : 1;
...
#define VMX_EXIT_QUALIFICATION_EPT_VIOLATION_SUPERVISOR_SHADOW_STACK(_) \
    (((_) >> 14) & 0x01)
        ...
        /**
         * [Bit 15] This bit is set if the EPT violation was caused as a result
         * of guest-paging verification.
         */
...
#define VMX_EXIT_QUALIFICATION_EPT_VIOLATION_GUEST_PAGING_VERIFICATION(_) \
    (((_) >> 15) & 0x01)
        ...
        /**
         * [Bit 16] This bit is set if the access was asynchronous to
         * instruction execution not the result of event delivery. (The bit is
         * set if the access is related to trace output by Intel PT; see
         * Section 25.5.4.) Otherwise, this bit is cleared.
         */
...
typedef union {
    struct {
         ...
         * [Bits 9:7] 0: 16-bit
         * 1: 32-bit
         * 2: 64-bit (used only on processors that support Intel 64
         * architecture) Other values not used.
         */
...
#define VMX_VMEXIT_INSTRUCTION_INFO_INS_OUTS_ADDRESS_SIZE(_)   (((_) >> 7) & 0x07)
         ...
         * 4: FS
         * 5: GS
         * Other values not used. Undefined for VM exits due to execution of
         * INS.
         */
...
typedef union {
    struct {
         ...
         * architecture) Undefined for instructions with no index register (bit
         * 22 is set).
         */
        UINT64 Scaling : 2;
...
#define VMX_VMEXIT_INSTRUCTION_INFO_INVALIDATE_SEGMENT_REGISTER(_) \
    (((_) >> 15) & 0x07)
        ...
        /**
         * [Bits 21:18] General-purpose register. Undefined for instructions
         * with no index register (bit 22 is set).
         */
        UINT64 GeneralPurposeRegister : 4;
...
#define VMX_VMEXIT_INSTRUCTION_INFO_INVALIDATE_GENERAL_PURPOSE_REGISTER_INVALID( \
    ...
    (((_) >> 22) & 0x01)
        ...
        /**
         * [Bits 26:23] BaseReg (encoded as IndexReg above). Undefined for
         * memory instructions with no base register (bit 27 is set).
         */
...
#define VMX_VMEXIT_INSTRUCTION_INFO_LDTR_TR_ACCESS_REG_1(_)   (((_) >> 3) & 0x0F)
         ...
         * 1: 32-bit
         * 2: 64-bit (used only on processors that support Intel 64
         * architecture) Other values not used. Undefined for register
...
#define VMX_VMEXIT_INSTRUCTION_INFO_LDTR_TR_ACCESS_SEGMENT_REGISTER(_) \
    (((_) >> 15) & 0x07)
         ...
         * instructions (bit 10 is set) and for memory instructions with no
         * index register (bit 10 is clear and bit 22 is set).
         */
        UINT64 GeneralPurposeRegister : 4;
...
#define VMX_VMEXIT_INSTRUCTION_INFO_LDTR_TR_ACCESS_GENERAL_PURPOSE_REGISTER_INVALID( \
    ...
    (((_) >> 22) & 0x01)
        ...
        /**
         * [Bits 26:23] BaseReg (encoded as IndexReg above). Undefined for
         * register instructions (bit 10 is set) and for memory instructions
         * with no base register (bit 10 is clear and bit 27 is set).
         */
        UINT64 BaseRegister : 4;
...
#define VMX_VMEXIT_INSTRUCTION_INFO_LDTR_TR_ACCESS_BASE_REGISTER(_) \
    (((_) >> 23) & 0x0F)
        ...
        /**
         * [Bit 27] BaseReg invalid (0 = valid; 1 = invalid). Undefined for
         * register instructions (bit 10 is set).
         */
        UINT64 BaseRegisterInvalid : 1;
...
typedef union {
    struct {
         ...
         * 2: scale by 4
         * 3: scale by 8 (used only on processors that support Intel 64
         * architecture) Undefined for register instructions (bit 10 is set) and
         * for memory instructions with no index register (bit 10 is clear and
         * bit 22 is set).
         */
        UINT64 Scaling : 2;
...
#define VMX_SEGMENT_ACCESS_RIGHTS_AVAILABLE_BIT(_)   (((_) >> 12) & 0x01)
        ...
        /**
         * [Bit 13] Reserved (except for CS). L - 64-bit mode active (for CS
         * only).
         */
        UINT32 LongMode : 1;
...
typedef union {
    struct {
        /**
         * [Bit 0] Execution of STI with RFLAGS.IF = 0 blocks maskable
         * interrupts on the instruction boundary following its execution.1
...
#define VMX_INTERRUPTIBILITY_STATE_BLOCKING_BY_STI(_)   (((_) >> 0) & 0x01)
         ...
         * certain debug exceptions as well as interrupts (maskable and
         * nonmaskable) on the instruction boundary following its execution.
         * Setting this bit indicates that this blocking is in effect. This
         * document uses the term "blocking by MOV SS," but it applies equally
         * to POP SS.
         *
...
#define VMX_INTERRUPTIBILITY_STATE_BLOCKING_BY_MOV_SS(_)   (((_) >> 1) & 0x01)
         ...
         * processor is in system-management mode (SMM). Setting this bit
...
#define VMX_INTERRUPTIBILITY_STATE_BLOCKING_BY_SMI(_)   (((_) >> 2) & 0x01)
        ...
        /**
         * [Bit 3] Delivery of a non-maskable interrupt (NMI) or a
         * system-management interrupt (SMI) blocks subsequent NMIs until the
         * next execution of IRET. Setting this bit indicates that blocking of
         * NMIs is in effect. Clearing this bit does not imply that NMIs are not
         * (temporarily) blocked for other reasons. If the "virtual NMIs"
         * VM-execution control is 1, this bit does not control the blocking of
         * NMIs. Instead, it refers to "virtual-NMI blocking" (the fact that
         * guest software is not ready for an NMI).
         *
...
#define VMX_INTERRUPTIBILITY_STATE_BLOCKING_BY_NMI(_)   (((_) >> 3) & 0x01)
        ...
        /**
         * [Bit 4] A VM exit saves this bit as 1 to indicate that the VM exit
...
typedef enum {
    ...
    /**
     * The logical processor is inactive because it executed the HLT
     * instruction.
     */
    VmxHlt = 0x00000001,
...
typedef union {
    struct {
        /**
         * [Bit 0] When set, indicates that the corresponding breakpoint
         * condition was met. May be set even if the corresponding enabling bit
         * in DR7 is not set.
         */
        UINT64 B0 : 1;
...
#define VMX_PENDING_DEBUG_EXCEPTIONS_B0(_)   (((_) >> 0) & 0x01)
        ...
        /**
         * [Bit 1] When set, indicates that the corresponding breakpoint
         * condition was met. May be set even if the corresponding enabling bit
         * in DR7 is not set.
         */
        UINT64 B1 : 1;
...
#define VMX_PENDING_DEBUG_EXCEPTIONS_B1(_)   (((_) >> 1) & 0x01)
        ...
        /**
         * [Bit 2] When set, indicates that the corresponding breakpoint
         * condition was met. May be set even if the corresponding enabling bit
         * in DR7 is not set.
         */
        UINT64 B2 : 1;
...
#define VMX_PENDING_DEBUG_EXCEPTIONS_B2(_)   (((_) >> 2) & 0x01)
        ...
        /**
         * [Bit 3] When set, indicates that the corresponding breakpoint
         * condition was met. May be set even if the corresponding enabling bit
         * in DR7 is not set.
         */
        UINT64 B3 : 1;
...
#define VMX_PENDING_DEBUG_EXCEPTIONS_ENABLED_BREAKPOINT(_)   (((_) >> 12) & 0x01)
        ...
        /**
         * [Bit 14] When set, this bit indicates that a debug exception would
...
#define VMX_PENDING_DEBUG_EXCEPTIONS_BS(_)   (((_) >> 14) & 0x01)
        ...
        /**
         * [Bit 16] When set, this bit indicates that a debug exception (\#DB)
         * or a breakpoint exception (\#BP) occurred inside an RTM region while
         * advanced debugging of RTM transactional regions was enabled.
         */
        UINT64 Rtm : 1;
...
typedef union {
    struct {
        /**
         * [Bits 15:0] Provides basic information about the cause of the VM exit
         * (if bit 31 is clear) or of the VM-entry failure (if bit 31 is set).
         */
...
#define VMX_VMEXIT_REASON_RESERVED1(_)   (((_) >> 17) & 0x3FF)
        ...
        /**
         * [Bit 27] A VM exit saves this bit as 1 to indicate that the VM exit
         * was incident to enclave mode.
         */
...
#define EPT_PAGE_WALK_LENGTH_4            0x00000003
        ...
        /**
         * [Bit 6] Setting this control to 1 enables accessed and dirty flags
         * for EPT.
         *
         * @see Vol3C[28.2.4(Accessed and Dirty Flags for EPT)]
         */
...
#define EPT_POINTER_ENABLE_ACCESS_AND_DIRTY_FLAGS(_)   (((_) >> 6) & 0x01)
        ...
        /**
         * [Bit 7] Setting this control to 1 enables enforcement of access
         * rights for supervisor shadow-stack pages.
         *
         * @see Vol3C[28.3.3.2(EPT Violations)]
         */
...
#define EPT_POINTER_ENABLE_SUPERVISOR_SHADOW_STACK_PAGES(_)   (((_) >> 7) & 0x01)
        ...
        /**
         * [Bits 47:12] Bits N-1:12 of the physical address of the 4-KByte
         * aligned EPT PML4 table.
         */
        UINT64 PageFrameNumber : 36;
...
#define EPT_PML4E_WRITE_ACCESS(_)   (((_) >> 1) & 0x01)
        ...
        /**
         * [Bit 2] If the "mode-based execute control for EPT" VM-execution
         * control is 0, execute access; indicates whether instruction fetches
         * are allowed from the 512-GByte region controlled by this entry. If
         * that control is 1, execute access for supervisor-mode linear
         * addresses; indicates whether instruction fetches are allowed from
         * supervisor-mode linear addresses in the 512-GByte region controlled
         * by this entry.
         */
        UINT64 ExecuteAccess : 1;
...
#define EPT_PML4E_EXECUTE_ACCESS(_)   (((_) >> 2) & 0x01)
        ...
        /**
         * [Bit 8] If bit 6 of EPTP is 1, accessed flag for EPT; indicates
         * whether software has accessed the 512-GByte region controlled by this
...
#define EPT_PML4E_ACCESSED(_)   (((_) >> 8) & 0x01)
         ...
         * "mode-based execute control for EPT" VM-execution control is 1,
         * indicates whether instruction fetches are allowed from user-mode
         * linear addresses in the 512-GByte region controlled by this entry. If
         * that control is 0, this bit is ignored.
         */
...
#define EPT_PDPTE_1GB_WRITE_ACCESS(_)   (((_) >> 1) & 0x01)
         ...
         * [Bit 2] If the "mode-based execute control for EPT" VM-execution
         * control is 0, execute access; indicates whether instruction fetches
         * are allowed from the 1-GByte page controlled by this entry. If that
         * control is 1, execute access for supervisor-mode linear addresses;
         * indicates whether instruction fetches are allowed from
         * supervisor-mode linear addresses in the 1-GByte page controlled by
         * this entry.
         */
        UINT64 ExecuteAccess : 1;
...
#define EPT_PDPTE_1GB_LARGE_PAGE(_)   (((_) >> 7) & 0x01)
        ...
        /**
         * [Bit 8] If bit 6 of EPTP is 1, accessed flag for EPT; indicates
         * whether software has accessed the 1-GByte page referenced by this
         * entry. Ignored if bit 6 of EPTP is 0.
         *
         * @see Vol3C[28.2.4(Accessed and Dirty Flags for EPT)]
         */
...
#define EPT_PDPTE_1GB_DIRTY(_)   (((_) >> 9) & 0x01)
         ...
         * "mode-based execute control for EPT" VM-execution control is 1,
         * indicates whether instruction fetches are allowed from user-mode
         * linear addresses in the 1-GByte page controlled by this entry. If
         * that control is 0, this bit is ignored.
         */
        UINT64 UserModeExecute : 1;
...
#define EPT_PDPTE_1GB_PAGE_FRAME_NUMBER(_)   (((_) >> 30) & 0x3FFFF)
         ...
         * structures used to access the 1-GByte page controlled by this entry
         * (see Section 28.3.3.2). If that control is 0, this bit is ignored.
         *
         * @see Vol3C[28.3.3.2(EPT Violations)]
         */
...
#define EPT_PDPTE_1GB_PAGING_WRITE_ACCESS(_)   (((_) >> 58) & 0x01)
         ...
         * whether supervisor shadow stack accesses are allowed to
         * guest-physical addresses in the 1-GByte page mapped by this entry
         * (see Section 28.3.3.2)
         *
         * @see Vol3C[28.3.3.2(EPT Violations)]
         */
        UINT64 SupervisorShadowStack : 1;
...
#define EPT_PDPTE_1GB_SUPERVISOR_SHADOW_STACK(_)   (((_) >> 60) & 0x01)
        ...
        /**
         * [Bit 63] Suppress \#VE. If the "EPT-violation \#VE" VM-execution
         * control is 1, EPT violations caused by accesses to this page are
         * convertible to virtualization exceptions only if this bit is 0. If
         * "EPT-violation \#VE" VMexecution control is 0, this bit is ignored.
         *
...
#define EPT_PDPTE_WRITE_ACCESS(_)   (((_) >> 1) & 0x01)
         ...
         * [Bit 2] If the "mode-based execute control for EPT" VM-execution
         * control is 0, execute access; indicates whether instruction fetches
         * are allowed from the 1-GByte region controlled by this entry. If that
         * control is 1, execute access for supervisor-mode linear addresses;
         * indicates whether instruction fetches are allowed from
         * supervisor-mode linear addresses in the 1-GByte region controlled by
         * this entry.
         */
        UINT64 ExecuteAccess : 1;
...
#define EPT_PDPTE_EXECUTE_ACCESS(_)   (((_) >> 2) & 0x01)
        ...
        /**
         * [Bit 8] If bit 6 of EPTP is 1, accessed flag for EPT; indicates
         * whether software has accessed the 1-GByte region controlled by this
         * entry. Ignored if bit 6 of EPTP is 0.
         *
         * @see Vol3C[28.2.4(Accessed and Dirty Flags for EPT)]
         */
...
#define EPT_PDPTE_ACCESSED(_)   (((_) >> 8) & 0x01)
         ...
         * "mode-based execute control for EPT" VM-execution control is 1,
         * indicates whether instruction fetches are allowed from user-mode
         * linear addresses in the 1-GByte region controlled by this entry. If
         * that control is 0, this bit is ignored.
         */
        UINT64 UserModeExecute : 1;
...
#define EPT_PDE_2MB_WRITE_ACCESS(_)   (((_) >> 1) & 0x01)
         ...
         * [Bit 2] If the "mode-based execute control for EPT" VM-execution
         * control is 0, execute access; indicates whether instruction fetches
         * are allowed from the 2-MByte page controlled by this entry. If that
         * control is 1, execute access for supervisor-mode linear addresses;
         * indicates whether instruction fetches are allowed from
         * supervisor-mode linear addresses in the 2-MByte page controlled by
         * this entry.
         */
        UINT64 ExecuteAccess : 1;
...
#define EPT_PDE_2MB_LARGE_PAGE(_)   (((_) >> 7) & 0x01)
        ...
        /**
         * [Bit 8] If bit 6 of EPTP is 1, accessed flag for EPT; indicates
         * whether software has accessed the 2-MByte page referenced by this
         * entry. Ignored if bit 6 of EPTP is 0.
         *
         * @see Vol3C[28.2.4(Accessed and Dirty Flags for EPT)]
         */
...
#define EPT_PDE_2MB_DIRTY(_)   (((_) >> 9) & 0x01)
         ...
         * "mode-based execute control for EPT" VM-execution control is 1,
         * indicates whether instruction fetches are allowed from user-mode
         * linear addresses in the 2-MByte page controlled by this entry. If
         * that control is 0, this bit is ignored.
         */
        UINT64 UserModeExecute : 1;
...
#define EPT_PDE_2MB_PAGE_FRAME_NUMBER(_)   (((_) >> 21) & 0x7FFFFFF)
         ...
         * [Bit 57] Verify guest paging. If the "guest-paging verification"
         * VM-execution control is 1, indicates limits on the guest paging
         * structures used to access the 2-MByte page controlled by this entry
         * (see Section 28.3.3.2). If that control is 0, this bit is ignored.
         *
         * @see Vol3C[28.3.3.2(EPT Violations)]
         */
...
#define EPT_PDE_2MB_PAGING_WRITE_ACCESS(_)   (((_) >> 58) & 0x01)
         ...
         * [Bit 60] Supervisor shadow stack. If bit 7 of EPTP is 1, indicates
         * whether supervisor shadow stack accesses are allowed to
         * guest-physical addresses in the 2-MByte page mapped by this entry
         * (see Section 28.3.3.2)
         *
         * @see Vol3C[28.3.3.2(EPT Violations)]
         */
...
#define EPT_PDE_WRITE_ACCESS(_)   (((_) >> 1) & 0x01)
         ...
         * [Bit 2] If the "mode-based execute control for EPT" VM-execution
         * control is 0, execute access; indicates whether instruction fetches
         * are allowed from the 2-MByte region controlled by this entry. If that
         * control is 1, execute access for supervisor-mode linear addresses;
         * indicates whether instruction fetches are allowed from
         * supervisor-mode linear addresses in the 2-MByte region controlled by
         * this entry.
         */
        UINT64 ExecuteAccess : 1;
...
#define EPT_PDE_EXECUTE_ACCESS(_)   (((_) >> 2) & 0x01)
        ...
        /**
         * [Bit 8] If bit 6 of EPTP is 1, accessed flag for EPT; indicates
         * whether software has accessed the 2-MByte region controlled by this
         * entry. Ignored if bit 6 of EPTP is 0.
         *
         * @see Vol3C[28.2.4(Accessed and Dirty Flags for EPT)]
         */
...
#define EPT_PDE_ACCESSED(_)   (((_) >> 8) & 0x01)
         ...
         * "mode-based execute control for EPT" VM-execution control is 1,
         * indicates whether instruction fetches are allowed from user-mode
         * linear addresses in the 2-MByte region controlled by this entry. If
         * that control is 0, this bit is ignored.
         */
        UINT64 UserModeExecute : 1;
...
#define EPT_PTE_WRITE_ACCESS(_)   (((_) >> 1) & 0x01)
         ...
         * [Bit 2] If the "mode-based execute control for EPT" VM-execution
         * control is 0, execute access; indicates whether instruction fetches
         * are allowed from the 4-KByte page controlled by this entry. If that
         * control is 1, execute access for supervisor-mode linear addresses;
         * indicates whether instruction fetches are allowed from
         * supervisor-mode linear addresses in the 4-KByte page controlled by
         * this entry.
         */
        UINT64 ExecuteAccess : 1;
...
#define EPT_PTE_IGNORE_PAT(_)   (((_) >> 6) & 0x01)
        ...
        /**
         * [Bit 8] If bit 6 of EPTP is 1, accessed flag for EPT; indicates
         * whether software has accessed the 4-KByte page referenced by this
         * entry. Ignored if bit 6 of EPTP is 0.
         *
         * @see Vol3C[28.2.4(Accessed and Dirty Flags for EPT)]
         */
...
#define EPT_PTE_DIRTY(_)   (((_) >> 9) & 0x01)
         ...
         * "mode-based execute control for EPT" VM-execution control is 1,
         * indicates whether instruction fetches are allowed from user-mode
         * linear addresses in the 4-KByte page controlled by this entry. If
         * that control is 0, this bit is ignored.
         */
        UINT64 UserModeExecute : 1;
...
#define EPT_PTE_PAGE_FRAME_NUMBER(_)   (((_) >> 12) & 0xFFFFFFFFF)
         ...
         * [Bit 57] Verify guest paging. If the "guest-paging verification"
         * VM-execution control is 1, indicates limits on the guest paging
         * structures used to access the 4-KByte page controlled by this entry
         * (see Section 28.3.3.2). If that control is 0, this bit is ignored.
         *
         * @see Vol3C[28.3.3.2(EPT Violations)]
         */
...
#define EPT_PTE_PAGING_WRITE_ACCESS(_)   (((_) >> 58) & 0x01)
         ...
         * [Bit 60] Supervisor shadow stack. If bit 7 of EPTP is 1, indicates
         * whether supervisor shadow stack accesses are allowed to
         * guest-physical addresses in the 4-KByte page mapped by this entry
         * (see Section 28.3.3.2)
         *
         * @see Vol3C[28.3.3.2(EPT Violations)]
         */
...
#define EPT_PTE_SUPERVISOR_SHADOW_STACK(_)   (((_) >> 60) & 0x01)
        ...
        /**
         * [Bit 61] Sub-page write permissions. If the "sub-page write
         * permissions for EPT" VM-execution control is 1, writes to individual
         * 128-byte regions of the 4-KByte page referenced by this entry may be
         * allowed even if the page would normally not be writable (see
         * Section 28.3.4). If "sub-page write permissions for EPT" VM-execution
         * control is 0, this bit is ignored.
         *
...
typedef enum {
    /**
     * If the INVVPID type is 0, the logical processor invalidates linear
     * mappings and combined mappings associated with the VPID specified in the
     * INVVPID descriptor and that would be used to translate the linear address
     * specified in of the INVVPID descriptor. Linear mappings and combined
     * mappings for that VPID and linear address are invalidated for all PCIDs
     * and, for combined mappings, all EP4TAs. (The instruction may also
     ...
     * mappings and combined mappings associated with the VPID specified in the
     * INVVPID descriptor. Linear mappings and combined mappings for that VPID
     * are invalidated for all PCIDs and, for combined mappings, all EP4TAs.
     * (The instruction may also invalidate mappings associated with other
     * VPIDs).
     */
    InvvpidSingleContext = 0x00000001,

    /**
     * If the INVVPID type is 2, the logical processor invalidates linear
     * mappings and combined mappings associated with all VPIDs except VPID
     * 0000H and with all PCIDs. (The instruction may also invalidate linear
     * mappings with VPID 0000H.) Combined mappings are invalidated for all
     * EP4TAs.
     */
     ...
     * mappings and combined mappings associated with the VPID specified in the
     * INVVPID descriptor. Linear mappings and combined mappings for that VPID
     * are invalidated for all PCIDs and, for combined mappings, all EP4TAs. The
     * logical processor is not required to invalidate information that was used
     * for global translations (although it may do so). (The instruction may
     * also invalidate mappings associated with other VPIDs).
     *
...
typedef union {
    struct {
        ...
        /**
         * [Bit 3] Page-level write-through; indirectly determines the memory
         * type used to access the first HLAT paging structure during
         * linear-address translation.
         */
        UINT64 PageLevelWriteThrough : 1;
...
typedef struct {
    struct {
         ...
         *
         * [Bits 30:0] Processors that maintain VMCS data in different formats
         * (see below) use different VMCS revision identifiers. These
         * identifiers enable software to avoid using a VMCS region formatted
         * for one processor on a processor that uses a different format.
         * Software should write the VMCS revision identifier to the VMCS region
         * before using that region for a VMCS. The VMCS revision identifier is
         * never written by the processor; VMPTRLD fails if its operand
         * references a VMCS region whose VMCS revision identifier differs from
         * that used by the processor. Software can discover the VMCS revision
         * identifier that a processor uses by reading the VMX capability MSR
         * IA32_VMX_BASIC.
         *
         * @see Vol3C[24.6.2(Processor-Based VM-Execution Controls)]
         * @see Vol3D[A.1(BASIC VMX INFORMATION)]
         ...
         *
         * [Bit 31] Software should clear or set the shadow-VMCS indicator
         * depending on whether the VMCS is to be an ordinary VMCS or a shadow
         * VMCS. VMPTRLD fails if the shadow-VMCS indicator is set and the
         * processor does not support the 1-setting of the "VMCS shadowing"
         * VM-execution control. Software can discover support for this setting
     ...
     * A logical processor writes a non-zero value into these bits if a VMX
     * abort occurs. Software may also write into this field.
     *
     ...
     * transitions. The format of these data is implementation-specific. To
     * ensure proper behavior in VMX operation, software should maintain the
     * VMCS region and related structures in writeback cacheable memory. Future
...
typedef struct {
    struct {
         ...
         * revision identifier to the VMXON region. (Specifically, it should
         * write the 31-bit VMCS revision identifier to bits 30:0 of the first 4
         * bytes of the VMXON region; bit 31 should be cleared to 0.)
         *
         * @see VMCS
     ...
     * region of a logical processor between execution of VMXON and VMXOFF on
     * that logical processor. Doing otherwise may lead to unpredictable
     * behavior.
     *
     * @see Vol3C[24.11.4(Software Access to Related Structures)]
     * @see Vol3D[A.1(BASIC VMX INFORMATION)]
...
typedef union {
    struct {
         ...
         *
         * [Bits 7:0] Determines which entry in the IDT is used or which other
         * event is injected.
         */
        UINT32 Vector : 8;
...
#define VMENTRY_INTERRUPT_INFORMATION_INTERRUPTION_TYPE(_)   (((_) >> 8) & 0x07)
         ...
         *
         * [Bit 11] Determines whether delivery pushes an error code on the
         * guest stack.
         */
...
#define VMENTRY_INTERRUPT_INFORMATION_DELIVER_ERROR_CODE(_)   (((_) >> 11) & 0x01)
         ...
         * @brief Valid
         *
         * [Bit 31] VM entry injects an event if and only if the valid bit is 1.
 ...
 * unexpected exceptions, including machine checks, and may vary between
 * implementations. Wider registers (64-bit or 256-bit) must be accessed using
 * multiple 32-bit loads or stores, with all accesses being 128-bit aligned.
...
typedef union {
    struct {
         ...
         * @brief Carry flag
         *
         * [Bit 0] Set if an arithmetic operation generates a carry or a borrow
         * out of the mostsignificant bit of the result; cleared otherwise. This
...
#define EFLAGS_READ_AS_1(_)   (((_) >> 1) & 0x01)
         ...
         * @brief Parity flag
         *
         * [Bit 2] Set if the least-significant byte of the result contains an
...
#define EFLAGS_PARITY_FLAG(_)   (((_) >> 2) & 0x01)
         ...
         *
         * [Bit 4] Set if an arithmetic operation generates a carry or a borrow
         * out of bit 3 of the result; cleared otherwise. This flag is used in
...
#define EFLAGS_ZERO_FLAG(_)   (((_) >> 6) & 0x01)
         ...
         * @brief Sign flag
         *
         * [Bit 7] Set equal to the most-significant bit of the result, which is
...
#define EFLAGS_INTERRUPT_ENABLE_FLAG(_)   (((_) >> 9) & 0x01)
         ...
         *
         * [Bit 10] Controls string instructions (MOVS, CMPS, SCAS, LODS, and
         ...
         * auto-increment (process strings from low addresses to high
         * addresses).
         */
...
#define EFLAGS_DIRECTION_FLAG(_)   (((_) >> 10) & 0x01)
         ...
         * @brief Overflow flag
         *
         * [Bit 11] Set if the integer result is too large a positive number or
...
#define EFLAGS_OVERFLOW_FLAG(_)   (((_) >> 11) & 0x01)
         ...
         *
         * [Bits 13:12] Indicates the I/O privilege level of the currently
         ...
         * I/O privilege level to access the I/O address space. The POPF and
         * IRET instructions can modify this field only when operating at a CPL
         * of 0.
         */
...
#define EFLAGS_IO_PRIVILEGE_LEVEL(_)   (((_) >> 12) & 0x03)
         ...
         *
         * [Bit 14] Controls the chaining of interrupted and called tasks. Set
         * when the current task is linked to the previously executed task;
...
#define EFLAGS_RESUME_FLAG(_)   (((_) >> 16) & 0x01)
         ...
         *
         * [Bit 17] Set to enable virtual-8086 mode; clear to return to
         * protected mode without virtual-8086 mode semantics.
         */
...
#define EFLAGS_VIRTUAL_8086_MODE_FLAG(_)   (((_) >> 17) & 0x01)
         ...
         *
         * [Bit 18] If the AM bit is set in the CR0 register, alignment checking
         * of user-mode data accesses is enabled if and only if this flag is 1.
         * If the SMAP bit is set in the CR4 register, explicit supervisor-mode
         * data accesses to user-mode pages are allowed if and only if this bit
         * is 1.
         *
         * @see Vol3A[4.6(ACCESS RIGHTS)]
         */
...
#define EFLAGS_ALIGNMENT_CHECK_FLAG(_)   (((_) >> 18) & 0x01)
         ...
         *
         * [Bit 19] Virtual image of the IF flag. Used in conjunction with the
         * VIP flag. (To use this flag and the VIP flag the virtual mode
         * extensions are enabled by setting the VME flag in control register
         * CR4.)
         */
...
// #define RFLAGS_AUXILIARY_CARRY_FLAG(_)                               (((_) >>
// 4) & 0x01)
//		UINT64 Reserved2 : 1;
//
//		/**
...
// #define RFLAGS_INTERRUPT_ENABLE_FLAG(_)                              (((_) >>
// 9) & 0x01)
//
//		/**
//		 * @brief Direction flag
...
// #define RFLAGS_DIRECTION_FLAG(_)                                     (((_) >>
// 10) & 0x01)
//
//		/**
//		 * @brief Overflow flag
...
// #define RFLAGS_OVERFLOW_FLAG(_)                                      (((_) >>
// 11) & 0x01)
//
//		/**
//		 * @brief I/O privilege level field
...
// #define RFLAGS_IO_PRIVILEGE_LEVEL(_)                                 (((_) >>
// 12) & 0x03)
//
//		/**
//		 * @brief Nested task flag
...
// #define RFLAGS_NESTED_TASK_FLAG(_)                                   (((_) >>
// 14) & 0x01)
//		UINT64 Reserved3 : 1;
//
//		/**
...
// #define RFLAGS_VIRTUAL_8086_MODE_FLAG(_)                             (((_) >>
// 17) & 0x01)
//
//		/**
//		 * @brief Alignment check (or access control) flag
...
// #define RFLAGS_ALIGNMENT_CHECK_FLAG(_)                               (((_) >>
// 18) & 0x01)
//
//		/**
//		 * @brief Virtual interrupt flag
...
// #define RFLAGS_VIRTUAL_INTERRUPT_FLAG(_)                             (((_) >>
// 19) & 0x01)
//
//		/**
//		 * @brief Virtual interrupt pending flag
...
// #define RFLAGS_VIRTUAL_INTERRUPT_PENDING_FLAG(_)                     (((_) >>
// 20) & 0x01)
//
//		/**
//		 * @brief Identification flag
...
// #define RFLAGS_IDENTIFICATION_FLAG(_)                                (((_) >>
// 21) & 0x01)
//		UINT64 Reserved4 : 42;
//	};
//
...
typedef union {
    struct {
         ...
         * 1 - NEAR-RET: Indicates the \#CP was caused by a near RET
         * instruction. 2 - FAR-RET/IRET: Indicates the \#CP was caused by a FAR
         * RET or IRET instruction. 3 - ENDBRANCH: indicates the \#CP was due to
         * missing ENDBRANCH at target of an indirect call or jump instruction.
         * 4 - RSTORSSP: Indicates the \#CP was caused by a shadow-stack-restore
         * token check failure in the RSTORSSP instruction. 5 - SETSSBSY:
         * Indicates \#CP was caused by a supervisor shadow stack token check
...
typedef enum {
     ...
     * Source: Control flow transfer attempt violated the control flow
     * enforcement technology constraints. Error Code: Yes.
     */
...
typedef union {
    struct {
        /**
         * [Bit 0] When set, indicates that the exception occurred during
         * delivery of an event external to the program, such as an interrupt or
         * an earlier exception. The bit is cleared if the exception occurred
...
#define EXCEPTION_ERROR_CODE_EXTERNAL_EVENT(_)   (((_) >> 0) & 0x01)
         ...
         * refers to a gate descriptor in the IDT; when clear, indicates that
         * the index refers to a descriptor in the GDT or the current LDT.
         */
...
#define EXCEPTION_ERROR_CODE_DESCRIPTOR_LOCATION(_)   (((_) >> 1) & 0x01)
         ...
         * indicates that the index portion of the error code refers to a
...
#define EXCEPTION_ERROR_CODE_GDT_LDT(_)   (((_) >> 2) & 0x01)
        ...
        /**
         * [Bits 15:3] The segment selector index field provides an index into
         * the IDT, GDT, or current LDT to the segment or gate selector being
         * referenced by the error code. In some cases the error code is null
         * (all bits are clear except possibly EXT). A null error code indicates
         * that the error was not caused by a reference to a specific segment or
         * that a null segment selector was referenced in an operation.
         *
         * @note The format of the error code is different for page-fault
         * exceptions (#PF).
         */
        UINT32 Index : 13;
...
typedef union {
    struct {
        /**
         * [Bit 0] This flag is 0 if there is no translation for the linear
         * address because the P flag was 0 in one of the pagingstructure
...
#define PAGE_FAULT_EXCEPTION_PRESENT(_)   (((_) >> 0) & 0x01)
        ...
        /**
         * [Bit 1] If the access causing the page-fault exception was a write,
         * this flag is 1; otherwise, it is 0. This flag describes the access
         * causing the page-fault exception, not the access rights specified by
         * paging.
         */
        UINT32 Write : 1;
...
#define PAGE_FAULT_EXCEPTION_WRITE(_)   (((_) >> 1) & 0x01)
        ...
        /**
         * [Bit 2] If a user-mode access caused the page-fault exception, this
         * flag is 1; it is 0 if a supervisor-mode access did so. This flag
         * describes the access causing the page-fault exception, not the access
...
#define PAGE_FAULT_EXCEPTION_USER_MODE_ACCESS(_)   (((_) >> 2) & 0x01)
        ...
        /**
         * [Bit 3] This flag is 1 if there is no translation for the linear
         * address because a reserved bit was set in one of the pagingstructure
         * entries used to translate that address. (Because reserved bits are
         * not checked in a paging-structure entry whose P flag is 0, bit 3 of
         * the error code can be set only if bit 0 is also set). Bits reserved
         * in the paging-structure entries are reserved for future
         * functionality. Software developers should be aware that such bits may
         * be used in the future and that a paging-structure entry that causes a
         * page-fault exception on one processor might not do so in the future.
         */
...
#define PAGE_FAULT_EXCEPTION_RESERVED_BIT_VIOLATION(_)   (((_) >> 3) & 0x01)
        ...
        /**
         * [Bit 4] This flag is 1 if (1) the access causing the page-fault
         * exception was an instruction fetch; and (2) either (a) CR4.SMEP = 1;
         * or (b) both (i) CR4.PAE = 1 (either PAE paging or 4-level paging is
         * in use); and (ii) IA32_EFER.NXE = 1. Otherwise, the flag is 0. This
         * flag describes the access causing the page-fault exception, not the
...
#define PAGE_FAULT_EXCEPTION_EXECUTE(_)   (((_) >> 4) & 0x01)
        ...
        /**
         * [Bit 5] This flag is 1 if (1) IA32_EFER.LMA = CR4.PKE = 1; (2) the
         * access causing the page-fault exception was a data access; (3) the
         * linear address was a user-mode address with protection key i; and (5)
         * the PKRU register is such that either (a) ADi = 1; or (b) the
         * following all hold: (i) WDi = 1; (ii) the access is a write access;
         * and (iii) either CR0.WP = 1 or the access causing the page-fault
         * exception was a user-mode access.
         *
         * @see Vol3A[4.6.2(Protection Keys)]
         */
...
#define PAGE_FAULT_EXCEPTION_PROTECTION_KEY_VIOLATION(_)   (((_) >> 5) & 0x01)
        ...
        /**
         * [Bit 6] If the access causing the page-fault exception was a
         * shadow-stack access (including shadow-stack accesses in enclave
         * mode), this flag is 1; otherwise, it is 0. This flag describes the
...
#define PAGE_FAULT_EXCEPTION_SHADOW_STACK(_)   (((_) >> 6) & 0x01)
        ...
        /**
         * [Bit 7] This flag is 1 if there is no translation for the linear
         * address using HLAT paging because, in one of the paging- structure
         * entries used to translate that address, either the P flag was 0 or a
         * reserved bit was set. An error code will set this flag only if it
         * clears bit o or sets bit 3. This flag will not be set by a page fault
         * resulting from a violation of access rights, nor for one encountered
         * during ordinary paging, including the case in which there has been a
...
#define PAGE_FAULT_EXCEPTION_HLAT(_)   (((_) >> 7) & 0x01)
         ...
         * fault, this flag is set only if the P flag (bit 0) is 1 and the RSVD
         * flag (bit 3) and the PK flag (bit 5) are both 0.
         */
        UINT32 Sgx : 1;
...
typedef struct {
    union {
        struct {
             ...
             * * 0: Indicates the root-entry is not present. All other fields
...
#define VTD_Lower64_PRESENT(_)   (((_) >> 0) & 0x01)
            ...
            /**
             * [Bits 63:12] Pointer to Context-table for this bus. The
             * Context-table is 4KB in size and size aligned. Hardware treats
             * bits 63:HAW as reserved (0), where HAW is the host address width
             * of the platform.
             */
...
#define VTD_Lower64_PRESENT(_)   (((_) >> 0) & 0x01)
             ...
             * * 1: Qualified non-recoverable faults are not recorded/reported
             * for requests processed through this context-entry. This field is
             * evaluated by hardware irrespective of the setting of the present
             * (P) field.
             */
...
#define VTD_Lower64_FAULT_PROCESSING_DISABLE(_)   (((_) >> 1) & 0x01)
            ...
            /**
             * [Bits 3:2] This field is applicable only for
             * requests-without-PASID, as hardware blocks all requests-with-
...
#define VTD_Lower64_TRANSLATION_TYPE(_)   (((_) >> 2) & 0x03)
            ...
            /**
             * [Bits 63:12] When the Translation-Type (TT) field is 00b or 01b,
             * this field points to the base of second level paging entries
             * (described in Section 9.8). Hardware treats bits 63:HAW as
             * reserved (0), where HAW is the host address width of the
             * platform. This field is ignored by hardware when Translation-Type
             * (TT) field is 10b (pass-through).
             */
...
#define VTD_Lower64_SECOND_LEVEL_PAGE_TRANSLATION_POINTER(_) \
    ...
    union {
        struct {
            /**
             * [Bits 2:0] When the Translation-type (TT) field is 00b or 01b,
             * this field indicates the adjusted guest address- width (AGAW) to
             * be used by hardware for the second-level page-table walk. The
             ...
             * * 100b-111b: Reserved
             * The value specified in this field must match an AGAW value
             * supported by hardware (as reported in the SAGAW field in the
             * Capability Register). When the Translation-type (TT) field
             * indicates pass-through processing (10b), this field must be
             * programmed to indicate the largest AGAW value supported by
             * hardware. Untranslated requests-without-PASID processed through
             * this context-entry and accessing addresses above 2X-1 (where X is
             * the AGAW value indicated by this field) are blocked and treated
             * as translation faults.
             */
...
#define VTD_Upper64_IGNORED(_)   (((_) >> 3) & 0x0F)
            ...
            /**
             * [Bits 17:8] Identifier for the domain to which this context-entry
             * maps. Hardware may use the domain identifier to tag its internal
             * caches. The Capability Register reports the domain-id width
             * supported by hardware. For implementations supporting less than
             * 16-bit domain-ids, unused bits of this field are treated as
             * reserved by hardware. For example, for implementation supporting
             * 8-bit domain-ids, bits 87:80 of this field are treated as
             * reserved. Context-entries programmed with the same domain
             * identifier must always reference same address translation
             * (SLPTPTR field). Context-entries referencing same address
             * translation are recommended to be programmed with same domain id
             * for hardware efficiency. When Caching Mode (CM) field in
             * Capability Register is reported as Set, the domain-id value of
             * zero is architecturally reserved. Software must not use domain-id
...
typedef union {
    struct {
         ...
         * domains.
         * * 011b: Hardware supports 10-bit domain-ids with support for up to
         * 1024 domains.
         * * 100b: Hardware supports 12-bit domain-ids with support for up to 4K
         * domains.
         * * 101b: Hardware supports 14-bit domain-ids with support for up to
         * 16K domains.
         * * 110b: Hardware supports 16-bit domain-ids with support for up to
         * 64K domains.
         * * 111b: Reserved.
         */
...
#define VTD_CAPABILITY_ADVANCED_FAULT_LOGGING(_)   (((_) >> 3) & 0x01)
         ...
         * ensure updates made to memory-resident remapping structures are
         * visible to hardware.
         */
...
#define VTD_CAPABILITY_PROTECTED_HIGH_MEMORY_REGION(_)   (((_) >> 6) & 0x01)
         ...
         *
         * [Bit 7] This field applies to all DMA and Interrupt remap tables
         * except FLtables. Hardware will not cache faulting FL-only
         * translations in IOTLB or FL-paging-structure caches.
         ...
         * remapping caches. Any software updates to the remapping structures
         * (including updates to "not-present" or erroneous entries) require
...
#define VTD_CAPABILITY_CACHING_MODE(_)   (((_) >> 7) & 0x01)
         ...
         * address widths (which in turn represents the levels of page-table
         * walks for the 4KB base page size) supported by the hardware
         * implementation. A value of 1 in any of these bits indicates the
         * corresponding adjusted guest address width is supported. The adjusted
         * guest address widths corresponding to various bit positions within
         * this field are:
         * * 0: Reserved
         ...
         * reported in this field. Hardware implementations reporting
         * second-level translation support (SLTS) field as Clear also report
         * this field as 0.
         */
...
#define VTD_CAPABILITY_SUPPORTED_ADJUSTED_GUEST_ADDRESS_WIDTHS(_) \
    (((_) >> 8) & 0x1F)
         ...
         * width supported by second-level translation in remapping hardware.
         * The Maximum Guest Address Width (MGAW) is computed as (N+1), where N
         * is the valued reported in this field. For example, a hardware
         * implementation supporting 48-bit MGAW reports a value of 47 (101111b)
         * in this field. If the value in this field is X, untranslated DMA
         * requests with addresses above 2(X+1)-1 that are subjected to
         * second-level translation are blocked by hardware. Device-TLB
         * translation requests to addresses above 2(X+1)-1 that are subjected
         * to second-level translation from allowed devices return a null
         * Translation-Completion Data with R=W=0. Guest addressability for a
         * given DMA request is limited to the minimum of the value reported
         * through this field and the adjusted guest address width of the
         * corresponding page-table structure. (Adjusted guest address widths
...
#define VTD_CAPABILITY_MAXIMUM_GUEST_ADDRESS_WIDTH(_)   (((_) >> 16) & 0x3F)
         ...
         * * 1: Indicates the remapping hardware unit supports zero length DMA
         * read requests to write-only pages. DMA remapping hardware
         * implementations are recommended to report ZLR field as Set.
         */
...
#define VTD_CAPABILITY_DEPRECATED(_)   (((_) >> 23) & 0x01)
         ...
         *
         * [Bits 33:24] This field specifies the offset of the first fault
         * recording register relative to the register base address of this
         * remapping hardware unit. If the register base address is X, and the
         * value reported in this field is Y, the address for the first fault
         * recording register is calculated as X+(16*Y).
         */
...
#define VTD_CAPABILITY_FAULT_RECORDING_REGISTER_OFFSET(_)   (((_) >> 24) & 0x3FF)
         ...
         * hardware. A value of 1 in any of these bits indicates the
         * corresponding large page size is supported. The large-page sizes
         ...
         * support all smaller large-page sizes. i.e., only valid values for
...
#define VTD_CAPABILITY_SECOND_LEVEL_LARGE_PAGE_SUPPORT(_)   (((_) >> 34) & 0x0F)
         ...
         *
         * [Bit 39]
         * * 0: Hardware supports only global and domain-selective invalidates
         * for IOTLB.
         * * 1: Hardware supports page-selective, domain-selective, and global
         * invalidates for IOTLB. Hardware implementations reporting this field
         * as Set are recommended to support a Maximum Address Mask Value (MAMV)
         * value of at least 9 (or 18 if supporting 1GB pages with second level
         * translation). This field is applicable only for IOTLB invalidations
         * for second-level translation. Irrespective of value reported in this
         * field, implementations supporting SMTS must support page/address
...
#define VTD_CAPABILITY_PAGE_SELECTIVE_INVALIDATION(_)   (((_) >> 39) & 0x01)
         ...
         * where N is the value reported in this field. Implementations must
         * support at least one fault recording register (NFR = 0) for each
         * remapping hardware unit in the platform. The maximum number of fault
         * recording registers per remapping hardware unit is 256.
         */
...
#define VTD_CAPABILITY_NUMBER_OF_FAULT_RECORDING_REGISTERS(_) \
    (((_) >> 40) & 0xFF)
         ...
         * used for invalidations of second-level translation. This field is
         * valid when the PSI field in Capability register is reported as Set.
...
#define VTD_CAPABILITY_MAXIMUM_ADDRESS_MASK_VALUE(_)   (((_) >> 48) & 0x3F)
         ...
         * Invalidation. Hardware implementation with Major Version 2 or higher
         * (VER_REG), always performs required drain without software explicitly
         * requesting a drain in IOTLB invalidation. This field is deprecated
         * and hardware will always report it as 1 to maintain backward
...
#define VTD_CAPABILITY_READ_DRAINING(_)   (((_) >> 55) & 0x01)
         ...
         * supported for first-level translation. Hardware implementation
         * reporting First-level Translation Support (FLTS) as Clear also report
         * this field as Clear.
         */
...
#define VTD_CAPABILITY_FIRST_LEVEL_1GBYTE_PAGE_SUPPORT(_)   (((_) >> 56) & 0x01)
         ...
         * Hardware implementation reporting Interrupt Remapping support (IR)
         * field in Extended Capability Register as Clear also report this field
         * as Clear.
         */
...
typedef union {
    struct {
         ...
         * PASIDdirectory, scalable-mode PASID-table, and interrupt-remap
         * tables, and legacy-mode second-level paging structures are coherent
         * (snooped) or not.
...
#define VTD_EXTENDED_CAPABILITY_QUEUED_INVALIDATION_SUPPORT(_) \
    (((_) >> 1) & 0x01)
         ...
         * Hardware implementation reporting Queued Invalidation support (QI)
...
#define VTD_EXTENDED_CAPABILITY_INTERRUPT_REMAPPING_SUPPORT(_) \
    (((_) >> 3) & 0x01)
         ...
         * (xAPIC Mode).
         * * 1: On Intel(R) 64 platforms, hardware supports 32-bit APICIDs
         * (x2APIC mode). Hardware implementation reporting Interrupt Remapping
         * support (IR) field as Clear also report this field as Clear.
         */
...
#define VTD_EXTENDED_CAPABILITY_EXTENDED_INTERRUPT_MODE(_)   (((_) >> 4) & 0x01)
         ...
         *
         * [Bit 5] This field must be reported as 0 to ensure backward
         * compatibility with older software.
         */
...
#define VTD_EXTENDED_CAPABILITY_PASS_THROUGH(_)   (((_) >> 6) & 0x01)
         ...
         * page-table entries. Implementations are recommended to support Snoop
         * Control to support software usages that require Snoop Control for
...
#define VTD_EXTENDED_CAPABILITY_SNOOP_CONTROL(_)   (((_) >> 7) & 0x01)
         ...
         * unit. If the register base address is X, and the value reported in
         * this field is Y, the address for the IOTLB registers is calculated as
         * X+(16*Y).
         */
...
#define VTD_EXTENDED_CAPABILITY_MAXIMUM_HANDLE_MASK_VALUE(_) \
    (((_) >> 20) & 0x0F)
         ...
         * compatibility with any software that enables extended mode address
         * translation.
         */
...
#define VTD_EXTENDED_CAPABILITY_DEPRECATED2(_)   (((_) >> 24) & 0x01)
         ...
         *
         * [Bit 25]
         * * 0: Hardware does not support Memory Type in first-level translation
         ...
         * implementations reporting Scalable Mode Translation Support (SMTS)
         * field as Clear also report this field as Clear. Remapping hardware
         * units with, one or more devices that operate in processor coherency
         * domain, under its scope must report this field as Set.
         */
...
#define VTD_EXTENDED_CAPABILITY_MEMORY_TYPE_SUPPORT(_)   (((_) >> 25) & 0x01)
         ...
         * (SMTS) field as Clear or First-level Translation Support (FLTS) field
         * as Clear or Second-level Translation Support (SLTS) field as Clear
...
#define VTD_EXTENDED_CAPABILITY_DEPRECATED3(_)   (((_) >> 28) & 0x01)
         ...
         * Hardware implementation reporting Device-TLB support (DT) field as
         * Clear or Scalable Mode Translation Support (SMTS) field as Clear also
...
#define VTD_EXTENDED_CAPABILITY_PAGE_REQUEST_SUPPORT(_)   (((_) >> 29) & 0x01)
         ...
         * permission. Hardware implementations reporting Process Address Space
         * ID support (PASID) field as Clear must report this field as Clear.
         */
...
#define VTD_EXTENDED_CAPABILITY_NO_WRITE_FLAG_SUPPORT(_)   (((_) >> 33) & 0x01)
         ...
         * Scalable-Mode Page-walk Coherency Support (SWPWCS) as Clear also
         * report this field as Clear.
         */
...
#define VTD_EXTENDED_CAPABILITY_EXTENDED_ACCESSED_FLAG_SUPPORT(_) \
    (((_) >> 34) & 0x01)
         ...
         *
         * [Bits 39:35] This field reports the PASID size supported by the
         * remapping hardware for requests-with-PASID. A value of N in this
         * field indicates hardware supports PASID field of N+1 bits (For
         * example, value of 7 in this field, indicates 8-bit PASIDs are
         * supported). Requests-with-PASID with PASID value beyond the limit
         * specified by this field are treated as error by the remapping
         * hardware. This field is unused and reported as 0 if Scalable Mode
         * Translation Support (SMTS) field is Clear.
         */
...
#define VTD_EXTENDED_CAPABILITY_PASID_SIZE_SUPPORTED(_)   (((_) >> 35) & 0x1F)
         ...
         *
         * [Bit 40]
         * * 0: Hardware does not support requests tagged with Process Address
         * Space IDs.
         * * 1: Hardware supports requests tagged with Process Address Space
         * IDs. Hardware implementations reporting Scalable Mode Translation
...
#define VTD_EXTENDED_CAPABILITY_PROCESS_ADDRESS_SPACE_ID_SUPPORT(_) \
    (((_) >> 40) & 0x01)
         ...
         * Hardware implementations reporting Device-TLB support (DT) as Clear
         * also report this field as Clear.
         */
...
#define VTD_EXTENDED_CAPABILITY_PAGE_REQUEST_DRAIN_SUPPORT(_) \
    (((_) >> 42) & 0x01)
         ...
         * scalable-mode context-table and PASID-table structures. Hardware
         * implementation reporting Queued Invalidation (QI) field as Clear also
         * report this field as Clear. Hardware implementation reporting
         * First-Level Translation Support (FLTS), Second-level Translation
         * Support (SLTS) and Pass-through Support (PT) as Clear also report
         * this field as Clear.
         */
...
#define VTD_EXTENDED_CAPABILITY_SCALABLE_MODE_TRANSLATION_SUPPORT(_) \
    (((_) >> 43) & 0x01)
         ...
         * Remapping hardware.
         * * 1: Hardware does support command submission to virtual- DMA
         * Remapping hardware. Hardware implementations of this architecture
         * report a value of 0 in this field. Software implementations
         * (emulation) of this architecture may report VCS=1. Software managing
         * remapping hardware should be written to handle both values of VCS.
         */
...
#define VTD_EXTENDED_CAPABILITY_VIRTUAL_COMMAND_SUPPORT(_)   (((_) >> 44) & 0x01)
         ...
         * translation. Hardware implementations reporting Scalable-Mode
         * Page-walk Coherency Support (SMPWCS) as Clear also report this field
         * as Clear.
         */
...
#define VTD_EXTENDED_CAPABILITY_SECOND_LEVEL_ACCESSED_DIRTY_SUPPORT(_) \
    (((_) >> 45) & 0x01)
         ...
         * second-level (PGTT=010b) in scalable-mode PASID-Table entry.
         */
...
#define VTD_EXTENDED_CAPABILITY_SECOND_LEVEL_TRANSLATION_SUPPORT(_) \
    (((_) >> 46) & 0x01)
         ...
         * (PGTT=001b) in scalable-mode PASID-Table entry. Hardware
         * implementations reporting Scalable Mode Translation Support (SMTS) as
...
#define VTD_EXTENDED_CAPABILITY_FIRST_LEVEL_TRANSLATION_SUPPORT(_) \
    (((_) >> 47) & 0x01)
         ...
         * PASID-table entry are snooped if PWSNP field in PASID-table entry is
         * Set. Paging-structures accessed through PASID-table entry are not
         * snooped if PWSNP field in PASID-table entry is Clear. Hardware
         * implementations reporting Scalable Mode Translation Support (SMTS) as
         * Clear also report this field as Clear.
         */
...
typedef union {
    struct {
         ...
         * supporting interrupt remapping. Software writes to this field to
         * enable or disable Compatibility Format interrupts on Intel(R) 64
         * platforms. The value in this field is effective only when
         * interrupt-remapping is enabled and Extended Interrupt Mode (x2APIC
         * mode) is not enabled.
         * * 0: Block Compatibility format interrupts.
         * * 1: Process Compatibility format interrupts as pass-through (bypass
         * interrupt remapping). Hardware reports the status of updating this
         * field through the CFIS field in the Global Status register. The value
...
#define VTD_GLOBAL_COMMAND_COMPATIBILITY_FORMAT_INTERRUPT(_) \
    (((_) >> 23) & 0x01)
         ...
         * interrupt remapping. Software sets this field to set/update the
         * interrupt remapping table pointer used by hardware. The interrupt
         * remapping table pointer is specified through the Interrupt Remapping
         * Table Address (IRTA_REG) register. Hardware reports the status of the
         * 'Set Interrupt Remap Table Pointer' operation through the IRTPS field
         * in the Global Status register. The 'Set Interrupt Remap Table
         * Pointer' operation must be performed before enabling or re-enabling
         * (after disabling) interrupt-remapping hardware through the IRE field.
...
#define VTD_GLOBAL_COMMAND_SET_INTERRUPT_REMAP_TABLE_POINTER(_) \
    (((_) >> 24) & 0x01)
         ...
         * operation through the IRES field in the Global Status register. There
         * may be active interrupt requests in the platform when software
         * updates this field. Hardware must enable or disable
         ...
         * remapping or not at all. For implementations reporting the Enhanced
         * Set Interrupt Remap Table Pointer Support (ESIRTPS) field as Set,
         * hardware performs global invalidation on all Interrupt remapping
         * caches as part of Interrupt Remapping Disable operation. Hardware
         * implementations must drain any in-flight interrupts requests queued
         * in the Root-Complex before completing the interrupt-remapping enable
         * command and reflecting the status of the command through the IRES
         * field in the Global Status register. The value returned on a read of
...
#define VTD_GLOBAL_COMMAND_INTERRUPT_REMAPPING_ENABLE(_)   (((_) >> 25) & 0x01)
         ...
         *
         * [Bit 26] This field is valid only for implementations supporting
         * queued invalidations. Software writes to this field to enable or
         * disable queued invalidations.
         ...
         * through QIES field in the Global Status register. The value returned
...
#define VTD_GLOBAL_COMMAND_QUEUED_INVALIDATION_ENABLE(_)   (((_) >> 26) & 0x01)
         ...
         * buffer flushing. Software sets this field to request that hardware
         * flush the Root-Complex internal write buffers. This is done to ensure
         * any updates to the memory resident remapping structures are not held
         * in any internal write posting buffers. Hardware reports the status of
         * the write buffer flushing operation through the WBFS field in the
         * Global Status register. Clearing this bit has no effect. The value
         * returned on a read of this field is undefined.
         */
...
#define VTD_GLOBAL_COMMAND_WRITE_BUFFER_FLUSH(_)   (((_) >> 27) & 0x01)
         ...
         *
         * [Bit 28] This field is valid only for implementations supporting
         * advanced fault logging. Software writes to this field to request
         * hardware to enable or disable advanced fault logging:
         ...
         * Global Status register. The value returned on read of this field is
         * undefined.
         */
...
#define VTD_GLOBAL_COMMAND_ENABLE_ADVANCED_FAULT_LOGGING(_)   (((_) >> 28) & 0x01)
         ...
         *
         * [Bit 29] This field is valid only for implementations supporting
         * advanced fault logging. Software sets this field to request hardware
         * to set/update the fault-log pointer used by hardware. The fault-log
         * pointer is specified through Advanced Fault Log register. Hardware
         * reports the status of the 'Set Fault Log' operation through the FLS
         * field in the Global Status register. The fault log pointer must be
         * set before enabling advanced fault logging (through EAFL field). Once
         * advanced fault logging is enabled, the fault log pointer may be
         * updated through this field while DMA remapping is active. Clearing
         * this bit has no effect. The value returned on read of this field is
         * undefined.
         */
...
#define VTD_GLOBAL_COMMAND_SET_FAULT_LOG(_)   (((_) >> 29) & 0x01)
         ...
         *
         * [Bit 30] Software sets this field to set/update the root-table
         * pointer (and translation table mode) used by hardware. The root-table
         * pointer (and translation table mode) is specified through the Root
         * Table Address (RTADDR_REG) register. Hardware reports the status of
         * the 'Set Root Table Pointer' operation through the RTPS field in the
         * Global Status register. The 'Set Root Table Pointer' operation must
         * be performed before enabling or re-enabling (after disabling) DMA
         * remapping through the TE field. For details on invalidation that
         * software may have to perform after the Clearing this bit has no
...
#define VTD_GLOBAL_COMMAND_SET_ROOT_TABLE_POINTER(_)   (((_) >> 30) & 0x01)
         ...
         * through the TES field in the Global Status register. There may be
         * active DMA requests in the platform when software updates this field.
         * Hardware must enable or disable remapping logic only at deterministic
         * transaction boundaries, so that any in-flight transaction is either
         * subject to remapping or not at all. Hardware implementations
         * supporting DMA draining must drain any inflight DMA read/write
         * requests queued within the Root-Complex before completing the
         * translation enable command and reflecting the status of the command
         * through the TES field in the Global Status register. For
         * implementations reporting Scalable Mode Translation Support (SMTS)
         * field as Set, hardware performs global invalidation on all DMA
         * remapping translation caches as part of Translation Disable
         * operation. The value returned on a read of this field is undefined.
         */
...
typedef union {
    struct {
         ...
         * interrupts on Intel(R) 64 implementations supporting
         * interrupt-remapping. The value reported in this field is applicable
         * only when interrupt-remapping is enabled and extended interrupt mode
...
#define VTD_GLOBAL_STATUS_COMPATIBILITY_FORMAT_INTERRUPT_STATUS(_) \
    (((_) >> 23) & 0x01)
         ...
         *
         * [Bit 24] This field indicates the status of the interrupt remapping
         * table pointer in hardware. This field is cleared by hardware when
         * software sets the SIRTP field in the Global Command register. This
         * field is Set by hardware when hardware completes the 'Set Interrupt
...
#define VTD_GLOBAL_STATUS_INTERRUPT_REMAPPING_TABLE_POINTER_STATUS(_) \
    (((_) >> 24) & 0x01)
         ...
         *
         * [Bit 25] This field indicates the status of Interrupt-remapping
         * hardware.
...
#define VTD_GLOBAL_STATUS_WRITE_BUFFER_FLUSH_STATUS(_)   (((_) >> 27) & 0x01)
         ...
         *
         * [Bit 28] This field is valid only for implementations supporting
         * advanced fault logging. It indicates the advanced fault logging
         * status:
...
#define VTD_GLOBAL_STATUS_ADVANCED_FAULT_LOGGING_STATUS(_)   (((_) >> 28) & 0x01)
         ...
         *
         * [Bit 29] This field:
         * * Is cleared by hardware when software Sets the SFL field in the
...
#define VTD_GLOBAL_STATUS_FAULT_LOG_STATUS(_)   (((_) >> 29) & 0x01)
         ...
         * hardware. This field is cleared by hardware when software sets the
         ...
         * operation using the value provided in the Root Table Address
         * register.
         */
...
typedef union {
    struct {
         ...
         * mode context tables.
         * * 10: reserved - in prior version of this specification, this
         * encoding was used to enable extended mode which is no longer
         * supported.
         * * 11: abort-dma mode.
         ...
         * value of this field takes effect only after software executes Set
         * Root Table Pointer command.
         */
...
#define VTD_ROOT_TABLE_ADDRESS_TRANSLATION_TABLE_MODE(_)   (((_) >> 10) & 0x03)
         ...
         *
         * [Bits 63:12] This field points to the base of the page-aligned,
         * 4KB-sized root-table in system memory. Hardware may ignore and not
         * implement bits 63:HAW, where HAW is the host address width. The value
         * of this field takes effect only after software executes Set Root
...
typedef union {
    struct {
         ...
         *
         * [Bits 15:0] Indicates the id of the domain whose context-entries need
         * to be selectively invalidated. This field must be programmed by
         * software for both domain selective and device-selective invalidation
         * requests. The Capability register reports the domain-id width
         * supported by hardware. Software must ensure that the value written to
         * this field is within this limit. Hardware ignores (and may not
         * implement) bits 15:N, where N is the supported domain-id width
         * reported in the Capability register.
         */
        UINT64 DomainId : 16;
...
#define VTD_CONTEXT_COMMAND_DOMAIN_ID(_)   (((_) >> 0) & 0xFFFF)
         ...
         *
         * [Bits 31:16] Indicates the source-id of the device whose
         * corresponding context-entry needs to be selectively invalidated.This
         * field along with the FM field must be programmed by software for
         * device-selective invalidation requests. The value returned on a read
...
#define VTD_CONTEXT_COMMAND_SOURCE_ID(_)   (((_) >> 16) & 0xFFFF)
         ...
         * function number portion (least significant three bits) of the SID
         * field to mask when performing device selective invalidations.The
         * following encodings are defined for this field:
         ...
         * The context-entries corresponding to the source-ids specified through
         * the SID and FM fields must have the domain-id specified in the DID
         * field. The value returned on a read of this field is undefined.
         */
...
#define VTD_CONTEXT_COMMAND_FUNCTION_MASK(_)   (((_) >> 32) & 0x03)
         ...
         *
         * [Bits 60:59] Hardware reports the granularity at which an
         * invalidation request was processed through the CAIG field at the time
         * of reporting invalidation completion (by clearing the ICC field). The
         * following are the encodings for this field:
         * * 00: Error. This indicates hardware detected an incorrect
         * invalidation request and ignored the request, e.g., register based
         * invalidation when Translation Table Mode (TTM) in Root Table Address
         * Register is not programmed to legacy mode (RTADDR_REG.TTM!=00b). On
         * hardware implementations with Major Version 6 or higher (VER_REG),
         * all invalidation requests through this register are treated as
         * incorrect invalidation requests. Software should use the Queued
         * Invalidation interface to perform context-cache invalidations for
         * such hardware implementations. Refer to Section 6.5 for more details.
         ...
         * specified by software in the DID field. This could be in response to
         ...
         * domain-id specified by software in the SID and FM fields. This can
         * only be in response to a device-selective invalidation request.
         */
...
#define VTD_CONTEXT_COMMAND_CONTEXT_ACTUAL_INVALIDATION_GRANULARITY(_) \
    (((_) >> 59) & 0x03)
         ...
         * * 11: Device-selective invalidation request. The target source-id(s)
         * must be specified through the SID and FM fields, and the domain-id
         * [that was programmed in the context-entry for these device(s)] must
         * be provided in the DID field. Hardware implementations may process an
         * invalidation request by performing invalidation at a coarser
         * granularity than requested. Hardware indicates completion of the
...
#define VTD_CONTEXT_COMMAND_CONTEXT_INVALIDATION_REQUEST_GRANULARITY(_) \
    (((_) >> 61) & 0x03)
         ...
         *
         * [Bit 63] Software requests invalidation of context-cache by setting
         * this field. Software must also set the requested invalidation
         * granularity by programming the CIRG field. Software must read back
         * and check the ICC field is Clear to confirm the invalidation is
         * complete. Software must not update this register when this field is
         * Set. Hardware clears the ICC field to indicate the invalidation
         * request is complete.Hardware also indicates the granularity at which
         * the invalidation operation was performed through the CAIG field.
         ...
         * this remapping hardware unit. Since information from the
         * context-cache may be used by hardware to tag IOTLB entries, software
         * must perform domain-selective (or global) invalidation of IOTLB after
         * the context-cache invalidation has completed. Hardware
         * implementations reporting a write-buffer flushing requirement (RWBF=1
         * in the Capability register) must implicitly perform a write buffer
         * flush before invalidating the context-cache. When Translation Table
         * Mode field in Root Table Address register is not setup as legacy mode
         * (RTADDR_REG.TTM!=00b), hardware will ignore the value provided by
         * software in this register, treat it as an incorrect invalidation
         * request, and report a value of 00b in CAIG field.
         */
...
typedef union {
    struct {
         ...
         *
         * [Bits 5:0] The value in this field specifies the number of low order
         * bits of the ADDR field that must be masked for the invalidation
         * operation. This field enables software to request invalidation of
         * contiguous mappings for size-aligned regions. When invalidating
         * mappings for large-pages, software must specify the appropriate mask
         * value. For example, when invalidating mapping for a 2MB page,
         * software must specify an address mask value of at least 9. Hardware
         * implementations report the maximum supported address mask value
         * through the Capability register. A value returned on a read of this
         * field is undefined.
         */
...
#define VTD_INVALIDATE_ADDRESS_ADDRESS_MASK(_)   (((_) >> 0) & 0x3F)
         ...
         *
         * [Bit 6] The field provides hints to hardware about preserving or
         * flushing the nonleaf (context-entry) entries that may be cached in
         * hardware:
         ...
         * the mappings specified by DID, ADDR and AM fields, in both IOTLB and
         * paging-structure caches.
         * * 1: Software has not modified any second-level non-leaf paging
         ...
         * hardware may preserve the cached second-level mappings in
         * paging-structurecaches. A value returned on a read of this field is
         * undefined.
         */
...
#define VTD_INVALIDATE_ADDRESS_INVALIDATION_HINT(_)   (((_) >> 6) & 0x01)
         ...
         *
         * [Bits 63:12] Software provides the second-level-input-address that
         * needs to be page selectively invalidated. To make a
         * page-selective-within-domain invalidation request to hardware,
         * software must first write the appropriate fields in this register,
         * and then issue the page-selective-within-domain invalidate command
         * through the IOTLB_REG. Hardware ignores bits 63:N, where N is the
         * maximum guest address width (MGAW) supported. A value returned on a
...
typedef union {
    struct {
         ...
         * @brief Domain-ID <b>(RW)</b>
         *
         * [Bits 47:32] Indicates the ID of the domain whose IOTLB entries need
         * to be selectively invalidated. This field must be programmed by
         * software for domainselective and page-selective invalidation
         * requests. The Capability register reports the domain-id width
         * supported by hardware. Software must ensure that the value written to
         * this field is within this limit. Hardware may ignore and not
         * implement bits 47:(32+N), where N is the supported domain-id width
         * reported in the Capability register.
         */
        UINT64 DomainId : 16;
...
#define VTD_IOTLB_INVALIDATE_DOMAIN_ID(_)   (((_) >> 32) & 0xFFFF)
         ...
         *
         * [Bit 48] This field is ignored by hardware if the DWD field is
         * reported as Clear in the Capability register. When the DWD field is
         * reported as Set in the Capability register, the following encodings
...
#define VTD_IOTLB_INVALIDATE_DRAIN_WRITES(_)   (((_) >> 48) & 0x01)
         ...
         *
         * [Bit 49] This field is ignored by hardware if the DRD field is
         * reported as Clear in the Capability register. When the DRD field is
         * reported as Set in the Capability register, the following encodings
         * are supported for this field:
         * * 0: Hardware may complete the IOTLB invalidation without draining
         * DMA read requests.
...
#define VTD_IOTLB_INVALIDATE_DRAIN_READS(_)   (((_) >> 49) & 0x01)
         ...
         *
         * [Bits 58:57] Hardware reports the granularity at which an
         * invalidation request was processed through this field when reporting
         * invalidation completion (by clearing the IVT field). The following
         * are the encodings for this field.
         * * 00: Error. This indicates hardware detected an incorrect
         * invalidation request and ignored the request, e.g., register based
         * invalidation when Translation Table Mode (TTM) in Root Table Address
         * Register is not programmed to legacy mode (RTADDR_REG.TTM!=00b),
         * detected an unsupported address mask value in Invalidate Address
         * register for page-selective invalidation requests. On hardware
         ...
         * * 10: Domain-selective invalidation performed using the domain-id
         * specified by software in the DID field. This could be in response to
         * a domain-selective or a page-selective invalidation request.
         ...
         * Address register and domain-id specified in DID field. This can be in
         * response to a page-selective-within-domain invalidation request.
         */
...
#define VTD_IOTLB_INVALIDATE_IOTLB_ACTUAL_INVALIDATION_GRANULARITY(_) \
    (((_) >> 57) & 0x03)
         ...
         *
         * [Bits 61:60] When requesting hardware to invalidate the IOTLB (by
         * setting the IVT field), software writes the requested invalidation
         ...
         * address, mask, and invalidation hint must be specified in the
         * Invalidate Address register, and the domain-id must be provided in
         ...
         * requested. Hardware indicates completion of the invalidation request
         * by clearing the IVT field. At that time, the granularity at which
...
#define VTD_IOTLB_INVALIDATE_IOTLB_INVALIDATION_REQUEST_GRANULARITY(_) \
    (((_) >> 60) & 0x03)
         ...
         * programming the IIRG field. Hardware clears the IVT field to indicate
         * the invalidation request is complete. Hardware also indicates the
         * granularity at which the invalidation operation was performed through
         * the IAIG field. Software must not submit another invalidation request
         * through this register while the IVT field is Set, nor update the
         * associated Invalidate Address register. Software must not submit
         * IOTLB invalidation requests when there is a context-cache
         * invalidation request pending at this remapping hardware unit.
         * Hardware implementations reporting a write-buffer flushing
         * requirement (RWBF=1 in Capability register) must implicitly perform a
         * write buffer flushing before invalidating the IOTLB. Refer to
         * Section 6.8 for write buffer flushing requirements. When Translation
         * Table Mode field in Root Table Address registers is not setup as
         * legacy mode (RTADDR_REG.TTM!=00b), hardware will ignore the value
         * provided by software in this register, treat it as an incorrect
...
typedef union {
    struct {
        /**
         * [Bit 0] This bit 0 must be 1. An attempt to write 0 to this bit
...
#define XCR0_X87(_)   (((_) >> 0) & 0x01)
        ...
        /**
         * [Bit 1] If 1, the XSAVE feature set can be used to manage MXCSR and
         * the XMM registers (XMM0-XMM15 in 64-bit mode; otherwise XMM0-XMM7).
         */
        UINT64 Sse : 1;
...
#define XCR0_SSE(_)   (((_) >> 1) & 0x01)
        ...
        /**
         * [Bit 2] If 1, AVX instructions can be executed and the XSAVE feature
         * set can be used to manage the upper halves of the YMM registers
         * (YMM0-YMM15 in 64-bit mode; otherwise YMM0-YMM7).
         */
        UINT64 Avx : 1;
...
#define XCR0_AVX(_)   (((_) >> 2) & 0x01)
        ...
        /**
         * [Bit 3] If 1, MPX instructions can be executed and the XSAVE feature
         * set can be used to manage the bounds registers BND0-BND3.
         */
        UINT64 Bndreg : 1;
...
#define XCR0_BNDREG(_)   (((_) >> 3) & 0x01)
        ...
        /**
         * [Bit 4] If 1, MPX instructions can be executed and the XSAVE feature
         * set can be used to manage the BNDCFGU and BNDSTATUS registers.
         */
        UINT64 Bndcsr : 1;
...
#define XCR0_BNDCSR(_)   (((_) >> 4) & 0x01)
        ...
        /**
         * [Bit 5] If 1, AVX-512 instructions can be executed and the XSAVE
         * feature set can be used to manage the opmask registers k0-k7.
         */
        UINT64 Opmask : 1;
...
#define XCR0_OPMASK(_)   (((_) >> 5) & 0x01)
        ...
        /**
         * [Bit 6] If 1, AVX-512 instructions can be executed and the XSAVE
         * feature set can be used to manage the upper halves of the lower ZMM
         * registers (ZMM0-ZMM15 in 64-bit mode; otherwise ZMM0-ZMM7).
         */
        UINT64 ZmmHi256 : 1;
...
#define XCR0_ZMM_HI256(_)   (((_) >> 6) & 0x01)
        ...
        /**
         * [Bit 7] If 1, AVX-512 instructions can be executed and the XSAVE
         * feature set can be used to manage the upper ZMM registers
         * (ZMM16-ZMM31, oonly in 64-bit mode).
         */
        UINT64 ZmmHi16 : 1;
